...
| **34** | Phase B widget smokes: non-exhaustive `match` after `Path` (E084) | **active** (2026-07-16) STEP=1 **done**; **STEP=2** Critic next | [TRACK_GUI_SCENE_PATH_MATCH](agent/TRACK_GUI_SCENE_PATH_MATCH.md) — Critic residual after Phase D |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_SCENE_PATH_MATCH (§34, **active**; STEP=1 done; **STEP=2** Critic next;
