...
| **43** | Editor folder nav history (back/forward; absorb WIP) | **active** (2026-07-16) STEP=0 **done**; STEP=1 next | [TRACK_EDITOR_FOLDER_NAV](agent/TRACK_EDITOR_FOLDER_NAV.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_FOLDER_NAV (§43, **active**; STEP=0 Decision next;
