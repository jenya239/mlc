...
| **37** | GLFW `content_scale` (HiDPI) — residual from §36 STEP=7 | **active** (2026-07-16) STEP=2 **done**; **STEP=3** optional editor wire next | [TRACK_GLFW_CONTENT_SCALE](agent/TRACK_GLFW_CONTENT_SCALE.md) |
