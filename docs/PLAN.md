...
| **93** | Editor edit autoclose without full stringify (§92 residual) | **open** STEP=1 done; STEP=2 green next | [agent/TRACK_EDITOR_EDIT_AUTOCLOSE_NO_FULL_STRINGIFY](agent/TRACK_EDITOR_EDIT_AUTOCLOSE_NO_FULL_STRINGIFY.md) |
