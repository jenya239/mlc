...
| **17** `T!E` error-union sugar | **done** (2026-07-11) | [TRACK_LANG_ERROR_UNION](archive/tracks/TRACK_LANG_ERROR_UNION.md) **closed** STEP=1–5; Ruby+mlcc desugar; e2e+`?`; REG 20/0; self-host DIFF 0 (awaiting Critic) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **LANG_ERROR_UNION (**active** STEP=5 — MLC.md + verify-gate + close;
