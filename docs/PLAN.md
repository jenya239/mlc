...
| **21** | Compile-smoke coverage для `misc/examples`/`misc/gui` (regression молчала на `gui_button_demo.mlc`) | **active** (2026-07-12) | [TRACK_EXAMPLES_CI](agent/TRACK_EXAMPLES_CI.md) **active** STEP=11 done (vm_*); STEP=4 wire regression_gate next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EXAMPLES_CI (active 2026-07-12: STEP=10 done; STEP=11 vm_* next;
