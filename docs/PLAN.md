...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **priority / active** (2026-07-15) Phase D STEP=2 **done**; **STEP=3** Path tess next | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_D](agent/TRACK_GUI_SCENE_PHASE_D.md); Phase A/B/C archive |
