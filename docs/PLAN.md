...
| **47** | MLC concurrency refinement backlog — `#5 CONCURRENCY_CANCELLATION_WAKES_BLOCKING` active STEP=0 → Driver STEP=1; #6…#11 pending | **active** (2026-07-20) Driver `#5` STEP=1 | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_CANCELLATION_WAKES_BLOCKING](agent/TRACK_CONCURRENCY_CANCELLATION_WAKES_BLOCKING.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-20: `#5 CONCURRENCY_CANCELLATION_WAKES_BLOCKING` STEP=0 done → Driver STEP=1;
