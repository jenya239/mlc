...
| **47** | MLC concurrency refinement backlog — `#9 CONCURRENCY_ISOLATE_MLC_SURFACE` **active** (STEP=1 → Driver STEP=2); #8 done; #10…#11 pending | **active** (2026-07-21) Driver `#9` STEP=2 | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_ISOLATE_MLC_SURFACE](agent/TRACK_CONCURRENCY_ISOLATE_MLC_SURFACE.md) · [archive/tracks/TRACK_CONCURRENCY_FFI_METADATA](archive/tracks/TRACK_CONCURRENCY_FFI_METADATA.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-21: `#9 CONCURRENCY_ISOLATE_MLC_SURFACE` STEP=1→Driver STEP=2; `#8` closed;
