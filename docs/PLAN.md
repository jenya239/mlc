...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **active** (2026-07-13) Phase A **Critic OK**; Phase B deferred if EDITOR priority | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) → [TRACK_GUI_SCENE_PHASE_A](archive/tracks/TRACK_GUI_SCENE_PHASE_A.md) |
...
| **29** | Retained affine-transform scene graph (Figma/blueprint canvas + classic + game + Flash-rich UI — один фундамент) | **active** (2026-07-13) Phase A Critic OK (`9d1fd06e`…`1a010299`); Phase B after EDITOR or user resume | [TRACK_GUI_SCENE_PHASE_A](archive/tracks/TRACK_GUI_SCENE_PHASE_A.md) — epic [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_CANVAS_GRAPH Phase A (**closed** 2026-07-13: Critic OK; STEP=1–7;
      `9d1fd06e`…`1a010299`; reopen: none;
      → [archive/tracks/TRACK_GUI_SCENE_PHASE_A.md](archive/tracks/TRACK_GUI_SCENE_PHASE_A.md))**
  → **EDITOR_MVP** if CONTINUITY priority override active (STEP=pre), else
    Planner opens `TRACK_GUI_SCENE_PHASE_B` (Phase B–D deferred behind EDITOR
    when override is set; epic → [agent/TRACK_GUI_CANVAS_GRAPH.md](agent/TRACK_GUI_CANVAS_GRAPH.md)).
```
