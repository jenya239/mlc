...
| **21** | Compile-smoke coverage для `misc/examples`/`misc/gui` (regression молчала на `gui_button_demo.mlc`) | **done** (2026-07-12) | [TRACK_EXAMPLES_CI](archive/tracks/TRACK_EXAMPLES_CI.md) **closed** STEP=1–6; sweep in `regression_gate`; REG 20/0; sweep ok=106 skip=1 (awaiting Critic) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EXAMPLES_CI (**closed** 2026-07-12: STEP=1–6; REG 20/0; sweep ok=106 skip=1;
      awaiting Critic;
