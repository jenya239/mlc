...
| **20b** MSDF (EDT/SDF) алгоритм — порт на MLC | **open, active** | [TRACK_TEXT_MSDF_TO_MLC](agent/TRACK_TEXT_MSDF_TO_MLC.md) **active** STEP=3 (STEP=2 done: golden `msdf_A_32_4.rgb`; MLC EDT port next) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **TEXT_MSDF_TO_MLC (**active** STEP=3 — golden fixture done; MLC EDT/SDF port next;
