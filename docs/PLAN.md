...
| **17** `T!E` error-union sugar | **open, active** | [TRACK_LANG_ERROR_UNION](agent/TRACK_LANG_ERROR_UNION.md) **active** STEP=4 (STEP=3: self-hosted `types.mlc` desugar) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **LANG_ERROR_UNION (**active** STEP=4 — e2e/`?` tests;
