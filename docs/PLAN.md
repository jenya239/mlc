...
| **85** | Editor probe reuses frame LineIndex (§84 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX](agent/TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_PROBE_REUSE_FRAME_LINE_INDEX (§85, open STEP=3 Critic next:
