...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **TEXT_GL_PERF_BASELINE (active 2026-07-12: STEP=1–9 done; STEP=10 privet
    golden check next;
