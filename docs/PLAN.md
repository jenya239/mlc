...
| **81** | Editor scroll reuses frame LineIndex (§80 residual) | **open** STEP=2 next | [agent/TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX](agent/TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX.md) |
