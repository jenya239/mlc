...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_PERF_DOGFOOD (§109 — QUEUE HEAD; user hard stop)
      §109a→§109b→§109c→§109d→§109e→§109f→§109g→§109h→§109i→§109j→§109k
      → [agent/TRACK_EDITOR_PERF_DOGFOOD](agent/TRACK_EDITOR_PERF_DOGFOOD.md))**
  → **MLC_SCRIPT_VM Phase 1 (§103f+ — SUSPENDED until §109 closes; §103a–e CLOSED;
