...
| **11** Stdlib для backend-приложений (TCP/HTTP сервер, Postgres, crypto, WS, job queue) | **partial** | [STDLIB_BACKEND.md](STDLIB_BACKEND.md); NET_SERVER **closed**. [TRACK_STDLIB_POSTGRES](archive/tracks/TRACK_STDLIB_POSTGRES.md) **closed** 2026-07-10. Next: crypto / WS / … |
