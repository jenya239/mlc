...
| **69** | Editor folder nav/breadcrumb hover (§46 #32 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_NAV_CRUMB_HOVER](agent/TRACK_EDITOR_NAV_CRUMB_HOVER.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_NAV_CRUMB_HOVER (§69, open STEP=3 Critic next:
