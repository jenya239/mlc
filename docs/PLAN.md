...
| **25** | Concurrency Supervisor — реализация (гейт снят) | **active** (2026-07-12) | [TRACK_CONCURRENCY_SUPERVISOR](agent/TRACK_CONCURRENCY_SUPERVISOR.md) **active** STEP=1–4 done (C++-only Decision); STEP=5 smoke next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **CONCURRENCY_SUPERVISOR (active 2026-07-12: STEP=1–3 done; STEP=4 MLC vs C++ next;
