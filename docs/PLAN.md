...
| **87** | Editor drop-file opens without stringify (§86 residual) | **open** STEP=1 next | [agent/TRACK_EDITOR_DROP_FILE_NO_STRINGIFY](agent/TRACK_EDITOR_DROP_FILE_NO_STRINGIFY.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_DROP_FILE_NO_STRINGIFY (§87, open STEP=1 next:
