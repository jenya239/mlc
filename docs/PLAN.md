...
| **24** | HTTP server hardening (keep-alive, лимиты, static files, graceful shutdown doc) | **active** (2026-07-12) | [TRACK_STDLIB_HTTP_HARDENING](agent/TRACK_STDLIB_HTTP_HARDENING.md) **active** STEP=1–5 done; STEP=6 load-test next |
