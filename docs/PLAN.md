...
| **36** | Stdlib IO/FS: `list_dir` / `is_directory` / `is_regular_file` / `create_directories` + editor tree wire | **active** (2026-07-16) STEP=2 **done**; **STEP=3** safe_list_dir next | [TRACK_STDLIB_IO_FS](agent/TRACK_STDLIB_IO_FS.md) |
