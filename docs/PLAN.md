...
| **59** | Editor text draw respects scroll_x (§58 residual) | **active** — STEP=2 done → Critic STEP=3 | [TRACK_EDITOR_TEXT_DRAW_SCROLL_X](agent/TRACK_EDITOR_TEXT_DRAW_SCROLL_X.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_TEXT_DRAW_SCROLL_X (§59, active: STEP=2 green done → Critic STEP=3;
      text_pen_x_scrolled on find/fill/caret/glyphs; `ux_ok text_draw_scroll_x_stable`;
