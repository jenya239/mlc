...
| **23** | GUI input robustness (debounce клика, keyboard text, resize) | **active** (2026-07-12) | [TRACK_GUI_INPUT_ROBUSTNESS](agent/TRACK_GUI_INPUT_ROBUSTNESS.md) **active** STEP=1 done (not reproducible); STEP=2 N/A; STEP=3 keyboard next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_INPUT_ROBUSTNESS (active 2026-07-12: STEP=1 done / STEP=2 N/A; STEP=3 keyboard next;
