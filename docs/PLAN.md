...
| **47** | MLC concurrency refinement backlog — `#7 CONCURRENCY_ATOMICS` **done**; next Planner `#8 CONCURRENCY_FFI_METADATA`; #9…#11 pending | **active** (2026-07-21) Planner `#8` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/tracks/TRACK_CONCURRENCY_ATOMICS](archive/tracks/TRACK_CONCURRENCY_ATOMICS.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-21: `#7 CONCURRENCY_ATOMICS` **closed**; next Planner `#8 CONCURRENCY_FFI_METADATA`;
