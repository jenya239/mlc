...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_SCRIPT_VM Phase 1 (§103 — QUEUE HEAD §103g Green done → Critic; §103a–f CLOSED;
