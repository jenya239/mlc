...
| **47** | MLC concurrency refinement backlog — `#1`–`#6` done; next Planner open `#7 CONCURRENCY_ATOMICS`; #8…#11 pending | **active** (2026-07-20) Planner `#7` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/TRACK_CONCURRENCY_CHANNEL_RENDEZVOUS_UNBOUNDED](archive/tracks/TRACK_CONCURRENCY_CHANNEL_RENDEZVOUS_UNBOUNDED.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-20: `#6` closed Critic OK; next Planner open `#7 CONCURRENCY_ATOMICS`;
