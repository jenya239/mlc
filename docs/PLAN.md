...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_SCRIPT_VM Phase 1 (§103a `SCRIPT_VM_VALUE_REP` — QUEUE HEAD; Green done; Critic next;
