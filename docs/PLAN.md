...
| **47** | MLC concurrency refinement backlog — `#1`–`#4` done; next Planner open `#5 CONCURRENCY_CANCELLATION_WAKES_BLOCKING`; #6…#11 pending | **active** (2026-07-20) Planner `#5` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/TRACK_CONCURRENCY_SYNC_TRAIT](archive/tracks/TRACK_CONCURRENCY_SYNC_TRAIT.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-20: `#4` closed Critic OK; next Planner open `#5 CONCURRENCY_CANCELLATION_WAKES_BLOCKING`;
      ...
      → [agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) ·
        ...
        [archive/tracks/TRACK_CONCURRENCY_MOVE_TRACKING.md](archive/tracks/TRACK_CONCURRENCY_MOVE_TRACKING.md))**
```
