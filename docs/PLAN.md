...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_TERMINAL (§102, open — §102a/§102b/§102c CLOSED,
      §102d `TERMINAL_INPUT_FORWARD` Driver done (red+green), Critic next, of
