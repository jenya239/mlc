...
| **17** `T!E` error-union sugar | **open, active** | [TRACK_LANG_ERROR_UNION](agent/TRACK_LANG_ERROR_UNION.md) **active** STEP=3 (STEP=2: Ruby `T!E` → `Result`) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **LANG_ERROR_UNION (**active** STEP=3 — self-hosted `types.mlc` desugar;
