...
| **47** | MLC concurrency refinement backlog — `#8 CONCURRENCY_FFI_METADATA` **done**; next Planner `#9 CONCURRENCY_ISOLATE_MLC_SURFACE`; #10…#11 pending | **active** (2026-07-21) Planner `#9` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/tracks/TRACK_CONCURRENCY_FFI_METADATA](archive/tracks/TRACK_CONCURRENCY_FFI_METADATA.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-21: `#8 CONCURRENCY_FFI_METADATA` STEP=3 done → Critic;
      ...
      → [agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) ·
        [agent/TRACK_CONCURRENCY_FFI_METADATA.md](agent/TRACK_CONCURRENCY_FFI_METADATA.md) ·
