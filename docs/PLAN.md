...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **priority / active** (2026-07-14) Phase B STEP=1 next | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_B](agent/TRACK_GUI_SCENE_PHASE_B.md); Phase A archive |
...
| **29** | Retained affine-transform scene graph (Figma/blueprint canvas + classic + game + Flash-rich UI — один фундамент) | **priority / active** (2026-07-14) Phase B STEP=1 | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_B](agent/TRACK_GUI_SCENE_PHASE_B.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_CANVAS_GRAPH Phase B (**PRIORITY / queue head; STEP=1 Decision next;
