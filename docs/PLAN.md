...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **COMPILER_ARCHITECTURE_HYGIENE Wave 1 only (§104, PRIORITY override 2026-07-28,
      ...
      closed same day, Critic-audited; open §104-12 slice 4
      (`transform_method.mlc`) Decision next; only §104-1/2/3 (done),
      §104-12..16, §104-18..20, §104-22/23 pulled forward here, Wave 2
      (§104-6..11) stays after §103, Wave 3 stays gated;
