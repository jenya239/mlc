...
| **20c** WebSocket framing/handshake — порт на MLC | **open, active** | [TRACK_STDLIB_WEBSOCKET_TO_MLC](agent/TRACK_STDLIB_WEBSOCKET_TO_MLC.md) **active** STEP=5 (handshake done) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → STDLIB_WEBSOCKET_TO_MLC (**active** STEP=5 — delete hpp after handshake
