...
| **14** FFI safety contract | **open, active** | [TRACK_FFI_SAFETY](agent/TRACK_FFI_SAFETY.md) **active** STEP=3 (STEP=2: W-EXTERN-ATTR + env/tcp `blocking`) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **FFI_SAFETY (**active** STEP=3 — W-EXTERN-ATTR done; ABI arity next;
