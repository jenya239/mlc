...
| **14** FFI safety contract | **open, active** | [TRACK_FFI_SAFETY](agent/TRACK_FFI_SAFETY.md) **active** STEP=4 (STEP=3: W-EXTERN-ARITY vs header_import) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **FFI_SAFETY (**active** STEP=4 — W-EXTERN-ARITY done; FFI_LAYER §9 docs next;
