...
| **72** | Editor context-menu item hover (§46 #32 residual) | **open** STEP=1 next | [agent/TRACK_EDITOR_CONTEXT_MENU_ITEM_HOVER](agent/TRACK_EDITOR_CONTEXT_MENU_ITEM_HOVER.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_CONTEXT_MENU_ITEM_HOVER (§72, open STEP=1 next:
