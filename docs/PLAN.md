...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_TERMINAL (§102, open — §102a/§102b/§102c/§102d CLOSED,
      §102e `TERMINAL_RESIZE_SCROLLBACK` next, of
