...
| **47** | MLC concurrency refinement backlog — `#8 CONCURRENCY_FFI_METADATA` STEP=3 done → Critic; #9…#11 pending | **active** (2026-07-21) Critic `#8` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_FFI_METADATA](agent/TRACK_CONCURRENCY_FFI_METADATA.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
