...
| **82** | Editor selection reuses frame LineIndex (§81 residual) | **open** STEP=1 next | [agent/TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX](agent/TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX (§82, open STEP=1 next:
