...
| **18** Package manager | **active** (STEP=2 done; STEP=3 version skew) | [TRACK_PACKAGE_MANAGER](agent/TRACK_PACKAGE_MANAGER.md) — `.mlc_packages/` + `pkg/path` imports; Steps 3–4 design then 5–10 |
