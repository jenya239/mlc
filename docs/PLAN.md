...
| **46** | Editor UX backlog — #1…#1d+#2+#3 done; next **#4 `EDITOR_MOUSE_WORD_LINE_SELECT`** (Planner pick-next) | **active** (2026-07-18) #3 closed; #4 pending | [TRACK_EDITOR_UX_BACKLOG](agent/TRACK_EDITOR_UX_BACKLOG.md) · [archive/tracks/TRACK_EDITOR_WORD_BOUNDARIES](archive/tracks/TRACK_EDITOR_WORD_BOUNDARIES.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_UX_BACKLOG (§46, **active**; #1…#1d+#2+#3 closed; next #4 `EDITOR_MOUSE_WORD_LINE_SELECT`;
