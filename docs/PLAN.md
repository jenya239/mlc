...
| **70** | Editor active-tab title without brackets (§68 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_ACTIVE_TAB_TITLE_PLAIN](agent/TRACK_EDITOR_ACTIVE_TAB_TITLE_PLAIN.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_ACTIVE_TAB_TITLE_PLAIN (§70, open STEP=3 Critic next:
