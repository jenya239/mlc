...
| **47** | MLC concurrency refinement backlog — `#1`–`#3` done; next Planner open `#4 CONCURRENCY_SYNC_TRAIT`; #5…#11 pending | **active** (2026-07-20) Planner `#4` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/TRACK_CONCURRENCY_MOVE_TRACKING](archive/tracks/TRACK_CONCURRENCY_MOVE_TRACKING.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-20: `#1`–`#3` done; next Planner open `#4 CONCURRENCY_SYNC_TRAIT`;
