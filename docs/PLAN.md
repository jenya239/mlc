...
| **56** | Editor multi-caret draw + blink (§55 residual) | **active** — STEP=0 done → Driver STEP=1 | [TRACK_EDITOR_MULTI_CARET_DRAW](agent/TRACK_EDITOR_MULTI_CARET_DRAW.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_MULTI_CARET_DRAW (§56, active: STEP=0 Decision frozen 2026-07-24 →
      Driver STEP=1 red; §55 residual — primary-only caret vs multi carets;
