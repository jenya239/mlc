...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_UX_BACKLOG (§46, **active** 2026-07-22: `#37 EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP` STEP=0→Driver STEP=1; `#38` closed Critic OK; #1…#36 closed (#22 superseded);
