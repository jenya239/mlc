...
| **47** | MLC concurrency refinement backlog — `#1 CONCURRENCY_MUTABLE_CAPTURE_CHECK` active STEP=0 → Driver STEP=1; #2…#11 pending | **active** (2026-07-20) Driver `#1` STEP=1 | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_MUTABLE_CAPTURE_CHECK](agent/TRACK_CONCURRENCY_MUTABLE_CAPTURE_CHECK.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-20: `#1 CONCURRENCY_MUTABLE_CAPTURE_CHECK` STEP=0 → Driver STEP=1;
