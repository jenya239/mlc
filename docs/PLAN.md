...
| **47** | MLC concurrency refinement backlog — `#3 CONCURRENCY_MOVE_TRACKING` active STEP=1 done → Driver STEP=2; #4…#11 pending | **active** (2026-07-20) Driver `#3` STEP=2 | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_MOVE_TRACKING](agent/TRACK_CONCURRENCY_MOVE_TRACKING.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-20: `#3 CONCURRENCY_MOVE_TRACKING` STEP=1 done → Driver STEP=2;
