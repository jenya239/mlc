...
| **98** | Editor newline auto-indent without full stringify (§93 / #1d residual) | **open** STEP=0 done; STEP=1 red next | [agent/TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY](agent/TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY (§98, open STEP=1 next:
      newline indent without document_to_string; [TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY](agent/TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY.md))**
```
