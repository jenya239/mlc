...
| **21** | Compile-smoke coverage для `misc/examples`/`misc/gui` (regression молчала на `gui_button_demo.mlc`) | **active** (2026-07-12) | [TRACK_EXAMPLES_CI](agent/TRACK_EXAMPLES_CI.md) **active** STEP=2 done (sysdep soft-skip); STEP=3 full sweep next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EXAMPLES_CI (active 2026-07-12: STEP=1 done; STEP=2 soft-skip next;
