...
| **23** | GUI input robustness (debounce клика, keyboard text, resize) | **active** (2026-07-12) | [TRACK_GUI_INPUT_ROBUSTNESS](agent/TRACK_GUI_INPUT_ROBUSTNESS.md) **active** STEP=3 done (text_buffer); STEP=4 text-field demo next |
