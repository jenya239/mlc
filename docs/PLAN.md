...
Трек: [TRACK_CPP_HEADER_IMPORT](agent/TRACK_CPP_HEADER_IMPORT.md). Известные пробелы → Phase 3.6.
...
Дизайн: [CPP_PARSER_DESIGN.md](CPP_PARSER_DESIGN.md). Трек: [TRACK_CPP_PARSER_FULL](agent/TRACK_CPP_PARSER_FULL.md).
