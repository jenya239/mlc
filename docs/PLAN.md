...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_RETAINED_PAINT (§108, open 2026-08-03 — QUEUE HEAD, ahead of §107q remainder;
      §108a EDITOR_DIRTY_TAXONOMY (CLOSED 2026-08-03)
        → §108b EDITOR_RETAIN_TEXT_LAYER (Decision+Red done; Driver STEP=2 Green next)
  ...
  → **EDITOR_HYGIENE (§107, open — remainder AFTER §108; was QUEUE HEAD 2026-08-01; authorized ahead of §103a/§104 W2;
      ...
      §107a–§107p CLOSED; §107q q3 Critic blocked on UX ×2 (disk)
        ...
        → §107q EDITOR_DRAW_OPS (q3 Critic: green+sab ok; UX ×2 blocked — disk)
  ...
  → COMPILER_ARCHITECTURE_HYGIENE Wave 2 (§104 — Wave 1 CLOSED; Wave 2 **queued last**,
      behind §107 and §103a; pulling it ahead of §107 P0 requires a new explicit user override
