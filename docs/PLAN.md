...
| **57** | Editor idle multi-caret paint overlay (§56 residual) | **active** — STEP=1 done → Driver STEP=2 | [TRACK_EDITOR_IDLE_MULTI_CARET_OVERLAY](agent/TRACK_EDITOR_IDLE_MULTI_CARET_OVERLAY.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_IDLE_MULTI_CARET_OVERLAY (§57, active: STEP=1 red done → Driver STEP=2;
