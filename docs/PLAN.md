...
| **80** | Editor paint reuses frame LineIndex (#1d residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX](agent/TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_PAINT_REUSE_FRAME_LINE_INDEX (§80, open STEP=3 Critic next:
