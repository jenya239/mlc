...
| **46** | Editor UX backlog — #1…#1d+#2+#3+#4+#5+#6+#7+#8+#9 done; next `#10 EDITOR_AUTO_INDENT` | **active** (2026-07-18) #9 closed; #10 next | [TRACK_EDITOR_UX_BACKLOG](agent/TRACK_EDITOR_UX_BACKLOG.md) · [archive/tracks/TRACK_EDITOR_DRAG_AUTOSCROLL](archive/tracks/TRACK_EDITOR_DRAG_AUTOSCROLL.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_UX_BACKLOG (§46, **active**; #1…#1d+#2+#3+#4+#5+#6+#7+#8+#9 closed; next `#10 EDITOR_AUTO_INDENT`;
