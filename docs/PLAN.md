...
| **47** | MLC concurrency refinement backlog — `#2 CONCURRENCY_SEND_BOUND` active STEP=1 done → Driver STEP=2; #3…#11 pending | **active** (2026-07-20) Driver `#2` STEP=2 | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_SEND_BOUND](agent/TRACK_CONCURRENCY_SEND_BOUND.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
