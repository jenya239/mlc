...
| **18** Package manager | **active** (2026-07-13) STEP=1 design deps model | [TRACK_PACKAGE_MANAGER](agent/TRACK_PACKAGE_MANAGER.md) — Steps 1–4 design then 5–10; `mlc.json`+git+rev candidate |
