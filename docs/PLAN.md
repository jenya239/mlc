...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_TERMINAL (§102, open — §102a/§102b/§102c/§102d/§102e CLOSED,
      §102f `TERMINAL_PANEL_INTEGRATION` next, of
