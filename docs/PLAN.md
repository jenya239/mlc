...
| **18** Package manager | **active** (STEP=6 done; STEP=7 resolver) | [TRACK_PACKAGE_MANAGER](agent/TRACK_PACKAGE_MANAGER.md) — fetch CLI; Steps 7–10 |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **PACKAGE_MANAGER (**active** 2026-07-13: STEP=1–6 done — Manifest+Fetcher;
      STEP=7 `pkg/path` → `.mlc_packages/` resolver next;
