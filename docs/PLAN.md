...
| **57** | Editor idle multi-caret paint overlay (§56 residual) | **active** — STEP=2 done → Critic STEP=3 | [TRACK_EDITOR_IDLE_MULTI_CARET_OVERLAY](agent/TRACK_EDITOR_IDLE_MULTI_CARET_OVERLAY.md) |
