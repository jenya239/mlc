...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_SCRIPT_VM Phase 1 (§103d `SCRIPT_VM_INTERPRETER_ARITHMETIC` — QUEUE HEAD; §103c CLOSED;
