...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_CARET_VISUAL_ROW_CACHE (§101, open STEP=0 next — §104 Wave 1 closed 2026-07-31:
