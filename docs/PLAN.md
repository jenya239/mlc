...
| **25** | Concurrency Supervisor — реализация (гейт снят) | **active** (2026-07-12) | [TRACK_CONCURRENCY_SUPERVISOR](agent/TRACK_CONCURRENCY_SUPERVISOR.md) **active** STEP=1 done; STEP=2 restart policies next |
