...
| **15** Debugging story (`#line` → `.mlc` в stack trace) | **active** (2026-07-13) STEP=3 done; STEP=4 gdb verify next | [TRACK_DEBUG_SOURCE_MAP](agent/TRACK_DEBUG_SOURCE_MAP.md) — Ruby+mlcc `#line` |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **DEBUG_SOURCE_MAP (**active** 2026-07-13: STEP=3 mlcc `#line` done; STEP=4
      gdb/addr2line verify next;
