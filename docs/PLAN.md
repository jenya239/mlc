...
| **50** | Editor idle caret blink (#38 residual: blink freezes on idle early-out) | **active** (2026-07-22) Driver STEP=2 | [TRACK_EDITOR_IDLE_CARET_BLINK](agent/TRACK_EDITOR_IDLE_CARET_BLINK.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_IDLE_CARET_BLINK (§50, **active** 2026-07-22: STEP=1→Driver STEP=2;
