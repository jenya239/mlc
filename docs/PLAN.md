...
| **81** | Editor scroll reuses frame LineIndex (§80 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX](agent/TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX (§81, open STEP=3 Critic next:
      scroll reuses frame LineIndex; [TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX](agent/TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX.md))**
```
