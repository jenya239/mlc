...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **parked** (2026-07-15) Phase D STEP=2 done; STEP=3+ after §33b | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_D](agent/TRACK_GUI_SCENE_PHASE_D.md); Phase A/B/C archive |
...
| **29** | Retained affine-transform scene graph (Figma/blueprint canvas + classic + game + Flash-rich UI — один фундамент) | **parked** (2026-07-15) Phase D after §33b LIVE_POLISH | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_D](agent/TRACK_GUI_SCENE_PHASE_D.md) |
...
| **33b** | Editor/GUI **live polish** (scissor, cursor, clipboard, command bus, frame split) — model≠product gap | **PRIORITY / queue head** (2026-07-15) STEP=7 **done**; **STEP=8** Scene/chrome Decision next; Phase D parked | [TRACK_EDITOR_LIVE_POLISH](agent/TRACK_EDITOR_LIVE_POLISH.md); review `mlc-support/responses/gui_editor_architecture_20260715_105621.md` |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_LIVE_POLISH (§33b, **PRIORITY OVERRIDE** 2026-07-15: queue head; STEP=7 done; STEP=8 Scene/chrome Decision next;
  ...
  → **GUI_CANVAS_GRAPH Phase D (**parked**; STEP=2 done; resume STEP=3 Path tess after §33b Critic;
      → [agent/TRACK_GUI_SCENE_PHASE_D.md](agent/TRACK_GUI_SCENE_PHASE_D.md))**
```
