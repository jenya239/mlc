...
| **46** | Editor UX backlog — `#37 EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP` **active** (STEP=1 → Driver STEP=2); `#38` closed | **active** (2026-07-22) Driver `#37` STEP=2 | [TRACK_EDITOR_UX_BACKLOG](agent/TRACK_EDITOR_UX_BACKLOG.md) · [TRACK_EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP](agent/TRACK_EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP.md) · [archive/TRACK_EDITOR_IDLE_BUSY_LOOP_92PCT_CPU](archive/tracks/TRACK_EDITOR_IDLE_BUSY_LOOP_92PCT_CPU.md) · [archive/TRACK_EDITOR_WRAP_PER_FRAME_ON_LARGE_FILE](archive/tracks/TRACK_EDITOR_WRAP_PER_FRAME_ON_LARGE_FILE.md) · [archive/TRACK_EDITOR_MINIMAP](archive/tracks/TRACK_EDITOR_MINIMAP.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_UX_BACKLOG (§46, **active** 2026-07-22: `#37 EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP` STEP=1→Driver STEP=2; `#38` closed Critic OK; #1…#36 closed (#22 superseded);
      → [agent/TRACK_EDITOR_UX_BACKLOG.md](agent/TRACK_EDITOR_UX_BACKLOG.md) ·
        [agent/TRACK_EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP.md](agent/TRACK_EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP.md) ·
