...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_TERMINAL (§102, open — §102a/§102b/§102c all CLOSED,
      §102d `TERMINAL_INPUT_FORWARD` next of
