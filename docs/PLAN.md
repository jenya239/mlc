...
| **18** Package manager | **active** (STEP=3 done; STEP=4 docs freeze) | [TRACK_PACKAGE_MANAGER](agent/TRACK_PACKAGE_MANAGER.md) — no version gate; Steps 4 design then 5–10 |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **PACKAGE_MANAGER (**active** 2026-07-13: STEP=1–3 done — manifest+vendor+
      no version gate; STEP=4 `docs/PACKAGE_MANAGER.md` next;
