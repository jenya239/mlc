...
| **51** | Editor idle CPU budget (live `/proc` sample; #38 residual) | **active** (2026-07-22) Critic STEP=3 | [TRACK_EDITOR_IDLE_CPU_BUDGET](agent/TRACK_EDITOR_IDLE_CPU_BUDGET.md) |
