...
| **46** | Editor UX backlog — #1…#1d+#2+#3 done; **#4 `EDITOR_MOUSE_WORD_LINE_SELECT` active** (STEP=1 done 2026-07-18; STEP=2 next) | **active** (2026-07-18) #4 STEP=2 | [TRACK_EDITOR_UX_BACKLOG](agent/TRACK_EDITOR_UX_BACKLOG.md) · [TRACK_EDITOR_MOUSE_WORD_LINE_SELECT](agent/TRACK_EDITOR_MOUSE_WORD_LINE_SELECT.md) |
