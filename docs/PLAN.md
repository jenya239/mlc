...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **TEXT_GL_PERF_BASELINE (active 2026-07-12: STEP=1 done face/font cache;
    STEP=2 concurrency note next; Part A then Part B bearing;
