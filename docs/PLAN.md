...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_SCRIPT_VM Phase 1 (§103b `SCRIPT_VM_BYTECODE_FORMAT` — QUEUE HEAD; Red done; Green next;
