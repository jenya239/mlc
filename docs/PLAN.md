...
| **23** | GUI input robustness (debounce клика, keyboard text, resize) | **active** (2026-07-12) | [TRACK_GUI_INPUT_ROBUSTNESS](agent/TRACK_GUI_INPUT_ROBUSTNESS.md) **active** STEP=4 done (text field demo); STEP=5 resize next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_INPUT_ROBUSTNESS (active 2026-07-12: STEP=3 done; STEP=4 text-field demo next;
