...
| **20b** MSDF (EDT/SDF) алгоритм — порт на MLC | **open, active** | [TRACK_TEXT_MSDF_TO_MLC](agent/TRACK_TEXT_MSDF_TO_MLC.md) **active** STEP=2 (STEP=1 done: Felzenszwalb EDT Decision locked; golden fixture next) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **TEXT_MSDF_TO_MLC (**active** STEP=2 — Decision locked; golden C++ fixture next;
