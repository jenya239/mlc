...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **priority / active** (2026-07-15) Phase C **closed** Critic OK; Phase D next (Planner) | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md); Phase C → [archive/tracks/TRACK_GUI_SCENE_PHASE_C.md](archive/tracks/TRACK_GUI_SCENE_PHASE_C.md) |
...
| **29** | Retained affine-transform scene graph (Figma/blueprint canvas + classic + game + Flash-rich UI — один фундамент) | **priority / active** (2026-07-15) Phase C closed Critic OK (`d0a3996f`…`64014467`); Phase D next | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md); [archive/tracks/TRACK_GUI_SCENE_PHASE_C.md](archive/tracks/TRACK_GUI_SCENE_PHASE_C.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_CANVAS_GRAPH Phase D (**PRIORITY / queue head next — Planner opens TRACK)**
```
