...
| **15** Debugging story (`#line` → `.mlc` в stack trace) | **active** (2026-07-13) STEP=1 Design Decision | [TRACK_DEBUG_SOURCE_MAP](agent/TRACK_DEBUG_SOURCE_MAP.md) — после TEXT_GLYPH Critic; Steps 1–5 |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **DEBUG_SOURCE_MAP (**active** 2026-07-13: STEP=1 Design `#line` Decision next;
