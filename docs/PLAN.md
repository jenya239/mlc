...
| **90** | Editor demo open-path without stringify (§89 residual) | **open** STEP=2 next | [agent/TRACK_EDITOR_DEMO_OPEN_PATH_NO_STRINGIFY](agent/TRACK_EDITOR_DEMO_OPEN_PATH_NO_STRINGIFY.md) |
