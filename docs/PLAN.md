...
| **21** | Compile-smoke coverage для `misc/examples`/`misc/gui` (regression молчала на `gui_button_demo.mlc`) | **active** (2026-07-12) | [TRACK_EXAMPLES_CI](agent/TRACK_EXAMPLES_CI.md) **active** STEP=9 done (ABI link/soft-skip); STEP=10 cluster D next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EXAMPLES_CI (active 2026-07-12: STEP=8 done; STEP=9 cluster C next;
