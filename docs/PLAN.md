...
| **75** | Editor minimap zoom-linked scale (§74 / #35 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_MINIMAP_ZOOM_SCALE](agent/TRACK_EDITOR_MINIMAP_ZOOM_SCALE.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_MINIMAP_ZOOM_SCALE (§75, open STEP=3 Critic next:
