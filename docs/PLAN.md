...
| **99** | Editor word-delete without full stringify (§98 / #1d residual) | **open** STEP=0 done; STEP=1 red next | [agent/TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY](agent/TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY.md) |
