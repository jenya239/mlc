...
| **23** | GUI input robustness (debounce клика, keyboard text, resize) | **active** (2026-07-12) | [TRACK_GUI_INPUT_ROBUSTNESS](agent/TRACK_GUI_INPUT_ROBUSTNESS.md) **active** STEP=1 next — controlled `gui_click_edge` repro |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_INPUT_ROBUSTNESS (active 2026-07-12: STEP=1 controlled click-edge repro next;
