...
| **14** FFI safety contract | **open, active** | [TRACK_FFI_SAFETY](agent/TRACK_FFI_SAFETY.md) **active** STEP=2 (STEP=1 Decision B locked: no `unsafe` syntax; warning; 255 extern/0 attrs) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **FFI_SAFETY (**active** STEP=2 — Decision B locked; warning + stdlib annotate;
