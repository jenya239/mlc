...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_SCRIPT_VM Phase 1 (§103e `SCRIPT_VM_CONTROL_FLOW` — QUEUE HEAD; §103d CLOSED;
