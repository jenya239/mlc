...
| **63** | Editor folder scrollbar thumb drag (§62 / §61 residual) | **active** — STEP=0 done → Driver STEP=1 | [TRACK_EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG](agent/TRACK_EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG (§63, active: STEP=0 Decision → Driver STEP=1;
      §62 residual — folder thumb drag → tree_scroll_y;
      → [agent/TRACK_EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG.md](agent/TRACK_EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG.md))**
```
