...
| **20e** GL-вызовы через GLAD2, без ручного C++ dispatch | **open, active** | [TRACK_GL_GLAD_MIGRATION](agent/TRACK_GL_GLAD_MIGRATION.md) **active** STEP=7 (STEP=6: REG 20/0 + self-host DIFF 0; docs next) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GL_GLAD_MIGRATION (**active** STEP=7 — STEP=6 REG 20/0 + self-host DIFF 0; docs+close;
