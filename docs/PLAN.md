...
| **47** | MLC concurrency refinement backlog — `#9 CONCURRENCY_ISOLATE_MLC_SURFACE` **done**; next Planner `#10 CONCURRENCY_SUPERVISOR_MLC_SURFACE`; #11 pending | **active** (2026-07-21) Planner `#10` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/tracks/TRACK_CONCURRENCY_ISOLATE_MLC_SURFACE](archive/tracks/TRACK_CONCURRENCY_ISOLATE_MLC_SURFACE.md) · [archive/tracks/TRACK_CONCURRENCY_FFI_METADATA](archive/tracks/TRACK_CONCURRENCY_FFI_METADATA.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-21: `#9 CONCURRENCY_ISOLATE_MLC_SURFACE` **closed**; next Planner `#10 CONCURRENCY_SUPERVISOR_MLC_SURFACE`;
