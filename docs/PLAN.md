...
| **38** | Editor folder browser (breadcrumbs + listing; absorb WIP) | **active** (2026-07-16) STEP=0 next | [TRACK_EDITOR_FOLDER_BROWSER](agent/TRACK_EDITOR_FOLDER_BROWSER.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_FOLDER_BROWSER (§38, **active**; STEP=0 Decision next;
