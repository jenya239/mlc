...
| **37** | GLFW `content_scale` (HiDPI) — residual from §36 STEP=7 | **active** (2026-07-16) STEP=3 **done**; **STEP=4** Critic next | [TRACK_GLFW_CONTENT_SCALE](agent/TRACK_GLFW_CONTENT_SCALE.md) |
