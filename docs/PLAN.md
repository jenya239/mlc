...
| **78** | Editor minimap highlight span cache (§77 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_MINIMAP_HIGHLIGHT_CACHE](agent/TRACK_EDITOR_MINIMAP_HIGHLIGHT_CACHE.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_MINIMAP_HIGHLIGHT_CACHE (§78, open STEP=3 Critic next:
      cache full-buffer spans for minimap rebuild; [TRACK_EDITOR_MINIMAP_HIGHLIGHT_CACHE](agent/TRACK_EDITOR_MINIMAP_HIGHLIGHT_CACHE.md))**
```
