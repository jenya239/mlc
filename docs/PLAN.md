...
| **33** | Native code editor MVP + mlc-support preflight; editor-first GUI architecture frozen | **priority / active** (2026-07-14) STEP=pre…12 **done**; **STEP=13** next (scroll perf) | [EDITOR.md](EDITOR.md) + [GUI_ARCHITECTURE.md](GUI_ARCHITECTURE.md) + [TRACK_EDITOR_MVP](agent/TRACK_EDITOR_MVP.md); GLFW PlatformBackend v1; GUI Phase B deferred |
