...
| **47** | MLC concurrency refinement backlog — `#8 CONCURRENCY_FFI_METADATA` active STEP=0 done → Driver STEP=1; #9…#11 pending | **active** (2026-07-21) Driver `#8` STEP=1 | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [TRACK_CONCURRENCY_FFI_METADATA](agent/TRACK_CONCURRENCY_FFI_METADATA.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **MLC_CONCURRENCY_REFINEMENT (§47, **active** 2026-07-21: `#8 CONCURRENCY_FFI_METADATA` STEP=0 done → Driver STEP=1;
