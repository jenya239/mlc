...
| **99** | Editor word-delete without full stringify (§98 / #1d residual) | **open** STEP=1 done; STEP=2 green next | [agent/TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY](agent/TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY.md) |
