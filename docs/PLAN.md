...
| **46** | Editor UX backlog — #1…#35 done (#22 superseded); `#36 EDITOR_WRAP_PER_FRAME_ON_LARGE_FILE` active STEP=2 done → Driver STEP=3 (priority ahead of §47 #3) | **active** (2026-07-20) Driver `#36` STEP=3 | [TRACK_EDITOR_UX_BACKLOG](agent/TRACK_EDITOR_UX_BACKLOG.md) · [TRACK_EDITOR_WRAP_PER_FRAME_ON_LARGE_FILE](agent/TRACK_EDITOR_WRAP_PER_FRAME_ON_LARGE_FILE.md) · [archive/TRACK_EDITOR_MINIMAP](archive/tracks/TRACK_EDITOR_MINIMAP.md) |
