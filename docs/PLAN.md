...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **active** (2026-07-16) Phase D STEP=5 **done**; **STEP=6** blueprint MVP next | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_D](agent/TRACK_GUI_SCENE_PHASE_D.md); Phase A/B/C archive |
...
| **29** | Retained affine-transform scene graph (Figma/blueprint canvas + classic + game + Flash-rich UI — один фундамент) | **active** (2026-07-16) Phase D STEP=4 done; **STEP=5** wire next | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) + [TRACK_GUI_SCENE_PHASE_D](agent/TRACK_GUI_SCENE_PHASE_D.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_CANVAS_GRAPH Phase D (**active**; STEP=4 done; **STEP=5** wire next;
