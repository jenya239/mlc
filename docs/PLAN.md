...
| **33a** | Headless UX harness (semantic scenarios ★, inject, probes; pixel MAE rare) | **priority / active** (2026-07-14) STEP=0–11 **done**; **STEP=12** next | [GUI_UX_TESTING.md](GUI_UX_TESTING.md) + [TRACK_UX_HEADLESS](agent/TRACK_UX_HEADLESS.md); L1–L9 live-shell backlog |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **UX_HEADLESS (§33a, PRIORITY 2026-07-14 — queue head; STEP=0–11 done; STEP=12 next;
