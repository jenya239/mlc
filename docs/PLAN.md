...
| **47** | MLC concurrency refinement backlog — `#2` done; next `#3 CONCURRENCY_MOVE_TRACKING` queued; #4…#11 pending | **active** (2026-07-20) Planner open `#3` | [TRACK_MLC_CONCURRENCY_REFINEMENT](agent/TRACK_MLC_CONCURRENCY_REFINEMENT.md) · [archive/TRACK_CONCURRENCY_SEND_BOUND](archive/tracks/TRACK_CONCURRENCY_SEND_BOUND.md) · [CONCURRENCY_V2.md](CONCURRENCY_V2.md) |
