...
| **76** | Editor minimap strip width × font zoom (§75 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_MINIMAP_WIDTH_ZOOM](agent/TRACK_EDITOR_MINIMAP_WIDTH_ZOOM.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_MINIMAP_WIDTH_ZOOM (§76, open STEP=3 Critic next:
      strip width × font zoom; [TRACK_EDITOR_MINIMAP_WIDTH_ZOOM](agent/TRACK_EDITOR_MINIMAP_WIDTH_ZOOM.md))**
```
