...
| **13c** VM: массив/map только `i32` (не point-fix, value-model) | **open, active** | [TRACK_VM_TYPED_COLLECTIONS](agent/TRACK_VM_TYPED_COLLECTIONS.md) **active** STEP=3 (field-slot smokes); Shared/VmFieldSlot elements done |
