...
| **17** `T!E` error-union sugar | **open, active** | [TRACK_LANG_ERROR_UNION](agent/TRACK_LANG_ERROR_UNION.md) **active** STEP=2 (STEP=1: Design locked — type postfix `!` → `Result`) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **LANG_ERROR_UNION (**active** STEP=2 — Ruby `T!E` desugar;
