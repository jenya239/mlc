...
| **86** | Editor probe reuses LineIndex text (§85 residual) | **open** STEP=3 Critic next | [agent/TRACK_EDITOR_PROBE_REUSE_LINE_INDEX_TEXT](agent/TRACK_EDITOR_PROBE_REUSE_LINE_INDEX_TEXT.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_PROBE_REUSE_LINE_INDEX_TEXT (§86, open STEP=3 Critic next:
