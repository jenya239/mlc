...
| **39** | Editor font config path (DejaVuMono default; no Fontconfig) | **active** (2026-07-16) STEP=0 **done**; STEP=1 next | [TRACK_EDITOR_FONT_CONFIG](agent/TRACK_EDITOR_FONT_CONFIG.md) |
