...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_HYGIENE (§107, open — QUEUE HEAD again after §108; authorized ahead of §103a/§104 W2;
      ...
      §107a–§107q CLOSED; §107r Decision frozen; STEP=1 Red next
        ...
        → §107r EDITOR_UX_GATE_BEHAVIORAL (Decision frozen; Red next)
