...
| **18** Package manager | **active** (STEP=4 done; design frozen; STEP=5 parser) | [TRACK_PACKAGE_MANAGER](agent/TRACK_PACKAGE_MANAGER.md) — [PACKAGE_MANAGER.md](PACKAGE_MANAGER.md); Steps 5–10 impl |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **PACKAGE_MANAGER (**active** 2026-07-13: STEP=1–4 done — design frozen in
      [PACKAGE_MANAGER.md](PACKAGE_MANAGER.md); STEP=5 Ruby `mlc.json` parser next;
