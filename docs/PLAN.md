...
| **24** | HTTP server hardening (keep-alive, лимиты, static files, graceful shutdown doc) | **active** (2026-07-12) | [TRACK_STDLIB_HTTP_HARDENING](agent/TRACK_STDLIB_HTTP_HARDENING.md) **active** STEP=1–2 done; STEP=3 idle timeout next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **STDLIB_HTTP_HARDENING (active 2026-07-12: STEP=1–2 done; STEP=3 idle timeout next;
