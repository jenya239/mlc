...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **TEXT_GL_PERF_BASELINE (active 2026-07-12: STEP=1–5 done, bench ~47× user
    CPU; STEP=6 smokes next; Part B bearing after;
