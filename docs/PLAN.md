...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **VM_TRAMPOLINE STEP=1–2 (**done** 2026-07-10: trampoline + corpus
    cpp_diff 18 / single-file 18+diff / examples 28) → STEP=3 (**next** —
    ≥100k fixture) → STEP=4–5** — host loop replaces per-step
