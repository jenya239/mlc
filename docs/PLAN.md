...
| **41** | Editor caret blink (UX L8 `caret_blink_phases` + live helper) | **active** (2026-07-16) STEP=0 **done**; STEP=1 next | [TRACK_EDITOR_CARET_BLINK](agent/TRACK_EDITOR_CARET_BLINK.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_CARET_BLINK (§41, **active**; STEP=0 Decision next;
