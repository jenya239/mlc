...
| **10c** Retained scene-graph фундамент (classic UI + game UI + Flash-rich + Figma/blueprint canvas — один фреймворк) | **active** (2026-07-13) Phase A closed (awaiting Critic); Phase B next after Critic | [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) → [TRACK_GUI_SCENE_PHASE_A](archive/tracks/TRACK_GUI_SCENE_PHASE_A.md) |
...
| **29** | Retained affine-transform scene graph (Figma/blueprint canvas + classic + game + Flash-rich UI — один фундамент) | **active** (2026-07-13) Phase A closed STEP=1–7; awaiting Critic | [TRACK_GUI_SCENE_PHASE_A](archive/tracks/TRACK_GUI_SCENE_PHASE_A.md) — epic [TRACK_GUI_CANVAS_GRAPH](agent/TRACK_GUI_CANVAS_GRAPH.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **GUI_CANVAS_GRAPH (**active** 2026-07-13: Phase A **closed** STEP=1–7,
      awaiting Critic; Phase B after Critic OK;
      phase A → [archive/tracks/TRACK_GUI_SCENE_PHASE_A.md](archive/tracks/TRACK_GUI_SCENE_PHASE_A.md);
      epic → [agent/TRACK_GUI_CANVAS_GRAPH.md](agent/TRACK_GUI_CANVAS_GRAPH.md))**
    Phase B–D on phase close only (Planner opens phase tracks).
```
