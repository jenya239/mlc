...
| **27** | Language reference manual (`docs/LANGUAGE_REFERENCE.md`) | **active** (2026-07-12) | [TRACK_LANG_DOCS](agent/TRACK_LANG_DOCS.md) **active** STEP=1 done; STEP=2 bindings+functions next |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **LANG_DOCS (active 2026-07-12: STEP=1 done; STEP=2 bindings+functions next;
