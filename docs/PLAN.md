...
| **46** | Editor UX backlog — #1…#1d+#2+#3+#4+#5+#6+#7+#8 done; next `#9 EDITOR_DRAG_AUTOSCROLL` | **active** (2026-07-18) #8 closed; #9 next | [TRACK_EDITOR_UX_BACKLOG](agent/TRACK_EDITOR_UX_BACKLOG.md) · [archive/tracks/TRACK_EDITOR_GOTO_LINE](archive/tracks/TRACK_EDITOR_GOTO_LINE.md) |
...
PARSE_PROGRAM_RESULT → CODE_QUALITY → FORMATTER → PHASE26_REMAINING
  ...
  → **EDITOR_UX_BACKLOG (§46, **active**; #1…#1d+#2+#3+#4+#5+#6+#7+#8 closed; next `#9 EDITOR_DRAG_AUTOSCROLL`;
