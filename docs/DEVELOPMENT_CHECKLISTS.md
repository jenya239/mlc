...
- [ ] **Codegen:** `semantic_ir` на входе; не тащить checker-логику обратно в eval.
...
- [ ] Число MLC-тестов в таблицах — периодически синхронять с фактическим выводом `rake test_compiler_mlc` (сейчас ориентир: 183).
