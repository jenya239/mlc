...
**Baseline:** build_tests **1125/0**; build.sh ok; **diff_exit=0**.
...
| 5 | `import "header.h"` wiring + registry; tests; close track | done |
...
**STEP=5 note (2026-06-21 Driver):** `cpp/header_import.mlc` — `.h`/`.hpp` path in `main.mlc`; cpp parse → extern `DeclFn`/types; `test_cpp_header_import.mlc` + fixture. Gate **1125/0**; **diff_exit=0**. Track **closed**.
