...
Honest residual: live process CPU sample (&lt;10%) optional, not measured here — **fixed** §51
`TRACK_EDITOR_IDLE_CPU_BUDGET` (Critic OK 2026-07-22). Caret blink may freeze
