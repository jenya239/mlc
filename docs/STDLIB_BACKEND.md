...
| WebSocket | `std/net/websocket.mlc`; thin `websocket_bridge.hpp` | **есть, MLC** (2026-07-11 STEP=5): upgrade/frames/handshake in MLC; gate `run_websocket_gate.sh` (MLC echo + Ruby client); [TRACK_STDLIB_WEBSOCKET_TO_MLC](agent/TRACK_STDLIB_WEBSOCKET_TO_MLC.md) STEP=6. Residual: Ruby `:extern` stubs in bridge |
