...
| Validation/schema | — | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=1 (philosophy first) |
...
| Validation | декларативные схемы для входных данных | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=2 |
...
7. **Validation** — **[TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md)
   open** STEP=1. Philosophy Decision first (compile-time vs runtime; §3/§5.7).
