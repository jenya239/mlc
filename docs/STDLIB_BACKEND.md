...
Keep-alive / size limits / idle `SO_RCVTIMEO` / `serve_static` land under
[TRACK_STDLIB_HTTP_HARDENING](agent/TRACK_STDLIB_HTTP_HARDENING.md) (status
row in §1 table updated when that track’s docs step lands).
