...
| WebSocket | `runtime/include/mlc/net/websocket.hpp`; `std/net/websocket.mlc` | **partial** (2026-07-10): runtime + MLC `WebSocket` (`mlc::websocket`); gate STEP=4 [TRACK_STDLIB_WEBSOCKET](agent/TRACK_STDLIB_WEBSOCKET.md) |
