...
| WebSocket | upgrade handshake, frame parsing поверх TCP сервера | **open** — [TRACK_STDLIB_WEBSOCKET](agent/TRACK_STDLIB_WEBSOCKET.md) STEP=1 |
...
4. **WebSocket** — **[TRACK_STDLIB_WEBSOCKET](agent/TRACK_STDLIB_WEBSOCKET.md)
   open** STEP=1 (API Decision). Server upgrade + text frames on TCP.
