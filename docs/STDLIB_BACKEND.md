...
| Validation/schema | `runtime/include/mlc/validate/validate.hpp`; `std/validate/validate.mlc` | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=3 |
...
| Validation | декларативные схемы для входных данных | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=4 |
...
7. **Validation** — **[TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md)
   open** STEP=3. Runtime `validate.hpp` + extern MLC; registry next.
