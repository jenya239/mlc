...
| Crypto | hash (SHA-256), HMAC, bcrypt/argon2 для паролей, JWT sign/verify | **open** — [TRACK_STDLIB_CRYPTO](agent/TRACK_STDLIB_CRYPTO.md) STEP=4 |
...
3. **Crypto** — **[TRACK_STDLIB_CRYPTO](agent/TRACK_STDLIB_CRYPTO.md) open**
   STEP=4. Runtime + `std/crypto/crypto` done; next gate.
