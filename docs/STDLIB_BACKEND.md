...
| Validation/schema | — | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=2 (explicit helpers; pure MLC) |
...
| Validation | декларативные схемы для входных данных | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=3 |
...
7. **Validation** — **[TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md)
   open** STEP=2. Decision: explicit runtime helpers; pure MLC `Validate`;
