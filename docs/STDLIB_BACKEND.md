...
| WebSocket | `runtime/include/mlc/net/websocket.hpp`; `std/net/websocket.mlc` | **partial** (2026-07-10): runtime + MLC; gate `run_websocket_gate.sh` OK; docs STEP=5 [TRACK_STDLIB_WEBSOCKET](agent/TRACK_STDLIB_WEBSOCKET.md) |
...
| WebSocket | upgrade handshake, frame parsing поверх TCP сервера | **partial** — runtime+MLC; gate STEP=4 [TRACK_STDLIB_WEBSOCKET](agent/TRACK_STDLIB_WEBSOCKET.md) |
...
4. **WebSocket** — **[TRACK_STDLIB_WEBSOCKET](agent/TRACK_STDLIB_WEBSOCKET.md)
   open** STEP=4. Runtime + `std/net/websocket.mlc` done; next echo gate.
