...
| Crypto | hash (SHA-256), HMAC, bcrypt/argon2 для паролей, JWT sign/verify | **open** — [TRACK_STDLIB_CRYPTO](agent/TRACK_STDLIB_CRYPTO.md) STEP=1 (JWT out of this track) |
...
3. **Crypto** — **[TRACK_STDLIB_CRYPTO](agent/TRACK_STDLIB_CRYPTO.md) open**
   STEP=1 (API Decision). libsodium: SHA-256 / HMAC / random / `crypto_pwhash`.
   JWT — follow-up after this track.
