...
| Validation/schema | `std/validate/validate.mlc` (pure MLC; `validate.hpp` deleted) | **есть** (2026-07-11 STEP=4): ValidateSuccess Ok payload; messages unchanged; mlcc `validate_mlc_smoke.mlc` |
...
7. **Validation** — [TRACK_STDLIB_VALIDATION](archive/tracks/TRACK_STDLIB_VALIDATION.md)
   **closed** 2026-07-11; logic ported to MLC in [TRACK_STDLIB_LOGIC_TO_MLC](agent/TRACK_STDLIB_LOGIC_TO_MLC.md)
