...
| Validation/schema | `runtime/include/mlc/validate/validate.hpp`; `std/validate/validate.mlc` | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=4 |
...
| Validation | декларативные схемы для входных данных | **open** — [TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md) STEP=5 |
...
7. **Validation** — **[TRACK_STDLIB_VALIDATION](agent/TRACK_STDLIB_VALIDATION.md)
   open** STEP=4. Registry done; gate next.
