...
See also [TRACK_STDLIB_HTTP_HARDENING](agent/TRACK_STDLIB_HTTP_HARDENING.md) and the §1 HTTP row above for keep-alive / limits / idle timeout / `serve_static` status.
