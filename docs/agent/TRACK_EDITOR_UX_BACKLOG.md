...
| 2 | `EDITOR_KEYBOARD_NAV_WIRE` | Wire arrow keys/Home/End/PageUp/PageDown (model exists in `document/navigation.mlc`, not called from demo) | `arrow_keys_move_caret`, `home_end_caret` | M | **active** — [TRACK_EDITOR_KEYBOARD_NAV_WIRE](TRACK_EDITOR_KEYBOARD_NAV_WIRE.md) STEP=2 next (STEP=1 red) |
