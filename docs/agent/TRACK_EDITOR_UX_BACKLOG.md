...
| 28 | `EDITOR_WIDE_CHAR_COLUMNS` | wcwidth-style column width for emoji/CJK (only if taken on) | `wide_char_column_width` (L0) | M | **active** STEP=0 done → STEP=1 — [TRACK_EDITOR_WIDE_CHAR_COLUMNS](TRACK_EDITOR_WIDE_CHAR_COLUMNS.md) |
