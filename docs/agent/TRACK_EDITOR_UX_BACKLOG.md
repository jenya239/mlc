...
| 3 | `EDITOR_WORD_BOUNDARIES` | Word-boundary helper in `document/`; Ctrl+Left/Right, Ctrl+Backspace/Delete | `ctrl_arrow_word_jump`, `ctrl_backspace_deletes_word` | M | **active** — [TRACK_EDITOR_WORD_BOUNDARIES](TRACK_EDITOR_WORD_BOUNDARIES.md) STEP=1 next (STEP=0 done) |
