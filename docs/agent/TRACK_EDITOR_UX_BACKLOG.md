...
| 25 | `EDITOR_CONTEXT_MENU` | Right-click → cut/copy/paste menu | `context_menu_opens` | M | **active** STEP=2 done → STEP=3 — [TRACK_EDITOR_CONTEXT_MENU](TRACK_EDITOR_CONTEXT_MENU.md) |
