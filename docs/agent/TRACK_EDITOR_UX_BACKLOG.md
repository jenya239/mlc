...
| 21 | `EDITOR_DIRTY_CLOSE_L1` | L1 scenario for dirty-close overlay discard/cancel click (currently L0-only) | `dirty_close_overlay_click` | S | **active** — [TRACK_EDITOR_DIRTY_CLOSE_L1](TRACK_EDITOR_DIRTY_CLOSE_L1.md) |
