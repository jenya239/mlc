...
## Status: **active** (2026-07-18) — #1…#1d+#2+#3+#4+#5+#6+#7+#8+#9 done; **#10 `EDITOR_AUTO_INDENT` opened** (STEP=2 done; Critic next)
...
| 10 | `EDITOR_AUTO_INDENT` | Enter preserves leading indent of current line | `enter_keeps_indent` | S | **active** — [TRACK_EDITOR_AUTO_INDENT](TRACK_EDITOR_AUTO_INDENT.md) STEP=3 Critic next (STEP=2 done) |
