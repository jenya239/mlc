...
## Status: **active** (2026-07-18) — #1…#1d+#2+#3+#4 done; **#5 `EDITOR_SHIFT_CLICK_EXTEND` opened** (STEP=0 done)
...
| 5 | `EDITOR_SHIFT_CLICK_EXTEND` | Shift-click extends selection from anchor | `shift_click_extends_selection` | S | **active** — [TRACK_EDITOR_SHIFT_CLICK_EXTEND](TRACK_EDITOR_SHIFT_CLICK_EXTEND.md) STEP=2 next (STEP=1 red harness done) |
