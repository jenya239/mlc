...
## Status: **active** (2026-07-18) — #1…#1d+#2+#3+#4+#5+#6+#7+#8 done; **#9 `EDITOR_DRAG_AUTOSCROLL` opened** (STEP=1 done)
...
| 9 | `EDITOR_DRAG_AUTOSCROLL` | Drag past viewport edge auto-scrolls (multi-frame stateful) | `drag_past_edge_autoscrolls` (L1.5) | M | **active** — [TRACK_EDITOR_DRAG_AUTOSCROLL](TRACK_EDITOR_DRAG_AUTOSCROLL.md) STEP=2 next (STEP=1 red harness done) |
