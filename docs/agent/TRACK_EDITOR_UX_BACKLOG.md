...
| 4 | `EDITOR_MOUSE_WORD_LINE_SELECT` | Double-click selects word, triple-click selects line, click timing via `UxDriver` | `double_click_selects_word`, `triple_click_selects_line` | M | **active** — [TRACK_EDITOR_MOUSE_WORD_LINE_SELECT](TRACK_EDITOR_MOUSE_WORD_LINE_SELECT.md) STEP=2 next (STEP=1 red harness done) |
