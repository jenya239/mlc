...
| 5 | `EDITOR_SHIFT_CLICK_EXTEND` | Shift-click extends selection from anchor | `shift_click_extends_selection` | S | **active** — [TRACK_EDITOR_SHIFT_CLICK_EXTEND](TRACK_EDITOR_SHIFT_CLICK_EXTEND.md) STEP=3 Critic (STEP=2 done) |
