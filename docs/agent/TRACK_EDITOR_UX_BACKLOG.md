...
## Status: **active** (2026-07-18) — #1…#1d+#2+#3+#4+#5+#6+#7 done; **#8 `EDITOR_GOTO_LINE` opened** (STEP=2 done; Critic next)
...
| 8 | `EDITOR_GOTO_LINE` | Ctrl+G → line number → scroll+caret | `goto_line_scrolls_caret` | S | **active** — [TRACK_EDITOR_GOTO_LINE](TRACK_EDITOR_GOTO_LINE.md) STEP=3 Critic next (STEP=2 done) |
