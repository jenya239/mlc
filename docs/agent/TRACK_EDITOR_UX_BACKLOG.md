...
| 27 | `EDITOR_DROP_FILE` | Runtime GLFW drop-callback → open file (needs ABI) | `drop_file_opens_tab` | M | **active** STEP=0 done → STEP=1 — [TRACK_EDITOR_DROP_FILE](TRACK_EDITOR_DROP_FILE.md) |
