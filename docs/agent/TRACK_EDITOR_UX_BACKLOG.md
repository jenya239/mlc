...
## Status: **active** (2026-07-18) — #1…#1d+#2+#3+#4+#5+#6+#7+#8+#9 done; **#10 `EDITOR_AUTO_INDENT` opened** (STEP=0 done)
...
| 10 | `EDITOR_AUTO_INDENT` | Enter preserves leading indent of current line | `enter_keeps_indent` | S | **active** — [TRACK_EDITOR_AUTO_INDENT](TRACK_EDITOR_AUTO_INDENT.md) STEP=1 next (STEP=0 done) |
