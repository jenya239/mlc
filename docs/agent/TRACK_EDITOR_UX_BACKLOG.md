...
## Status: **active** (2026-07-18) — #1…#1d+#2+#3+#4+#5+#6 done; **#7 `EDITOR_FIND` opened** (STEP=0 done)
...
| 7 | `EDITOR_FIND` | Find + next/prev, highlight matches in visible range | `find_highlights_matches` | M | **active** — [TRACK_EDITOR_FIND](TRACK_EDITOR_FIND.md) STEP=3 Critic (STEP=2 done) |
