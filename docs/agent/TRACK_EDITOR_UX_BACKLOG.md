...
| 19 | `EDITOR_COMMENT_TOGGLE` | Ctrl+/ line-comment toggle (by language from status bar) | `toggle_line_comment` | S | **active** STEP=2 done → Critic — [TRACK_EDITOR_COMMENT_TOGGLE](TRACK_EDITOR_COMMENT_TOGGLE.md) |
