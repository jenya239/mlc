...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_OVERFLOW_REUSE_FRAME_LINE_INDEX` (§84).
**`TRACK_EDITOR_OVERFLOW_REUSE_FRAME_LINE_INDEX` (§84)** **open** — STEP=0 Decision; STEP=1 red next.
