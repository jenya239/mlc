...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX` (§80).
**`TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX` (§80)** **open** — STEP=2 green done; STEP=3 Critic next.
