...
**Queue head:** Driver `STEP=1` `TRACK_EDITOR_TREE_PARENT_DOUBLE_CLICK` (§46 #33d) — L1 red harness.
**`TRACK_EDITOR_TREE_PARENT_DOUBLE_CLICK` (§46 #33d)** active — STEP=0 Decision frozen (parent `..` arm / double navigate).
