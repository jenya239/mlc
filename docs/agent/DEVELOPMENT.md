...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX` (§80).
**`TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX` (§80)** **open** — STEP=0 Decision; STEP=1 red next.
