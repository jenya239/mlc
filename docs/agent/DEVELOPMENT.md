...
**Queue head:** Driver `TRACK_EDITOR_CHROME_HOVER_DEFAULT_THEME` (§66) STEP=1.
**`TRACK_EDITOR_CHROME_HOVER_DEFAULT_THEME` (§66)** **active** — STEP=0 Decision done → Driver STEP=1.
