...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (§85).
**`TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (§85)** **open** — STEP=0 Decision; STEP=1 red next.
