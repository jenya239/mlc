...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97a `EDITOR_REAL_PERF_HARNESS`.
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97a Decision frozen; STEP=1 red next (then §97b → §97c; §93 after).
