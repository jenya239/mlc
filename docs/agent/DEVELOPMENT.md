...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97c (kill app unpack red).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97c Decision done; STEP=1 red next (then green/Critic → §93).
