...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX` (§82).
**`TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX` (§82)** **open** — STEP=2 green done; STEP=3 Critic next.
