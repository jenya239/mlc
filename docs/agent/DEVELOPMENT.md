...
**Compiler queue head:** PLAN §104-6 slice 24 Green (`TRACK_COMPILER_ARCHITECTURE_HYGIENE`). Uncommitted `compiler/mir/lower_fn.mlc` may already contain in-progress Green — do not treat it as done until SESSION/TRACK say so.
