...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97c (§96 wheel-hover L0 green).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §96 STEP=1 done; STEP=2 green next (then Critic → §93).
