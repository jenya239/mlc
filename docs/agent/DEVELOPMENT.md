...
**Queue head:** Critic `TRACK_EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG` (§63) STEP=3.
**`TRACK_EDITOR_FOLDER_SCROLLBAR_THUMB_DRAG` (§63)** **active** — STEP=2 green done → Critic STEP=3.
