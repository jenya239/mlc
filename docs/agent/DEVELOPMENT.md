...
**Queue head:** Critic `STEP=critique-audit` `TRACK_EDITOR_SESSION_CARET_RESTORE` (§46 `#20`).
**`TRACK_EDITOR_SESSION_CARET_RESTORE` (§46 #20)** active; STEP=2 done; Decision frozen.
