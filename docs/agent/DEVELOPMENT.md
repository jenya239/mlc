...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_OVERFLOW_REUSE_FRAME_LINE_INDEX` (§84).
**`TRACK_EDITOR_OVERFLOW_REUSE_FRAME_LINE_INDEX` (§84)** **open** — STEP=1 red done; STEP=2 green next.
