...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97c (§96 wheel-hover L0 red).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §96 add-on Decision done; STEP=1 red next (then green/Critic → §93).
