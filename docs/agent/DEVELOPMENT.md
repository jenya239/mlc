...
**Queue head:** Driver `TRACK_CONCURRENCY_MUTABLE_CAPTURE_CHECK` STEP=1 (§47 #1).
**`TRACK_CONCURRENCY_MUTABLE_CAPTURE_CHECK` (§47 #1)** active — STEP=0 Decision frozen; next red E087 on `TaskScope.spawn`.
