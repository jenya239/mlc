...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY` §99 (green).
**`TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY` (§99)** **open** — STEP=1 done; STEP=2 green next.
