...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (§85).
**`TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (§85)** **open** — STEP=2 green done; STEP=3 Critic next.
