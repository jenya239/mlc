...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97a `EDITOR_REAL_PERF_HARNESS`.
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97a STEP=1 red done; STEP=2 green next (then §97b → §97c; §93 after).
