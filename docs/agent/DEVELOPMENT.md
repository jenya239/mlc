...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX` (§80).
**`TRACK_EDITOR_PAINT_REUSE_FRAME_LINE_INDEX` (§80)** **open** — STEP=1 red done; STEP=2 green next.
