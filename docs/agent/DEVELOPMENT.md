...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_ACTIVE_TAB_TINT` (§68).
**`TRACK_EDITOR_DISCARD_DANGER_THEME` (§67)** **closed** 2026-07-24 (Critic OK). Archived.
**`TRACK_EDITOR_ACTIVE_TAB_TINT` (§68)** **open** STEP=2 — active tab idle → theme.selection_*.
