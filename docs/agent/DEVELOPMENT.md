...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_DEMO_OPEN_PATH_NO_STRINGIFY` (§90).
**`TRACK_EDITOR_DEMO_OPEN_PATH_NO_STRINGIFY` (§90)** **open** — STEP=0 Decision done; STEP=1 red next.
