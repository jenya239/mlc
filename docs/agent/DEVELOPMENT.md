...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_DIRTY_CLOSE_BUTTON_HOVER` (§73).
**`TRACK_EDITOR_CONTEXT_MENU_ITEM_HOVER` (§72)** **closed** 2026-07-25 (Critic OK). Archived.
**`TRACK_EDITOR_DIRTY_CLOSE_BUTTON_HOVER` (§73)** **open** — STEP=1 red done; STEP=2 wire chrome_hover.
