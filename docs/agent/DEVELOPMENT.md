...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_PROBE_REUSE_LINE_INDEX_TEXT` (§86).
**`TRACK_EDITOR_PROBE_REUSE_LINE_INDEX_TEXT` (§86)** **open** — STEP=1 red done; STEP=2 green next.
