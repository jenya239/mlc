...
**Queue head:** Driver STEP=0 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b `EDITOR_FRAME_SPLIT` Decision.
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97a **closed** Critic OK; §97b Decision next (then §97c; §93 after).
