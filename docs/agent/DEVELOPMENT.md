...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b `EDITOR_FRAME_SPLIT` (green: wrap→`frame_layout`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97b STEP=1 red done; STEP=2 green next (then §97c; §93 after).
