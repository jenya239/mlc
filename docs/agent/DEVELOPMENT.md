...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX` (§81).
**`TRACK_EDITOR_SCROLL_REUSE_FRAME_LINE_INDEX` (§81)** **open** — STEP=0 Decision; STEP=1 red next.
