...
**Queue head:** Critic `STEP=critique-audit` `TRACK_EDITOR_CHROME_HOVER_STATE` (§46 #32).
**`TRACK_EDITOR_CHROME_HOVER_STATE` (§46 #32)** active — STEP=3 demo_live hover fills wired.
