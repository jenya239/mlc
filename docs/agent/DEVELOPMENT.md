...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (§85).
**`TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (§85)** **open** — STEP=1 red done; STEP=2 green next.
