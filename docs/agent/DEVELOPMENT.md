...
**Queue head:** Driver STEP=0 Decision `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (dual-wrap).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — frame_input slice closed (Critic OK); next Decision dual-wrap (then §97c; §93 after).
