...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (`shared_span_cache` red).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — shared_span_cache Decision done; STEP=1 red next (then green/Critic → minimap / §97c; §93 after).
