...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (red: snapshot→`frame_layout`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — frame_cache Decision frozen; STEP=1 red next (then §97c; §93 after).
