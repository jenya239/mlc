...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97c (kill app unpack green).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97c STEP=1 done; STEP=2 green next (then Critic → §93).
