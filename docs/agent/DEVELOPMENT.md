...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX` (§82).
**`TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX` (§82)** **open** — STEP=1 red done; STEP=2 green next.
