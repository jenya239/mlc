...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY` §99 (red).
**`TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY` (§99)** **open** — STEP=0 done; STEP=1 red next.
