...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (green: snapshot→`frame_layout`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — frame_cache STEP=1 red done; STEP=2 green next (then §97c; §93 after).
