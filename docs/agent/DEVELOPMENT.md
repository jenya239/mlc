...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (dual-wrap red).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — dual-wrap Decision done; STEP=1 red next (then green/Critic → §97c; §93 after).
