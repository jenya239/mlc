...
**Queue head:** Driver `TRACK_CONCURRENCY_MUTABLE_CAPTURE_CHECK` STEP=2 (§47 #1).
**`TRACK_CONCURRENCY_MUTABLE_CAPTURE_CHECK` (§47 #1)** active — STEP=0–1 done; next wire E087 on `TaskScope.spawn`.
