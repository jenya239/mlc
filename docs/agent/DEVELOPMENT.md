...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_EDIT_AUTOCLOSE_NO_FULL_STRINGIFY` (§93).
**`TRACK_EDITOR_EDIT_AUTOCLOSE_NO_FULL_STRINGIFY` (§93)** **open** — STEP=0 Decision done; STEP=1 red next.
