...
**`TRACK_CODEGEN_CPPAST_ONLY` (§44) queue head** — STEP=1/test-fix/2/3/4/5/6/7a/7b1/7b2/7b3a/7b3b/7b3c1/7b3c2/7b3c3/7b3c4 done;
`dev_gate_fast` green; **STEP=7b3c5** next (`derive_methods_cpp` JSON DeclFragments).
