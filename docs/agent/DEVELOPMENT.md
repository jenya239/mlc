...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_GOTO_LINE_REUSE_FRAME_LINE_INDEX` (§83).
**`TRACK_EDITOR_GOTO_LINE_REUSE_FRAME_LINE_INDEX` (§83)** **open** — STEP=1 red done; STEP=2 green next.
