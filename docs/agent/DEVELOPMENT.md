...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (`minimap_cache`→`frame_layout`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — minimap_cache STEP=2 green done; Critic STEP=3 next (then dual-wrap / §97c; §93 after).
