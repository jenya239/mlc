...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_GOTO_LINE_REUSE_FRAME_LINE_INDEX` (§83).
**`TRACK_EDITOR_GOTO_LINE_REUSE_FRAME_LINE_INDEX` (§83)** **open** — STEP=0 Decision; STEP=1 red next.
