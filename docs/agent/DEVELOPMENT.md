...
**Queue head:** Driver `TRACK_EDITOR_MINIMAP_INDICATOR_THEME_TINT` (§65) STEP=2.
**`TRACK_EDITOR_MINIMAP_INDICATOR_THEME_TINT` (§65)** **active** — STEP=1 red done → Driver STEP=2.
