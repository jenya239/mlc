...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_EDIT_AUTOCLOSE_NO_FULL_STRINGIFY` §93.
**`TRACK_EDITOR_EDIT_AUTOCLOSE_NO_FULL_STRINGIFY` (§93)** **open** — STEP=2 done; Critic STEP=3 next.
