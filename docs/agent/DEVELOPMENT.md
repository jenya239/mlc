...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (`shared_span_cache` green).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — shared_span_cache STEP=1 red done; STEP=2 next (then Critic → minimap / §97c; §93 after).
