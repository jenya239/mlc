...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_SESSION_RESTORE_NO_STRINGIFY` (§88).
**`TRACK_EDITOR_SESSION_RESTORE_NO_STRINGIFY` (§88)** **open** — STEP=0 Decision done; STEP=1 red next.
