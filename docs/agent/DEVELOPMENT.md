...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_DEMO_OPEN_PATH_NO_STRINGIFY` (§90).
**`TRACK_EDITOR_DEMO_OPEN_PATH_NO_STRINGIFY` (§90)** **open** — STEP=1 red done; STEP=2 green next.
