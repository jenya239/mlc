...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (`frame_input` green).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — frame_input STEP=1 red done; STEP=2 next (then Critic → dual-wrap / §97c; §93 after).
