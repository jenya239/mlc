...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_GOTO_LINE_REUSE_FRAME_LINE_INDEX` (§83).
**`TRACK_EDITOR_GOTO_LINE_REUSE_FRAME_LINE_INDEX` (§83)** **open** — STEP=2 green done; STEP=3 Critic next.
