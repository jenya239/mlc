...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX` (§82).
**`TRACK_EDITOR_SELECTION_REUSE_FRAME_LINE_INDEX` (§82)** **open** — STEP=0 Decision; STEP=1 red next.
