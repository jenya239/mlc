...
**Queue head:** Critic `TRACK_EDITOR_SYNTAX_HIGHLIGHT_MLC_RICHER` (§46 #34).
**`TRACK_EDITOR_SYNTAX_HIGHLIGHT_MLC_RICHER` (§46 #34)** active — STEP=0–3 done; compile gate green.
