...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (frame_cache→`frame_layout`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — frame_cache STEP=2 green done; Critic STEP=3 next (then further extracts / §97c; §93 after).
