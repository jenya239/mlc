...
**`TRACK_CODEGEN_CPPAST_ONLY` (§44) queue head** — STEP=1/test-fix/2/3/4/5/6/7a/7b1/7b2/7b3a/7b3b done;
`dev_gate_fast` green; **STEP=7b3c** next (per-arm guarded / FFI / derive JSON Fragments).
