...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_NAV_CRUMB_HOVER` (§69).
**`TRACK_EDITOR_ACTIVE_TAB_TINT` (§68)** **closed** 2026-07-25 (Critic OK). Archived.
**`TRACK_EDITOR_NAV_CRUMB_HOVER` (§69)** **open** STEP=3 — chrome_hover wired; Critic next.
