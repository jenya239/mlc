...
**Queue head:** Driver `STEP=2` `TRACK_EDITOR_COLUMN_PIXEL_MODEL_FIX` (§46 #31a) — measure char_width from font advance.
**`TRACK_EDITOR_COLUMN_PIXEL_MODEL_FIX` (§46 #31a)** active — STEP=1 red harnesses done.
