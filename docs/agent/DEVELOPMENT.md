...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_COMMENT_TOGGLE_NO_FULL_STRINGIFY` §100 (red).
**`TRACK_EDITOR_COMMENT_TOGGLE_NO_FULL_STRINGIFY` (§100)** **open** — STEP=0 done; STEP=1 red next.
