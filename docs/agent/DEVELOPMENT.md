...
**Queue head:** Critic `TRACK_EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP` (§46 `#37`).
**`TRACK_EDITOR_WRAPPED_TEXT_BLEEDS_INTO_MINIMAP` (§46 #37)** active 2026-07-22 — STEP=3 done → Critic.
