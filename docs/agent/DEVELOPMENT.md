...
**Queue head (Planner 2026-07-18):** Critic `TRACK_EDITOR_FOLDER_NAV` (§43) STEP=3.
Then Critic `TRACK_EDITOR_CLEAN_ARCHITECTURE` (§45) STEP=4; then open §46 #1 `EDITOR_DEMO_ORCHESTRATOR` (Decision).
