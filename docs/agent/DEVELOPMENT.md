...
**Queue head:** Driver STEP=1 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b `EDITOR_FRAME_SPLIT` (red: wrap→`frame_layout`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97a closed; §97b Decision frozen; STEP=1 red next (then §97c; §93 after).
