...
**Queue head:** Driver STEP=2 `TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY` §98 (green).
**`TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY` (§98)** **open** — STEP=1 done; STEP=2 green next.
