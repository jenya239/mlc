...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97a `EDITOR_REAL_PERF_HARNESS`.
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — §97a STEP=2 green done; Critic STEP=3 next (then §97b → §97c; §93 after).
