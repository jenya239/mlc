...
**Queue head:** Critic STEP=3 `TRACK_EDITOR_RENDER_ARCHITECTURE` §97b (`frame_input`).
**`TRACK_EDITOR_RENDER_ARCHITECTURE` (§97)** **open** — frame_input STEP=2 green done; Critic STEP=3 next (then dual-wrap / §97c; §93 after).
