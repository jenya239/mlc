...
**Queue head:** Driver `TRACK_CONCURRENCY_CANCELLATION_WAKES_BLOCKING` (§47 #5) STEP=3.
**`TRACK_CONCURRENCY_CANCELLATION_WAKES_BLOCKING` (§47 #5)** active — STEP=2 wire done; next Driver STEP=3 (MEMORY_MODEL).
...
**`TRACK_MLC_CONCURRENCY_REFINEMENT` (§47)** active — `#5` open.
