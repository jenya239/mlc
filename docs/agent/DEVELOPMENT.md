...
**Queue head:** Critic `TRACK_CONCURRENCY_CANCELLATION_WAKES_BLOCKING` (§47 #5).
**`TRACK_CONCURRENCY_CANCELLATION_WAKES_BLOCKING` (§47 #5)** active — STEP=3 MEMORY_MODEL done; next Critic.
