...
## Status: **open** — STEP=3 Ruby done; STEP=3 self-hosted next

**Driver 2026-07-09:** STEP=3 Ruby — parse `= "c" from "<h>"`; IR fields;
codegen `#include` + wrapper via `&::c_name` binder; `extern_ffi_binding_test.rb`.
