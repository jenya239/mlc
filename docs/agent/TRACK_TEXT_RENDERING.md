...
## Status: **open** — STEP=0–1 **done**; STEP=2 next (FreeType bindings)
...
<!-- sub-steps STEP=2:
  1) extern type/fn FreeType subset in stdlib or runtime/text module
  2) smoke: load .ttf, FT_Load_Glyph+FT_Render_Glyph one char, assert bitmap size
  3) link via extern lib "freetype" / pkg-config
-->
