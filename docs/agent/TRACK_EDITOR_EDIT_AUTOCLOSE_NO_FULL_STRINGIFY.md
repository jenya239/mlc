...
**STEP=3** — Critic: stable×2 + related + `run_ux_gate`.
...
| 2 | (this) | wrap+peek via `document_byte_slice`; green |
...
| 2 | `document_byte_slice` in autoclose; green | **done** (`run_ux_edit_autoclose_no_full_stringify_stable.sh`) |
...
<!-- STEP=2: wrap+peek via document_byte_slice; typing_paren + edit_unit -->
<!-- STEP=3: Critic -->
