...
- **Diagnostics (remaining codes):** [TRACK_DIAGNOSTICS2.md](TRACK_DIAGNOSTICS2.md) — **active** (step 2)

## Next step (Driver)

**STEP=2** [TRACK_DIAGNOSTICS2.md](TRACK_DIAGNOSTICS2.md) — infer_array_method.mlc array HOF codes.
