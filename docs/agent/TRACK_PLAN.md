...
- **SemanticIR decl spans:** [TRACK_SPAN_IR.md](TRACK_SPAN_IR.md) — **active** (step 5)
...
**STEP=5** [TRACK_SPAN_IR.md](TRACK_SPAN_IR.md) — audit remaining span-less IR; close track.
