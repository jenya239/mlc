...
- **Performance:** [TRACK_PERFORMANCE.md](TRACK_PERFORMANCE.md) — **active** (step 3 pending)

## Next step (Driver)

See [TRACK_PERFORMANCE.md](TRACK_PERFORMANCE.md) — **STEP=3** (build_registry COW audit).
