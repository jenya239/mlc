...
- **SemanticIR decl spans:** [TRACK_SPAN_IR.md](TRACK_SPAN_IR.md) — **active** (step 4)
...
**STEP=4** [TRACK_SPAN_IR.md](TRACK_SPAN_IR.md) — checker diagnostics on decl paths use `SDecl` span helpers.
