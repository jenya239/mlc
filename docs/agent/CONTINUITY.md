...
| **`TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY` (PLAN §98)** | **open** STEP=1 done; STEP=2 green next. Newline indent without full stringify (§93 residual). Size S |
...
| **Authorized queue** | **§98** Driver STEP=2 (green) — then Critic; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
