...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97c unpack slice closed; §96 add-on Decision next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97c** Driver STEP=0 (§96 wheel-hover add-on Decision) — then green/Critic → §93; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
