...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b shared_span_cache STEP=1 red done; STEP=2 next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Driver STEP=2 (`shared_span_cache` green) — then Critic → minimap / §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
