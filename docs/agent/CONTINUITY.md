...
| **`TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY` (PLAN §99)** | **open** STEP=1 done; STEP=2 green next. Word-delete without full stringify (§98 residual). Size S |
...
| **Authorized queue** | **§99** Driver STEP=1 (red) — then green/Critic; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
