...
| **`TRACK_EDITOR_PROBE_REUSE_FRAME_LINE_INDEX` (PLAN §85)** | **open** STEP=2 next. Probe snapshot reuses frame LineIndex (§84 residual). Size M |
...
| **Authorized queue** | **§85** Driver STEP=2 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
