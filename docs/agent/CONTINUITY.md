...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b extracts closed; next Decision §97c. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97c** Decision STEP=0 — then §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
