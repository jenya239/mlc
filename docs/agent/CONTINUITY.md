...
| **`TRACK_EDITOR_UX_BACKLOG` (PLAN §46)** | Umbrella. #1…#1d+#2+#3+#4 done. **#5 active:** [TRACK_EDITOR_SHIFT_CLICK_EXTEND](TRACK_EDITOR_SHIFT_CLICK_EXTEND.md) STEP=2. Then `#6`. Product ceiling: **Sublime Text** |
