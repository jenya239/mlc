...
| **`TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY` (PLAN §98)** | **open** STEP=2 done; Critic STEP=3 next. Newline indent without full stringify (§93 residual). Size S |
...
| **Authorized queue** | **§98** Critic STEP=3 — then Planner; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
