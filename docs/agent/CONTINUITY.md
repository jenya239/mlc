...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b shared_span_cache Decision done; STEP=1 red next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Driver STEP=1 (`shared_span_cache` red) — then green/Critic → minimap / §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
