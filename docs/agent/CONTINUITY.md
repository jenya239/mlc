...
| **`TRACK_EDITOR_NEWLINE_INDENT_NO_FULL_STRINGIFY` (PLAN §98)** | **open** STEP=0 done; STEP=1 red next. Newline indent without full stringify (§93 residual). Size S |
...
| **Authorized queue** | **§98** Driver STEP=1 (red) — then green/Critic; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
