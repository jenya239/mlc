...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b wrap slice Critic OK; next Decision (frame_cache). Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Critic STEP=3 — then further extracts / §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
