...
| **`TRACK_EDITOR_WRAP_HIT_SCROLL_X` (PLAN §58)** | **active** — STEP=2 done → Critic STEP=3. Wrap pixel hit + scroll_offset_x; `ux_ok wrap_hit_scroll_x_stable` |
...
| **Authorized queue** | **§58** `TRACK_EDITOR_WRAP_HIT_SCROLL_X` STEP=2 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
