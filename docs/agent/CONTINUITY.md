...
**`test_gate=fail` → `ROLE=Driver STEP=test-fix` before TRACK feature STEPs** (rotation table). Tier A (`dev_gate_fast`) green as of 2026-07-17 test-fix Decision. Queue head: **Critic** `STEP=critique-audit` `TRACK_EDITOR_DROP_FILE` (§46 `#27`).
...
| **`TRACK_EDITOR_DROP_FILE` (§46 #27)** | **active** 2026-07-19. STEP=3 done (demo_live drain). Next Critic. Do not skip Decision |
