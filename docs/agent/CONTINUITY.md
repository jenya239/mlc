...
**`test_gate=fail` → `ROLE=Driver STEP=test-fix` before TRACK feature STEPs** (rotation table). Tier A (`dev_gate_fast`) green as of 2026-07-17 test-fix Decision. Queue head: **Planner** `PLAN` (authorized queue empty after §54 close). Priority override `#36` **closed** 2026-07-20. **Override 2026-07-24:** §46/#47/#48/#49/#50/#51/#52/#53/#54 done.
...
| **Authorized queue** | **idle** 2026-07-24 after §54 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE gated |
