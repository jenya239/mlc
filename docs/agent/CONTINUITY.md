...
| **`TRACK_EDITOR_SCROLLBAR_THEME_TINT` (PLAN §62)** | **active** — STEP=2 done → Critic STEP=3. thumbs use theme.muted_*; green stable |
...
| **Authorized queue** | **§62** `TRACK_EDITOR_SCROLLBAR_THEME_TINT` Critic STEP=3 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
