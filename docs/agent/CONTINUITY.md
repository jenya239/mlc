...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b minimap_cache Decision done; STEP=1 red next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Driver STEP=1 (`minimap_cache` red) — then green/Critic → dual-wrap / §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
