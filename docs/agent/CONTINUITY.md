...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b minimap_cache STEP=2 green done; Critic STEP=3 next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Critic STEP=3 (`minimap_cache`→layout) — then dual-wrap / §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
