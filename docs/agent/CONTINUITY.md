...
**`test_gate=fail` → `ROLE=Driver STEP=test-fix` before TRACK feature STEPs** (rotation table). Tier A (`dev_gate_fast`) green as of 2026-07-17 test-fix Decision. Queue head: **Driver** `STEP=2` `TRACK_EDITOR_COMMENT_TOGGLE` (§46 `#19`).
...
| **`TRACK_EDITOR_COMMENT_TOGGLE` (§46 #19)** | **active** 2026-07-19. STEP=1 done (L1 red). Next STEP=2 API + Cmd/GLFW wire. Do not skip Decision |
