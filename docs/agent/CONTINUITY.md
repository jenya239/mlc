...
| **`TRACK_EDITOR_WORD_DELETE_NO_FULL_STRINGIFY` (PLAN §99)** | **open** STEP=2 done; Critic STEP=3 next. Word-delete without full stringify (§98 residual). Size S |
...
| **Authorized queue** | **§99** Driver STEP=2 (green) — then Critic; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
