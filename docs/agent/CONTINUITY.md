...
| **`TRACK_EDITOR_CHROME_HOVER_DEFAULT_THEME` (PLAN §66)** | **active** — STEP=1 done → Driver STEP=2. Red: chrome_hover bare Light RGB |
...
| **Authorized queue** | **§66** `TRACK_EDITOR_CHROME_HOVER_DEFAULT_THEME` STEP=2 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
