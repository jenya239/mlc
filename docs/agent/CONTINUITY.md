...
| **`TRACK_EDITOR_WRAP_HIT_SCROLL_X` (PLAN §58)** | **active** — STEP=0 frozen → Driver STEP=1. §46 #17 residual: wrap pixel hit ignores scroll_offset_x |
...
| **Authorized queue** | **§58** `TRACK_EDITOR_WRAP_HIT_SCROLL_X` STEP=1 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
