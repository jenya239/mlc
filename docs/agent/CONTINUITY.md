...
**`test_gate=fail` → `ROLE=Driver STEP=test-fix` before TRACK feature STEPs** (rotation table). Tier A (`dev_gate_fast`) green as of 2026-07-17 test-fix Decision. Queue head: **Driver** `TRACK_CONCURRENCY_SUPERVISOR_MLC_SURFACE` (§47 `#10` STEP=2). Priority override `#36` **closed** 2026-07-20.
