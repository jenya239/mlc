...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b frame_input slice closed; next Decision dual-wrap. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Decision STEP=0 (dual-wrap) — then §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
