...
| **`TRACK_EDITOR_ACTIVE_TAB_TINT` (PLAN §68)** | **open** STEP=1 next. Active tab idle → theme.selection_*. Size S |
...
| **Authorized queue** | **§68** Driver STEP=1 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
