...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b dual-wrap STEP=1 red done; STEP=2 next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97b** Driver STEP=2 (dual-wrap green) — then Critic → §97c; §93 after; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
