...
| **`TRACK_EDITOR_ACTIVE_TAB_TITLE_PLAIN` (PLAN §70)** | **open** STEP=2 next. Drop active `[title]` brackets. Size S |
...
| **Authorized queue** | **§70** Driver STEP=1 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
