...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97b STEP=2 green done; Critic STEP=3 next. Priority override. Sub-tracks §97a→§97b→§97c |
