...
| **`TRACK_EDITOR_MINIMAP_ZOOM_SCALE` (PLAN §75)** | **open** STEP=1 next. Minimap pixel size × font zoom. Size S |
...
| **Authorized queue** | **§75** Driver STEP=1 — SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
