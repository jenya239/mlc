...
| **`TRACK_EDITOR_RENDER_ARCHITECTURE` (PLAN §97)** | **open** — §97c §96 add-on Decision done; STEP=1 red next. Priority override. Sub-tracks §97a→§97b→§97c |
...
| **Authorized queue** | **§97c** Driver STEP=1 (§96 wheel-hover L0 red) — then green/Critic → §93; SCRIPT_VM / MIR Epic 5 / LANG_AUTO_CYCLE still gated |
