...
| Boundaries out | Lock-free channel; DropNewest/Oldest/Reject overflow policies; Isolate mailbox (#9); changing existing rendezvous/buffered semantics; `lib/mlc/`; Atomcis (#7) |
