...
## Status: **open** — STEP=1–6 **done**; STEP=7 next (ThreadPool)

**Driver 2026-07-10:** STEP=6 — `http_router.hpp` (`HttpResponse`, `format_http_response`,
`write_http_response`, `HttpRouter` exact match, `http_not_found`); smoke 14/0.
