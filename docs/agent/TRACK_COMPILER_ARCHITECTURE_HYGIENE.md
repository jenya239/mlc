...
## Status: **open** — Wave 1 CLOSED; **queue head §104-6 slice 9** Decision next (s8 CLOSED). Prior: §104-6 s8 CLOSED; §100 closed 2026-07-28, §104-1/2/3 found already
...
- **§104-6** complete MIR lowering coverage (Step 6) — **queue head**, slice 8 CLOSED; slice 9 Decision next; parent open until `lower_error_count=0`
