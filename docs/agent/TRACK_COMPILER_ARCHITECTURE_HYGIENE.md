...
## Status: **open** — Wave 1 CLOSED; **queue head §104-6 slice 6** Green next (Red done 2026-08-06). Prior: §100 closed 2026-07-28, §104-1/2/3 found already
...
- **§104-6** complete MIR lowering coverage (Step 6) — **queue head**, slice 6 Red done (`to_i` gap proven); Green next; parent open until `lower_error_count=0`
