...
## Status: **open** — Wave 1 CLOSED; **queue head §104-6 slice 23 Decision frozen** (unknown Ident→ConstStr funref; gate LEC≤12). Prior: s22 CLOSED (LEC=32); §100 closed 2026-07-28, §104-1/2/3 found already
