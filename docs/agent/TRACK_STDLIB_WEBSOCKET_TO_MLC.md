...
## Status: open — unblocked (HTTP_MLC + FFI_SHIM closed)

**Planner 2026-07-11:** HTTP dependency satisfied. FFI_SHIM closed same day —
next «без C++» candidate (crypto/SHA1 notes in Goal). Not activated.
...
[TRACK_FFI_SHIM_MIGRATION](../archive/tracks/TRACK_FFI_SHIM_MIGRATION.md) — libsodium не
