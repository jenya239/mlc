...
| Step | Item | Status |
|------|------|--------|
| 1 | `main_program_parameter_items_cpp` — argc/argv param list for CppFnProto/CppFnDef | pending |
| 2 | `gen_fn_proto_cpp` / `gen_fn_decl_cpp` — native main proto (drop string bridge branch) | pending |
| 3 | `main_set_args_preamble_cpp` — native `mlc::io::set_args` prelude stmts | pending |
