...
## Status: **open** — STEP=2 done; STEP=3 next (decision)

**Driver 2026-07-09:** STEP=2 — `-ftime-trace` on `exprs.cpp` (largest TU).
Results: [BUILD_SPEED3_FTIME_TRACE_2026_07_09.md](BUILD_SPEED3_FTIME_TRACE_2026_07_09.md).
Dominant: `std::variant` AST/TokenKind; `std::function` ~89ms (CLOSURE_ESCAPE win).
