...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("method push expects an array receiver, got ", 43) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("method set expects an array or Map receiver, got ", 49) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("methods length and size apply to string or array; receiver is ", 62) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("method to_i expects a string receiver, got ", 43) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
if (((!semantic_type_structure::type_is_unknown(receiver_type)) && (!semantic_type_structure::type_is_string(receiver_type)))) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("method ", 7) + method_name) + mlc::String(" expects a string receiver, got ", 32)) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
if (((!semantic_type_structure::type_is_unknown(receiver_type)) && (!semantic_type_structure::type_is_array(receiver_type)))) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("method join expects an array receiver, got ", 43) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("method has expects a Map receiver, got ", 39) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
if (((!semantic_type_structure::type_is_unknown(receiver_type)) && (!semantic_type_structure::receiver_type_is_map(receiver_type)))) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("method ", 7) + method_name) + mlc::String(" expects a Map receiver, got ", 29)) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
...
if (((!semantic_type_structure::type_is_unknown(receiver_type)) && (!semantic_type_structure::type_is_array(receiver_type)))) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("method ", 7) + method_name) + mlc::String(" expects an array receiver, got ", 32)) + semantic_type_structure::type_description(receiver_type)), method_span)};
} else {
return mlc::Array<ast::Diagnostic>{};
}
} else {
