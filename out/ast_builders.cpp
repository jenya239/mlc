...
return std::make_shared<ast::TypeExpr>(ast::TyString{});
}
...
return std::make_shared<ast::TypeExpr>(ast::TyNamed{type_name});
}
std::shared_ptr<ast::TypeExpr> array_type(std::shared_ptr<ast::TypeExpr> element_type) noexcept{
return std::make_shared<ast::TypeExpr>(ast::TyArray{element_type});
}
std::shared_ptr<ast::TypeExpr> shared_type(std::shared_ptr<ast::TypeExpr> inner_type) noexcept{
return std::make_shared<ast::TypeExpr>(ast::TyShared{inner_type});
}
...
return std::make_shared<ast::TypeExpr>(ast::TyGeneric{type_name, type_arguments});
}
...
return std::make_shared<ast::TypeExpr>(ast::TyFn{parameter_types, return_type});
}
std::shared_ptr<ast::Expr> integer_expr(int value) noexcept{
return std::make_shared<ast::Expr>(ast::ExprInt{value, ast::span_unknown()});
}
std::shared_ptr<ast::Expr> string_expr(mlc::String value) noexcept{
return std::make_shared<ast::Expr>(ast::ExprStr{value, ast::span_unknown()});
}
std::shared_ptr<ast::Expr> boolean_expr(bool value) noexcept{
return std::make_shared<ast::Expr>(ast::ExprBool{value, ast::span_unknown()});
}
...
return std::make_shared<ast::Expr>(ast::ExprIdent{name, ast::span_unknown()});
}
...
return std::make_shared<ast::Expr>(ast::ExprBin{operation, left_expr, right_expr, ast::span_unknown()});
}
std::shared_ptr<ast::Expr> unary_expr(mlc::String operation, std::shared_ptr<ast::Expr> inner_expr) noexcept{
return std::make_shared<ast::Expr>(ast::ExprUn{operation, inner_expr, ast::span_unknown()});
}
std::shared_ptr<ast::Expr> call_expr(mlc::String function_name, mlc::Array<std::shared_ptr<ast::Expr>> arguments) noexcept{
return std::make_shared<ast::Expr>(ast::ExprCall{std::make_shared<ast::Expr>(ast::ExprIdent{function_name, ast::span_unknown()}), arguments, ast::span_unknown()});
}
...
return std::make_shared<ast::Expr>(ast::ExprMethod{object, method_name, arguments, ast::span_unknown()});
}
std::shared_ptr<ast::Expr> field_expr(std::shared_ptr<ast::Expr> object, mlc::String field_name) noexcept{
return std::make_shared<ast::Expr>(ast::ExprField{object, field_name, ast::span_unknown()});
}
std::shared_ptr<ast::Expr> index_expr(std::shared_ptr<ast::Expr> object, std::shared_ptr<ast::Expr> index) noexcept{
return std::make_shared<ast::Expr>(ast::ExprIndex{object, index, ast::span_unknown()});
}
...
return std::make_shared<ast::Expr>(ast::ExprIf{condition, then_expr, else_expr, ast::span_unknown()});
}
...
return std::make_shared<ast::Expr>(ast::ExprBlock{statements, result_expr, ast::span_unknown()});
}
...
return std::make_shared<ast::Stmt>(ast::StmtLet{binding_name, false, type_expr, value_expr, ast::span_unknown()});
}
...
return std::make_shared<ast::Stmt>(ast::StmtLet{binding_name, true, type_expr, value_expr, ast::span_unknown()});
}
std::shared_ptr<ast::Stmt> expression_statement(std::shared_ptr<ast::Expr> expr) noexcept{
return std::make_shared<ast::Stmt>(ast::StmtExpr{expr, ast::span_unknown()});
}
std::shared_ptr<ast::Stmt> return_statement(std::shared_ptr<ast::Expr> value_expr) noexcept{
return std::make_shared<ast::Stmt>(ast::StmtReturn{value_expr, ast::span_unknown()});
}
std::shared_ptr<ast::Param> value_param(mlc::String parameter_name, std::shared_ptr<ast::TypeExpr> parameter_type) noexcept{
return std::make_shared<ast::Param>(ast::Param{parameter_name, false, parameter_type, false, std::make_shared<ast::Expr>(ast::ExprUnit{ast::span_unknown()})});
}
...
return std::make_shared<ast::Decl>(ast::DeclFn{function_name, {}, {}, parameters, return_type, body_expr});
}
std::shared_ptr<ast::Decl> type_decl(mlc::String type_name, mlc::Array<std::shared_ptr<ast::TypeVariant>> variants) noexcept{
return std::make_shared<ast::Decl>(ast::DeclType{type_name, {}, variants, {}});
}
std::shared_ptr<ast::Decl> exported_decl(std::shared_ptr<ast::Decl> inner_decl) noexcept{
return std::make_shared<ast::Decl>(ast::DeclExported{inner_decl});
}
...
return std::make_shared<ast::TypeVariant>(ast::VarRecord{variant_name, field_definitions, false});
}
...
return std::make_shared<ast::TypeVariant>(ast::VarTuple{variant_name, field_types, false});
}
std::shared_ptr<ast::TypeVariant> unit_variant(mlc::String variant_name) noexcept{
return std::make_shared<ast::TypeVariant>(ast::VarUnit{variant_name, false});
}
std::shared_ptr<ast::FieldDef> field_definition(mlc::String field_name, std::shared_ptr<ast::TypeExpr> field_type) noexcept{
return std::make_shared<ast::FieldDef>(ast::FieldDef{field_name, field_type});
}
