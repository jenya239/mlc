...
return MutActualArgumentMaterializationOutcome{mlc::String("", 0), positional_argument_expressions.map([=](std::shared_ptr<semantic_ir::SExpr> expression) mutable { return evaluate_expression(expression, context, gen_stmts); })};
} else {
return positional_argument_expressions.fold(MutActualArgumentMaterializationOutcome{mlc::String("", 0), {}}, [=](MutActualArgumentMaterializationOutcome accumulator, std::shared_ptr<semantic_ir::SExpr> positional_argument_expression) mutable { return [&]() {
