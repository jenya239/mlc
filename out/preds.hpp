...
struct RecordLitPartsResult {mlc::Array<ast::RecordLitPart> lit_parts;Parser parser;};
...
struct WhereClauseParseResult {mlc::Array<ast::WhereClauseBound> where_bounds;Parser parser;};
