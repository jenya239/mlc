...
auto vname = std::visit(overloaded{[&](const ast::VarRecord& varRecord) { auto [n, __1, __2] = varRecord; return n; },
[&](const ast::VarTuple& varTuple) { auto [n, __1, __2] = varTuple; return n; },
[&](const ast::VarUnit& varUnit) { auto [n, __1] = varUnit; return n; }
}, (*variants[vi]));
if (should_add) {
...
return [&]() {
while ((vi < variants.length())) {
std::visit(overloaded{[&](const ast::VarRecord& varRecord) { auto [variant_name, __1, __2] = varRecord; return variant_map.set(variant_name, type_name); },
[&](const ast::VarTuple& varTuple) { auto [variant_name, __1, __2] = varTuple; return variant_map.set(variant_name, type_name); },
[&](const ast::VarUnit& varUnit) { auto [variant_name, __1] = varUnit; return variant_map.set(variant_name, type_name); }
}, (*variants[vi]));
vi = (vi + 1);
}
}();
...
return [&]() {
while ((vi < variants.length())) {
std::visit(overloaded{[&](const ast::VarRecord& varRecord) { auto [variant_name, field_defs, __2] = varRecord; return [&]() {
...
[&](const ast::VarTuple& varTuple) { auto [__0, __1, __2] = varTuple; return /* unit */; },
[&](const ast::VarUnit& varUnit) { auto [__0, __1] = varUnit; return /* unit */; }
}, (*variants[vi]));
vi = (vi + 1);
}
}();
...
[&](const ast::DeclAssocType& declAssocType) { auto [__0, __1] = declAssocType; return /* unit */; },
[&](const ast::DeclAssocBind& declAssocBind) { auto [__0, __1, __2] = declAssocBind; return /* unit */; }
