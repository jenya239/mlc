...
struct PrecomputedCtx {mlc::Array<std::shared_ptr<FieldOrder>> field_orders;mlc::HashMap<mlc::String, mlc::String> variant_types;mlc::HashMap<mlc::String, std::shared_ptr<LoadItem>> item_index;mlc::Array<std::shared_ptr<CtorTypeInfo>> ctor_type_infos;mlc::Array<mlc::String> generic_variants;};
