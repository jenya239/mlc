...
auto error = mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("? operator requires a Result type, got ", 39) + semantic_type_structure::type_description(inner_result.inferred_type)), question_span)};
