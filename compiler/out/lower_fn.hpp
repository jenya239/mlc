...
struct MirLambdaBinding {
  mlc::String name;
  mlc::Array<mlc::String> parameter_names;
  std::shared_ptr<semantic_ir::SemanticExpression> body;
};
struct MirLowerState {
  mlc::HashMap<mlc::String, mir_types::LocalId> name_environment;
  mlc::Array<MirLambdaBinding> lambda_bindings;
