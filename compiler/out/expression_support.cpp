...
if ((__match_subject == mlc::String("read", 4))) {
  return mlc::String("mlc::file::read_to_string", 25);
} else if ((__match_subject == mlc::String("write", 5))) {
...
mlc::String cpp_function_name_for_profile_method(mlc::String method_name) noexcept{
  return [&]() -> mlc::String {
auto __match_subject = method_name;
if ((__match_subject == mlc::String("scope_begin", 11))) {
  return mlc::String("mlc::profile::scope_begin", 25);
} else if ((__match_subject == mlc::String("scope_end", 9))) {
  return mlc::String("mlc::profile::scope_end", 23);
} else if ((__match_subject == mlc::String("monotonic_nanos", 15))) {
  return mlc::String("mlc::profile::monotonic_nanos", 29);
} else if ((__match_subject == mlc::String("peak_rss_kib", 12))) {
  return mlc::String("mlc::profile::peak_rss_kib", 26);
} else if ((__match_subject == mlc::String("print_report", 12))) {
  return mlc::String("mlc::profile::print_report", 26);
} else if ((__match_subject == mlc::String("reset", 5))) {
