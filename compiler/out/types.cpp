...
return (preds::TKind_is_arrow(preds::Parser_kind(base.parser)) ? [&]() {
...
return (preds::TKind_is_lbracket(kind) ? [&]() {
...
return ((name == mlc::String("i32", 3)) ? preds::TypeResult{std::make_shared<ast::TypeExpr>(ast::TyI32{}), preds::Parser_advance(parser)} : ((name == mlc::String("string", 6)) ? preds::TypeResult{std::make_shared<ast::TypeExpr>(ast::TyString{}), preds::Parser_advance(parser)} : ((name == mlc::String("bool", 4)) ? preds::TypeResult{std::make_shared<ast::TypeExpr>(ast::TyBool{}), preds::Parser_advance(parser)} : ((name == mlc::String("unit", 4)) ? preds::TypeResult{std::make_shared<ast::TypeExpr>(ast::TyUnit{}), preds::Parser_advance(parser)} : ((name == mlc::String("ref", 3)) ? [&]() {
...
return ((preds::TKind_is_op(preds::Parser_kind(after)) && (preds::TKind_op_val(preds::Parser_kind(after)) == mlc::String("<", 1))) ? [&]() {
