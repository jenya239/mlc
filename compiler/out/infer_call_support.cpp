...
return semantic_type_structure::type_is_function(function_result.inferred_type) ? infer_expr_call_non_constructor_arity_only(base, function_result, call_arguments, call_source_span, return_type) : infer_expr_call_non_constructor_not_callable(base, function_result, call_source_span);
}
