...
struct CppAggregateInit {mlc::String field0;mlc::Array<std::shared_ptr<cpp_ast::CppExpr>> field1;};
...
struct CppExpr {std::variant<CppInt, CppStr, CppBool, CppIdent, CppCall, CppMember, CppIndex, CppBinary, CppUnary, CppTernary, CppLambda, CppInitList, CppAggregateInit, CppStdVisit, CppCast, CppInvokedWhile, CppInvokedFor, CppQuestionTry, CppWithBlock> _;};
