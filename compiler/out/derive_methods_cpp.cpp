...
mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> gen_derive_trait_cpp(mlc::String type_name, mlc::Array<std::shared_ptr<ast::TypeVariant>> variants, mlc::String trait_name) noexcept{return trait_name == mlc::String("Display") ? gen_derive_display_cpp(type_name, variants) : trait_name == mlc::String("Eq") ? gen_derive_eq_cpp(type_name, variants) : trait_name == mlc::String("Ord") ? gen_derive_ord_cpp(type_name, variants) : trait_name == mlc::String("Hash") ? gen_derive_hash_cpp(type_name, variants) : mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>>{};}
