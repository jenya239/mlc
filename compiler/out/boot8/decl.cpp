...
auto is_main = std::visit(overloaded{[&](const semantic_ir::SDeclFn& sDeclFn) { auto [name, __1, __2, __3, __4, __5, __6] = sDeclFn; return (name == mlc::String("main", 4)); },
...
[&](const semantic_ir::SDeclFn& sDeclFn) { auto [__0, __1, __2, __3, __4, __5, __6] = sDeclFn; return ((phase == 2) ? (gen_proto(decls[index], context)) : (((phase == 3) ? (gen_decl(decls[index], context)) : (mlc::String("", 0))))); },
