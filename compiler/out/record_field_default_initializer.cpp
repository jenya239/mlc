...
mlc::String record_field_default_identifier_cpp(mlc::String name, context::CodegenContext context) noexcept{return context::context_resolve(context, cpp_naming::map_builtin_identifier_reference(name));}
