...
[&](const ast::DeclExternType& declExternType) { auto [type_name, c_type_name, extern_header, drop_function_name, concurrency_attrs, span] = declExternType; return std::make_shared<semantic_ir::SemanticDeclaration>(semantic_ir::SemanticDeclarationExternType{type_name, c_type_name, extern_header, drop_function_name, concurrency_attrs, span}); },
