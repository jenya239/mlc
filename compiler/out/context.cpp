...
parts.push_back(statement_result.output);
return context::GenStmtsResult{parts, statement_result.next_try};
}
...
return context::CodegenContext{self.field_orders, self.field_order_index, self.namespace_prefix, self.qualified, self.namespace_alias_prefixes, self.self_type, self.method_owners, self.shared_params, self.shared_array_params, self.array_elem_types, self.shared_map_params, self.ctor_type_infos, self.ctor_type_info_index, self.variant_types, new_value_params, self.match_deref_params, self.generic_variants, self.struct_using_lines};
}

context::CodegenContext CodegenContext_add_match_deref(context::CodegenContext self, mlc::String name) noexcept{
mlc::Array<mlc::String> new_match_deref_params = self.match_deref_params;
new_match_deref_params.push_back(name);
return context::CodegenContext{self.field_orders, self.field_order_index, self.namespace_prefix, self.qualified, self.namespace_alias_prefixes, self.self_type, self.method_owners, self.shared_params, self.shared_array_params, self.array_elem_types, self.shared_map_params, self.ctor_type_infos, self.ctor_type_info_index, self.variant_types, self.value_params, new_match_deref_params, self.generic_variants, self.struct_using_lines};
}
...
return context::CodegenContext{field_orders, decl_index::build_field_order_index(field_orders), mlc::String(""), mlc::HashMap<mlc::String, mlc::String>(), mlc::HashMap<mlc::String, mlc::String>(), mlc::String(""), type_index::build_method_owners_from_decls(prog.decls), {}, {}, mlc::HashMap<mlc::String, mlc::String>(), {}, ctor_type_infos, ctor_info::build_ctor_type_info_index(ctor_type_infos), type_index::build_variant_types_from_decls(prog.decls), {}, {}, type_index::build_generic_variants_from_decls(prog.decls), mlc::HashMap<mlc::String, mlc::Array<mlc::String>>()};
}
