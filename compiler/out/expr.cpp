...
mlc::String array_literal(mlc::String argument_list) noexcept{
  if ((argument_list.length() == 0))   {
    ...
    return ((mlc::String("mlc::Array{", 11) + mlc::to_string(argument_list)) + mlc::String("}", 1));
  }
}
mlc::String block_as_immediate_invoked_function_expression(mlc::String body_statements_and_return) noexcept{
  return ((mlc::String("[&]() {\n", 8) + mlc::to_string(body_statements_and_return)) + mlc::String("}()", 3));
}
...
mlc::String match_arm_wild_or_unit_return(mlc::String return_expression_code) noexcept{
  return ((mlc::String("[=](const auto& __v) { return ", 30) + mlc::to_string(return_expression_code)) + mlc::String("; }", 3));
}
mlc::String match_arm_wild_or_unit_statement(mlc::String body_expression_code) noexcept{
  return ((mlc::String("[=](const auto& __v) -> void { ", 31) + mlc::to_string(body_expression_code)) + mlc::String("; }", 3));
}
mlc::String match_arm_binding_identifier(mlc::String parameter_cpp_safe, mlc::String return_expression_code) noexcept{
  return ((((mlc::String("[=](const auto& ", 16) + mlc::to_string(parameter_cpp_safe)) + mlc::String(") { return ", 11)) + mlc::to_string(return_expression_code)) + mlc::String("; }", 3));
}
mlc::String match_arm_binding_identifier_void(mlc::String parameter_cpp_safe, mlc::String body_expression_code) noexcept{
  return ((((mlc::String("[=](const auto& ", 16) + mlc::to_string(parameter_cpp_safe)) + mlc::String(") -> void { ", 12)) + mlc::to_string(body_expression_code)) + mlc::String("; }", 3));
}
mlc::String match_arm_constructed_value(mlc::String const_reference_parameter, mlc::String binding_prefix, mlc::String return_expression_code) noexcept{
  return ((((((mlc::String("[=](", 4) + mlc::to_string(const_reference_parameter)) + mlc::String(") { ", 4)) + mlc::to_string(binding_prefix)) + mlc::String("return ", 7)) + mlc::to_string(return_expression_code)) + mlc::String("; }", 3));
}
mlc::String match_arm_constructed_value_void(mlc::String const_reference_parameter, mlc::String binding_prefix, mlc::String body_expression_code) noexcept{
  return ((((((mlc::String("[=](", 4) + mlc::to_string(const_reference_parameter)) + mlc::String(") -> void { ", 12)) + mlc::to_string(binding_prefix)) + mlc::String("", 0)) + mlc::to_string(body_expression_code)) + mlc::String("; }", 3));
}
mlc::String record_initializer(mlc::String type_resolved, mlc::String values_comma_separated) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(type_resolved)) + mlc::String("{", 1)) + mlc::to_string(values_comma_separated)) + mlc::String("}", 1));
}
mlc::String record_update_lazy_closure(mlc::String initializer_and_assignments) noexcept{
  return ((mlc::String("[&]() { ", 8) + mlc::to_string(initializer_and_assignments)) + mlc::String("return __upd; }()", 17));
}
...
mlc::String constructor_call_braces(mlc::String constructor_code, mlc::String argument_list) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(constructor_code)) + mlc::String("{", 1)) + mlc::to_string(argument_list)) + mlc::String("}", 1));
}
mlc::String lambda_with_return(mlc::String header_code, mlc::String return_expression_code) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(header_code)) + mlc::String(" { return ", 10)) + mlc::to_string(return_expression_code)) + mlc::String("; }", 3));
}
mlc::String assignment_statement(mlc::String left_code, mlc::String right_code) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(left_code)) + mlc::String(" = ", 3)) + mlc::to_string(right_code)) + mlc::String(";\n", 2));
}
mlc::String expression_operation_statement(mlc::String operation, mlc::String left_code, mlc::String right_code) noexcept{
  return ((((((mlc::String("(", 1) + mlc::to_string(left_code)) + mlc::String(" ", 1)) + mlc::to_string(operation)) + mlc::String(" ", 1)) + mlc::to_string(right_code)) + mlc::String(");\n", 3));
}
mlc::String suffix_semicolon_newline(mlc::String expression_code) noexcept{
  return ((mlc::String("", 0) + mlc::to_string(expression_code)) + mlc::String(";\n", 2));
}
mlc::String try_unwrap_result_block(mlc::String result_variable, mlc::String inner_code, mlc::String success_line, mlc::String from_converter_name) noexcept{
  if ((from_converter_name.length() > 0))   {
    return ((((((((((((mlc::String("auto ", 5) + mlc::to_string(result_variable)) + mlc::String(" = ", 3)) + mlc::to_string(inner_code)) + mlc::String(";\nif (std::get_if<1>(&", 22)) + mlc::to_string(result_variable)) + mlc::String(")) return ", 10)) + mlc::to_string(from_converter_name)) + mlc::String("(*std::get_if<1>(&", 18)) + mlc::to_string(result_variable)) + mlc::String("));\n", 4)) + mlc::to_string(success_line)) + mlc::String("", 0));
  } else   {
    return ((((((((((mlc::String("auto ", 5) + mlc::to_string(result_variable)) + mlc::String(" = ", 3)) + mlc::to_string(inner_code)) + mlc::String(";\nif (std::get_if<1>(&", 22)) + mlc::to_string(result_variable)) + mlc::String(")) return *std::get_if<1>(&", 27)) + mlc::to_string(result_variable)) + mlc::String(");\n", 3)) + mlc::to_string(success_line)) + mlc::String("", 0));
  }
}
mlc::String auto_binding_statement(mlc::String binding_cpp_safe, mlc::String value_code) noexcept{
  return ((((mlc::String("auto ", 5) + mlc::to_string(binding_cpp_safe)) + mlc::String(" = ", 3)) + mlc::to_string(value_code)) + mlc::String(";\n", 2));
}
mlc::String constexpr_auto_binding_statement(mlc::String binding_cpp_safe, mlc::String value_code) noexcept{
  return ((((mlc::String("constexpr auto ", 15) + mlc::to_string(binding_cpp_safe)) + mlc::String(" = ", 3)) + mlc::to_string(value_code)) + mlc::String(";\n", 2));
}
mlc::String return_line(mlc::String expression_code) noexcept{
  return ((mlc::String("return ", 7) + mlc::to_string(expression_code)) + mlc::String(";\n", 2));
}
mlc::String if_brace_block(mlc::String condition_code, mlc::String inner_statements) noexcept{
  return ((((mlc::String("if (", 4) + mlc::to_string(condition_code)) + mlc::String(") {\n", 4)) + mlc::to_string(inner_statements)) + mlc::String("}", 1));
}
mlc::String else_if_brace_block(mlc::String condition_code, mlc::String inner_statements) noexcept{
  return ((((mlc::String(" else if (", 10) + mlc::to_string(condition_code)) + mlc::String(") {\n", 4)) + mlc::to_string(inner_statements)) + mlc::String("}", 1));
}
mlc::String else_brace_block(mlc::String inner_statements) noexcept{
  return ((mlc::String(" else {\n", 8) + mlc::to_string(inner_statements)) + mlc::String("}", 1));
}
mlc::String else_fragment_raw(mlc::String raw_else_suffix) noexcept{
  return ((mlc::String(" else ", 6) + mlc::to_string(raw_else_suffix)) + mlc::String("", 0));
}
mlc::String while_loop_statement(mlc::String condition_code, mlc::String body_statements) noexcept{
  return ((((mlc::String("while (", 7) + mlc::to_string(condition_code)) + mlc::String(") {\n", 4)) + mlc::to_string(body_statements)) + mlc::String("}\n", 2));
}
mlc::String for_loop_statement(mlc::String variable_cpp_safe, mlc::String iterator_code, mlc::String body_statements) noexcept{
  return ((((((mlc::String("for (auto ", 10) + mlc::to_string(variable_cpp_safe)) + mlc::String(" : ", 3)) + mlc::to_string(iterator_code)) + mlc::String(") {\n", 4)) + mlc::to_string(body_statements)) + mlc::String("}\n", 2));
}
...
mlc::String let_from_try_ok_field0(mlc::String binding_cpp_safe, mlc::String try_variable) noexcept{
  return ((((mlc::String("auto ", 5) + mlc::to_string(binding_cpp_safe)) + mlc::String(" = std::get<0>(", 15)) + mlc::to_string(try_variable)) + mlc::String(").field0;\n", 10));
}
mlc::String discard_try_ok_field0_statement(mlc::String try_variable) noexcept{
  return ((mlc::String("/* discard */ (void)std::get<0>(", 32) + mlc::to_string(try_variable)) + mlc::String(").field0;\n", 10));
}
mlc::String return_try_ok_field0_statement(mlc::String try_variable) noexcept{
  return ((mlc::String("return std::get<0>(", 19) + mlc::to_string(try_variable)) + mlc::String(").field0;\n", 10));
}
mlc::String if_always_true_block(mlc::String inner_statements) noexcept{
  return ((mlc::String("if (true) {\n", 12) + mlc::to_string(inner_statements)) + mlc::String("}\n", 2));
}
mlc::String fragment_with_newline(mlc::String fragment) noexcept{
  return ((mlc::String("", 0) + mlc::to_string(fragment)) + mlc::String("\n", 1));
}
mlc::String tuple_destructure_binding(mlc::String binding_names_csv, mlc::String source_name) noexcept{
  return ((((mlc::String("auto [", 6) + mlc::to_string(binding_names_csv)) + mlc::String("] = ", 4)) + mlc::to_string(source_name)) + mlc::String("; ", 2));
}
mlc::String record_pattern_field_binding(mlc::String field_cpp_safe, mlc::String variant_lower_name) noexcept{
  return ((((((mlc::String("const auto& ", 12) + mlc::to_string(field_cpp_safe)) + mlc::String(" = ", 3)) + mlc::to_string(variant_lower_name)) + mlc::String(".", 1)) + mlc::to_string(field_cpp_safe)) + mlc::String("; ", 2));
}
mlc::String record_update_base_prefix(mlc::String expression_code) noexcept{
  return ((mlc::String("auto __upd = ", 13) + mlc::to_string(expression_code)) + mlc::String("; ", 2));
}
mlc::String mutable_member_assignment(mlc::String receiver, mlc::String member_cpp_safe, mlc::String value_code) noexcept{
  return ((((((mlc::String("", 0) + mlc::to_string(receiver)) + mlc::String(".", 1)) + mlc::to_string(member_cpp_safe)) + mlc::String(" = ", 3)) + mlc::to_string(value_code)) + mlc::String("; ", 2));
}
mlc::String visit_subject_for_match(mlc::String expression_code, bool needs_dereference) noexcept{
  if (needs_dereference)   {
    return ((mlc::String("(*", 2) + mlc::to_string(expression_code)) + mlc::String(")", 1));
  } else   {
    return expression_code;
  }
}
mlc::String make_shared_call(mlc::String element_type, mlc::String argument_code) noexcept{
  return ((((mlc::String("std::make_shared<", 17) + mlc::to_string(element_type)) + mlc::String(">(", 2)) + mlc::to_string(argument_code)) + mlc::String(")", 1));
}
mlc::String runtime_to_string_call(mlc::String expression_code) noexcept{
  return ((mlc::String("mlc::to_string(", 15) + mlc::to_string(expression_code)) + mlc::String(")", 1));
}
...
mlc::String block_immediate_function_return_fragment(mlc::String return_expression_code) noexcept{
  return ((mlc::String("return ", 7) + mlc::to_string(return_expression_code)) + mlc::String(";\n", 2));
}
mlc::String append_trailing_expression_statement(mlc::String statements_code, mlc::String expression_code) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(statements_code)) + mlc::String("", 0)) + mlc::to_string(expression_code)) + mlc::String(";\n", 2));
}
mlc::String hash_map_empty_instantiation(mlc::String key_type_cpp, mlc::String value_type_cpp) noexcept{
  return ((((mlc::String("mlc::HashMap<", 13) + mlc::to_string(key_type_cpp)) + mlc::String(", ", 2)) + mlc::to_string(value_type_cpp)) + mlc::String(">()", 3));
}
mlc::String typed_array_empty_or_untyped_empty(mlc::String element_type_cpp) noexcept{
  if ((element_type_cpp == mlc::String("auto", 4)))   {
    return mlc::String("{}", 2);
  } else   {
    return ((mlc::String("mlc::Array<", 11) + mlc::to_string(element_type_cpp)) + mlc::String(">{}", 3));
  }
}
mlc::String typed_array_braced_initializer(mlc::String element_type_cpp, mlc::String comma_separated_elements) noexcept{
  return ((((mlc::String("mlc::Array<", 11) + mlc::to_string(element_type_cpp)) + mlc::String(">{", 2)) + mlc::to_string(comma_separated_elements)) + mlc::String("}", 1));
}
...
mlc::String match_lambda_const_reference_parameter(mlc::String resolved_type_name, mlc::String generic_angle_bracket_argument, mlc::String binding_name_cpp_safe) noexcept{
  return ((((((mlc::String("const ", 6) + mlc::to_string(resolved_type_name)) + mlc::String("", 0)) + mlc::to_string(generic_angle_bracket_argument)) + mlc::String("& ", 2)) + mlc::to_string(binding_name_cpp_safe)) + mlc::String("", 0));
}
mlc::String match_arm_constructed_value_generic(mlc::String resolved_type_name, mlc::String binding_name_cpp_safe, mlc::String binding_prefix, mlc::String return_expression_code) noexcept{
  return ((((((((mlc::String("[=]<typename __mlcT>(const ", 27) + mlc::to_string(resolved_type_name)) + mlc::String("<__mlcT>& ", 10)) + mlc::to_string(binding_name_cpp_safe)) + mlc::String(") { ", 4)) + mlc::to_string(binding_prefix)) + mlc::String("return ", 7)) + mlc::to_string(return_expression_code)) + mlc::String("; }", 3));
}
mlc::String match_arm_constructed_value_generic_void(mlc::String resolved_type_name, mlc::String binding_name_cpp_safe, mlc::String binding_prefix, mlc::String body_expression_code) noexcept{
  return ((((((((mlc::String("[=]<typename __mlcT>(const ", 27) + mlc::to_string(resolved_type_name)) + mlc::String("<__mlcT>& ", 10)) + mlc::to_string(binding_name_cpp_safe)) + mlc::String(") -> void { ", 12)) + mlc::to_string(binding_prefix)) + mlc::String("", 0)) + mlc::to_string(body_expression_code)) + mlc::String("; }", 3));
}
mlc::String dot_member_access(mlc::String receiver_code, mlc::String member_code) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(receiver_code)) + mlc::String(".", 1)) + mlc::to_string(member_code)) + mlc::String("", 0));
}
mlc::String comma_separated_pair(mlc::String first_code, mlc::String second_code) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(first_code)) + mlc::String(", ", 2)) + mlc::to_string(second_code)) + mlc::String("", 0));
}
...
mlc::String noexcept_function_prototype(mlc::String return_type_cpp, mlc::String name_cpp, mlc::String parameter_list) noexcept{
  return ((((((mlc::String("", 0) + mlc::to_string(return_type_cpp)) + mlc::String(" ", 1)) + mlc::to_string(name_cpp)) + mlc::String("(", 1)) + mlc::to_string(parameter_list)) + mlc::String(") noexcept;\n", 12));
}
...
mlc::String inline_noexcept_forwarding_call(mlc::String return_type_cpp, mlc::String method_name_cpp, mlc::String parameter_list, mlc::String callee_code, mlc::String call_argument_list) noexcept{
  return ((((((((((mlc::String("inline ", 7) + mlc::to_string(return_type_cpp)) + mlc::String(" ", 1)) + mlc::to_string(method_name_cpp)) + mlc::String("(", 1)) + mlc::to_string(parameter_list)) + mlc::String(") noexcept { return ", 20)) + mlc::to_string(callee_code)) + mlc::String("(", 1)) + mlc::to_string(call_argument_list)) + mlc::String("); }\n", 5));
}
mlc::String noexcept_one_line_returning_function(mlc::String return_type_cpp, mlc::String name_cpp, mlc::String parameter_list, mlc::String return_expression_code) noexcept{
  return ((((((((mlc::String("", 0) + mlc::to_string(return_type_cpp)) + mlc::String(" ", 1)) + mlc::to_string(name_cpp)) + mlc::String("(", 1)) + mlc::to_string(parameter_list)) + mlc::String(") noexcept { return ", 20)) + mlc::to_string(return_expression_code)) + mlc::String("; }\n", 4));
}
mlc::String parameter_declaration_item(mlc::String type_expression_cpp, mlc::String binding_name_cpp) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(type_expression_cpp)) + mlc::String(" ", 1)) + mlc::to_string(binding_name_cpp)) + mlc::String("", 0));
}
mlc::String block_close_newline() noexcept{
  return mlc::String("}\n", 2);
}
mlc::String cpp_array_type_element(mlc::String inner_type_cpp) noexcept{
  return ((mlc::String("mlc::Array<", 11) + mlc::to_string(inner_type_cpp)) + mlc::String(">", 1));
}
...
mlc::String cpp_template_two_type_arguments(mlc::String template_name_cpp, mlc::String first_type_argument_cpp, mlc::String second_type_argument_cpp) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(template_name_cpp)) + mlc::String("<", 1)) + mlc::to_string(comma_separated_pair(first_type_argument_cpp, second_type_argument_cpp))) + mlc::String(">", 1));
}
...
mlc::String struct_empty_definition(mlc::String resolved_struct_name) noexcept{
  return ((mlc::String("struct ", 7) + mlc::to_string(resolved_struct_name)) + mlc::String(" {};\n", 5));
}
mlc::String struct_with_inline_members_definition(mlc::String resolved_struct_name, mlc::String member_declarations_concatenated) noexcept{
  return ((((mlc::String("struct ", 7) + mlc::to_string(resolved_struct_name)) + mlc::String(" {", 2)) + mlc::to_string(member_declarations_concatenated)) + mlc::String("};\n", 3));
}
mlc::String struct_forward_declaration_line(mlc::String template_prefix_before_keyword, mlc::String resolved_struct_name) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(template_prefix_before_keyword)) + mlc::String("struct ", 7)) + mlc::to_string(resolved_struct_name)) + mlc::String(";\n", 2));
}
mlc::String variant_using_alias_definition_line(mlc::String template_prefix_before_using, mlc::String resolved_alias_name, mlc::String variant_alternatives_csv) noexcept{
  return ((((((mlc::String("", 0) + mlc::to_string(template_prefix_before_using)) + mlc::String("using ", 6)) + mlc::to_string(resolved_alias_name)) + mlc::String(" = std::variant<", 16)) + mlc::to_string(variant_alternatives_csv)) + mlc::String(">;\n", 3));
}
mlc::String concept_requires_clause_line(mlc::String requires_predicates_joined) noexcept{
  return ((mlc::String("requires ", 9) + mlc::to_string(requires_predicates_joined)) + mlc::String("\n", 1));
}
mlc::String concept_trait_constraint_on_type_parameter(mlc::String trait_name_cpp_safe, mlc::String type_parameter_name) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(trait_name_cpp_safe)) + mlc::String("<", 1)) + mlc::to_string(type_parameter_name)) + mlc::String(">", 1));
}
mlc::String struct_tuple_field_declaration(mlc::String element_type_cpp, mlc::String field_index_text) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(element_type_cpp)) + mlc::String(" field", 6)) + mlc::to_string(field_index_text)) + mlc::String(";", 1));
}
mlc::String struct_named_field_declaration(mlc::String field_type_cpp, mlc::String field_name_cpp_safe) noexcept{
  return ((((mlc::String("", 0) + mlc::to_string(field_type_cpp)) + mlc::String(" ", 1)) + mlc::to_string(field_name_cpp_safe)) + mlc::String(";", 1));
}
...
mlc::String include_guard_ifndef_line(mlc::String guard_macro) noexcept{
  return ((mlc::String("#ifndef ", 8) + mlc::to_string(guard_macro)) + mlc::String("\n", 1));
}
mlc::String include_guard_define_line(mlc::String guard_macro) noexcept{
  return ((mlc::String("#define ", 8) + mlc::to_string(guard_macro)) + mlc::String("\n", 1));
}
mlc::String include_guard_endif_comment_line(mlc::String guard_macro) noexcept{
  return ((mlc::String("#endif // ", 10) + mlc::to_string(guard_macro)) + mlc::String("\n", 1));
}
mlc::String namespace_open_line(mlc::String namespace_identifier) noexcept{
  return ((mlc::String("namespace ", 10) + mlc::to_string(namespace_identifier)) + mlc::String(" {\n", 3));
}
mlc::String namespace_close_comment_line(mlc::String namespace_identifier) noexcept{
  return ((mlc::String("} // namespace ", 15) + mlc::to_string(namespace_identifier)) + mlc::String("\n", 1));
}
...
mlc::String concept_requires_expression_method_returns_convertible(mlc::String callee_name, mlc::String declval_arguments_csv, mlc::String destination_type_cpp) noexcept{
  if ((declval_arguments_csv.length() > 0))   {
    return ((((((mlc::String("{ ", 2) + mlc::to_string(callee_name)) + mlc::String("(self, ", 7)) + mlc::to_string(declval_arguments_csv)) + mlc::String(") } -> std::convertible_to<", 27)) + mlc::to_string(destination_type_cpp)) + mlc::String(">", 1));
  } else   {
    return ((((mlc::String("{ ", 2) + mlc::to_string(callee_name)) + mlc::String("(self) } -> std::convertible_to<", 32)) + mlc::to_string(destination_type_cpp)) + mlc::String(">", 1));
  }
}
mlc::String trait_concept_requires_definition_line(mlc::String template_header, mlc::String trait_cpp_safe, mlc::String self_parameter_name, mlc::String requires_expressions_semicolon_separated) noexcept{
  return ((((((((mlc::String("", 0) + mlc::to_string(template_header)) + mlc::String("concept ", 8)) + mlc::to_string(trait_cpp_safe)) + mlc::String(" = requires(const ", 18)) + mlc::to_string(self_parameter_name)) + mlc::String("& self) { ", 10)) + mlc::to_string(requires_expressions_semicolon_separated)) + mlc::String("; };\n", 5));
}
mlc::String concept_trait_constraint_with_result_and_implementor(mlc::String trait_name_cpp_safe, mlc::String result_type_parameter_name, mlc::String implementor_type_parameter_name) noexcept{
  return ((((((mlc::String("", 0) + mlc::to_string(trait_name_cpp_safe)) + mlc::String("<", 1)) + mlc::to_string(result_type_parameter_name)) + mlc::String(", ", 2)) + mlc::to_string(implementor_type_parameter_name)) + mlc::String(">", 1));
}
mlc::String std_function_field_line(mlc::String return_type_cpp, mlc::String parameter_types_csv, mlc::String method_name_cpp_safe) noexcept{
  return ((((((mlc::String("  std::function<", 16) + mlc::to_string(return_type_cpp)) + mlc::String("(", 1)) + mlc::to_string(parameter_types_csv)) + mlc::String(")> ", 3)) + mlc::to_string(method_name_cpp_safe)) + mlc::String(";\n", 2));
}
mlc::String trait_vtable_struct_cpp_name(mlc::String trait_cpp_safe) noexcept{
  return ((mlc::String("", 0) + mlc::to_string(trait_cpp_safe)) + mlc::String("_vtable", 7));
}
mlc::String trait_struct_definition_lines(mlc::String template_header, mlc::String vtable_struct_cpp_name, mlc::String field_lines) noexcept{
  return ((((((mlc::String("", 0) + mlc::to_string(template_header)) + mlc::String("struct ", 7)) + mlc::to_string(vtable_struct_cpp_name)) + mlc::String(" {\n", 3)) + mlc::to_string(field_lines)) + mlc::String("};\n", 3));
}
...
mlc::String static_assert_concept_for_type_line(mlc::String concept_cpp_safe, mlc::String type_cpp, mlc::String diagnostic_message_inside_cpp_string_literal) noexcept{
  return ((((((((mlc::String("static_assert(", 14) + mlc::to_string(concept_cpp_safe)) + mlc::String("<", 1)) + mlc::to_string(type_cpp)) + mlc::String(">, ", 3)) + mlc::String("\"", 1)) + diagnostic_message_inside_cpp_string_literal) + mlc::String("\"", 1)) + mlc::String(");\n", 3));
}
mlc::String static_assert_concept_for_result_and_implementor_line(mlc::String concept_cpp_safe, mlc::String result_type_cpp, mlc::String implementor_type_cpp, mlc::String diagnostic_message_inside_cpp_string_literal) noexcept{
  return ((((((((((mlc::String("static_assert(", 14) + mlc::to_string(concept_cpp_safe)) + mlc::String("<", 1)) + mlc::to_string(result_type_cpp)) + mlc::String(", ", 2)) + mlc::to_string(implementor_type_cpp)) + mlc::String(">, ", 3)) + mlc::String("\"", 1)) + diagnostic_message_inside_cpp_string_literal) + mlc::String("\"", 1)) + mlc::String(");\n", 3));
}
mlc::String with_block_statement(mlc::String resource_code, mlc::String binder, mlc::String body_statements) noexcept{
  return ((((((((mlc::String("{\nauto ", 7) + mlc::to_string(binder)) + mlc::String(" = (", 4)) + mlc::to_string(resource_code)) + mlc::String(");\n", 3)) + mlc::to_string(body_statements)) + mlc::String("", 0)) + mlc::to_string(binder)) + mlc::String(".drop();\n}\n", 11));
}
