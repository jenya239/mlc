...
if (std::holds_alternative<registry::TGeneric>((*__match_subject))) {
const registry::TGeneric& tGeneric = std::get<registry::TGeneric>((*__match_subject));
auto [name, type_arguments] = tGeneric; return (((name == mlc::String("Result", 6)) && (type_arguments.length() >= 1)) ? (type_arguments[0]) : (std::make_shared<registry::Type>(registry::TUnknown{})));
}
if (std::holds_alternative<registry::TNamed>((*__match_subject))) {
const registry::TNamed& tNamed = std::get<registry::TNamed>((*__match_subject));
...
if (std::holds_alternative<registry::TGeneric>((*__match_subject))) {
const registry::TGeneric& tGeneric = std::get<registry::TGeneric>((*__match_subject));
auto [name, type_arguments] = tGeneric; return (((name == mlc::String("Result", 6)) && (type_arguments.length() >= 2)) ? (type_arguments[1]) : (std::make_shared<registry::Type>(registry::TUnknown{})));
}
if (std::holds_alternative<registry::TNamed>((*__match_subject))) {
const registry::TNamed& tNamed = std::get<registry::TNamed>((*__match_subject));
auto [name] = tNamed; return ((name == mlc::String("Result", 6)) ? (std::make_shared<registry::Type>(registry::TUnknown{})) : (std::make_shared<registry::Type>(registry::TUnknown{})));
...
if (std::holds_alternative<registry::TGeneric>((*__match_subject))) {
const registry::TGeneric& tGeneric = std::get<registry::TGeneric>((*__match_subject));
auto [name, type_arguments] = tGeneric; return (((name == mlc::String("Option", 6)) && (type_arguments.length() >= 1)) ? (type_arguments[0]) : (std::make_shared<registry::Type>(registry::TUnknown{})));
}
if (std::holds_alternative<registry::TNamed>((*__match_subject))) {
const registry::TNamed& tNamed = std::get<registry::TNamed>((*__match_subject));
