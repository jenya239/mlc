...
}()) : ((semantic_type_structure::types_structurally_equal(expected_type, actual_type) ? (empty_diagnostic_list()) : (mlc::Array<ast::Diagnostic>{argument_type_mismatch_diagnostic(expected_type, actual_type, diagnostic_span)}))));
}
...
return (semantic_type_structure::types_structurally_equal(expected_type, actual_type) ? (empty_diagnostic_list()) : (mlc::Array<ast::Diagnostic>{argument_type_mismatch_diagnostic(expected_type, actual_type, diagnostic_span)}));
std::abort();
}();
  }
}
