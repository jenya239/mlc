...
context::PrecomputedCtx empty_precomputed_context() noexcept{return context::PrecomputedCtx{{}, mlc::HashMap<mlc::String, mlc::String>(), mlc::HashMap<mlc::String, std::shared_ptr<load_item::LoadItem>>(), {}, {}, mlc::HashMap<mlc::String, mlc::String>(), mlc::HashMap<mlc::String, mlc::Array<mlc::String>>(), mlc::HashMap<mlc::String, std::shared_ptr<ctor_info::CtorTypeInfo>>(), mlc::HashMap<mlc::String, std::shared_ptr<ast::TypeExpr>>()};}
