...
bool is_format_subcommand(mlc::String argument) noexcept{return argument == mlc::String("fmt");}

bool is_lsp_subcommand(mlc::String argument) noexcept{return argument == mlc::String("lsp");}
