...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprStr('hi') → 'mlc::String(\"hi\")'"), codegen::gen_expr(std::make_shared<ast::Expr>(ast::ExprStr(mlc::String("hi"))), ctx), mlc::String("mlc::String(\"hi\")")));
