...
results.push_back(test_runner::assert_eq_str(mlc::String("create_codegen_context: gen_expr with ctx"), eval::gen_expr_via_string(si(42), ctx), mlc::String("42")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprInt(42) - '42'"), eval::gen_expr_via_string(si(42), ctx), mlc::String("42")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprQuestion: gen_expr index-based unwrap"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprQuestion(si(7), unk_t(), ast::span_unknown())), ctx), mlc::String("({ auto __q = 7; if (std::get_if<1>(&__q)) return *std::get_if<1>(&__q); std::get<0>(__q).field0; })")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprBool(true) - 'true'"), eval::gen_expr_via_string(sb(true), ctx), mlc::String("true")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprStr('hi') - 'mlc::String(\"hi\", 2)'"), eval::gen_expr_via_string(ss(mlc::String("hi")), ctx), mlc::String("mlc::String(\"hi\", 2)")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprUnit - 'std::make_tuple()'"), eval::gen_expr_via_string(su(), ctx), mlc::String("std::make_tuple()")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprIdent('x') - 'x'"), eval::gen_expr_via_string(sid(mlc::String("x")), ctx), mlc::String("x")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprIdent('print') - 'mlc::io::print'"), eval::gen_expr_via_string(sid(mlc::String("print")), ctx), mlc::String("mlc::io::print")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprIdent('println') - 'mlc::io::println'"), eval::gen_expr_via_string(sid(mlc::String("println")), ctx), mlc::String("mlc::io::println")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprBin add - '(1 + 2)'"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprBin(mlc::String("+"), si(1), si(2), i32_t(), ast::span_unknown())), ctx), mlc::String("(1 + 2)")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprUn neg - '(-42)'"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprUn(mlc::String("-"), si(42), i32_t(), ast::span_unknown())), ctx), mlc::String("(-42)")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprLambda annotated TFn([i32], i32) uses explicit int parameter"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprLambda(single_params, std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprBin(mlc::String("+"), sid(mlc::String("x")), si(1), i32_t(), ast::span_unknown())), lambda_typed_with_single_i32_parameter, ast::span_unknown())), ctx), mlc::String("[&](int x) mutable { return (x + 1); }")));
mlc::Array<mlc::String> two_params = mlc::Array<mlc::String>{mlc::String("a"), mlc::String("b")};
results.push_back(test_runner::assert_eq_str(mlc::String("ExprLambda two params - '[=](auto a, auto b) mutable { return ... }'"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprLambda(two_params, std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprBin(mlc::String("+"), sid(mlc::String("a")), sid(mlc::String("b")), i32_t(), ast::span_unknown())), unk_t(), ast::span_unknown())), ctx), mlc::String("[&](auto a, auto b) mutable { return (a + b); }")));
mlc::Array<mlc::String> zero_params = {};
results.push_back(test_runner::assert_eq_str(mlc::String("ExprLambda zero params - '[]() mutable { return ... }'"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprLambda(zero_params, si(42), unk_t(), ast::span_unknown())), ctx), mlc::String("[]() mutable { return 42; }")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprCall with lambda arg"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprCall(sid(mlc::String("apply")), call_lambda_args, empty_parameter_mutability_pattern(), unk_t(), ast::span_unknown())), ctx), mlc::String("apply(5, [&](auto x) mutable { return (x + 1); })")));
mlc::Array<std::shared_ptr<semantic_ir::SExpr>> ok_args = mlc::Array<std::shared_ptr<semantic_ir::SExpr>>{si(42)};
results.push_back(test_runner::assert_eq_str(mlc::String("ExprCall ctor Ok(42) uses brace init"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprCall(sid(mlc::String("Ok")), ok_args, empty_parameter_mutability_pattern(), unk_t(), ast::span_unknown())), ctx), mlc::String("Ok{42}")));
mlc::Array<std::shared_ptr<semantic_ir::SExpr>> err_args = mlc::Array<std::shared_ptr<semantic_ir::SExpr>>{ss(mlc::String("oops"))};
results.push_back(test_runner::assert_eq_str(mlc::String("ExprCall ctor Err(str) uses brace init"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprCall(sid(mlc::String("Err")), err_args, empty_parameter_mutability_pattern(), unk_t(), ast::span_unknown())), ctx), mlc::String("Err{mlc::String(\"oops\", 4)}")));
...
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("mutable first positional actual argument lowers with holder IIFE"), eval::gen_expr_via_string(outer_under_mut_actual_test_expression, ctx), mlc::String("__mut_actual_argument_holder_0")));
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("mutable first positional actual argument lowers with return prelude"), eval::gen_expr_via_string(outer_under_mut_actual_test_expression, ctx), mlc::String("[&]()")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprIf"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprIf(sb(true), si(1), si(2), i32_t(), ast::span_unknown())), ctx), mlc::String("(true ? (1) : (2))")));
mlc::Array<std::shared_ptr<semantic_ir::SExpr>> arr_elems = mlc::Array<std::shared_ptr<semantic_ir::SExpr>>{si(1), si(2), si(3)};
results.push_back(test_runner::assert_eq_str(mlc::String("ExprArray"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprArray(arr_elems, std::make_shared<registry::Type>(registry::TArray(i32_t())), ast::span_unknown())), ctx), mlc::String("mlc::Array<int>{1, 2, 3}")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprArray empty"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprArray(empty_arr, std::make_shared<registry::Type>(registry::TArray(i32_t())), ast::span_unknown())), ctx), mlc::String("mlc::Array<int>{}")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprIndex"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprIndex(sid(mlc::String("arr")), si(0), i32_t(), ast::span_unknown())), ctx), mlc::String("arr[0]")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprField on ident"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprField(sid(mlc::String("point")), mlc::String("x"), unk_t(), ast::span_unknown())), ctx), mlc::String("point.x")));
mlc::Array<std::shared_ptr<semantic_ir::SExpr>> method_args = mlc::Array<std::shared_ptr<semantic_ir::SExpr>>{si(1)};
results.push_back(test_runner::assert_eq_str(mlc::String("ExprMethod push"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprMethod(sid(mlc::String("arr")), mlc::String("push"), method_args, empty_parameter_mutability_pattern(), unit_t(), ast::span_unknown())), ctx), mlc::String("arr.push_back(1)")));
results.push_back(test_runner::assert_eq_str(mlc::String("ExprMethod length"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprMethod(sid(mlc::String("arr")), mlc::String("length"), empty_arr, empty_parameter_mutability_pattern(), i32_t(), ast::span_unknown())), ctx), mlc::String("arr.length()")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprMethod Result map"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprMethod(s_result, mlc::String("map"), map_one, empty_parameter_mutability_pattern(), unk_t(), ast::span_unknown())), ctx), mlc::String("mlc::result::map(r, f)")));
...
mlc::String match_out = eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprMatch(sid(mlc::String("n")), pat_arms, str_t(), ast::span_unknown())), ctx);
...
mlc::String or_match_out = eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprMatch(sid(mlc::String("s")), or_arms, str_t(), ast::span_unknown())), ctx);
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: guarded primitive"), guarded_primitive_program));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: plain sum"), plain_sum_program));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: guarded sum"), guarded_sum_program));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: mixed guard"), mixed_guard_program));
...
mlc::String while_out = eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprWhile(sb(true), while_body, unit_t(), ast::span_unknown())), ctx);
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprBlock"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprBlock(block_stmts, sid(mlc::String("x")), i32_t(), ast::span_unknown())), ctx), mlc::String("[&]() {\nauto x = 1;\nreturn x;\n}()")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("gen_stmts_cpp_as_string: break"), eval::gen_stmts_str(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>{std::make_shared<semantic_ir::SStmt>(semantic_ir::SStmtBreak(ast::span_unknown()))}, ctx), mlc::String("break;\n")));
results.push_back(test_runner::assert_eq_str(mlc::String("gen_stmts_cpp_as_string: let"), eval::gen_stmts_str(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>{std::make_shared<semantic_ir::SStmt>(semantic_ir::SStmtLet(mlc::String("counter"), false, si(1), i32_t(), ast::span_unknown()))}, ctx), mlc::String("auto counter = 1;\n")));
results.push_back(test_runner::assert_eq_str(mlc::String("gen_stmts_cpp_as_string: return"), eval::gen_stmts_str(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>{std::make_shared<semantic_ir::SStmt>(semantic_ir::SStmtReturn(si(0), ast::span_unknown()))}, ctx), mlc::String("return 0;\n")));
results.push_back(test_runner::assert_eq_str(mlc::String("gen_stmts_cpp_as_string: let const matches string"), eval::gen_stmts_str(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>{std::make_shared<semantic_ir::SStmt>(semantic_ir::SStmtLetConst(mlc::String("limit"), si(42), i32_t(), ast::span_unknown()))}, ctx), eval::gen_stmts_via_string(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>{std::make_shared<semantic_ir::SStmt>(semantic_ir::SStmtLetConst(mlc::String("limit"), si(42), i32_t(), ast::span_unknown()))}, ctx)));
...
results.push_back(test_runner::assert_eq_str(mlc::String("ExprRecord positional"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprRecord(mlc::String("Point"), fv_a, std::make_shared<registry::Type>(registry::TNamed(mlc::String("Point"))), ast::span_unknown())), ctx), mlc::String("Point{1, 2}")));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent(mlc::String("backends: fn_prog"), fn_prog));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: d3 trait parameter"), d3_trait_parameter_source));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: d3 two trait parameters"), d3_two_trait_parameter_source));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: d4 where trait bounds"), d4_where_trait_bounds_source));
...
results.push_back(test_runner::assert_eq_str(mlc::String("string literal with embedded newline - escapes to \\n in C++"), eval::gen_expr_via_string(ss(mlc::String("hello\nworld")), ctx), mlc::String("mlc::String(\"hello\\nworld\", 11)")));
results.push_back(test_runner::assert_eq_str(mlc::String("string literal with tab - escapes to \\t"), eval::gen_expr_via_string(ss(mlc::String("a\tb")), ctx), mlc::String("mlc::String(\"a\\tb\", 3)")));
results.push_back(test_runner::assert_eq_str(mlc::String("string literal with backslash - escapes to \\\\"), eval::gen_expr_via_string(ss(mlc::String("a\\b")), ctx), mlc::String("mlc::String(\"a\\\\b\", 3)")));
results.push_back(test_runner::assert_eq_str(mlc::String("string literal with double quote - escapes to \\\""), eval::gen_expr_via_string(ss(mlc::String("say \"hi\"")), ctx), mlc::String("mlc::String(\"say \\\"hi\\\"\", 8)")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("phantom record expr: Ast<Unvalidated>{}"), eval::gen_expr_via_string(phantom_rec_expr, ctx), mlc::String("Ast<Unvalidated>{}")));
...
results.push_back(test_runner::assert_eq_str(mlc::String("c4: f64 literal codegen"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprFloat(mlc::String("3.14"), f64_t, ast::span_unknown())), ctx), mlc::String("3.14")));
results.push_back(test_runner::assert_eq_str(mlc::String("c4: i64 literal codegen"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprI64(mlc::String("42"), i64_t, ast::span_unknown())), ctx), mlc::String("42")));
results.push_back(test_runner::assert_eq_str(mlc::String("c4: u8 literal codegen"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprU8(mlc::String("255"), u8_t, ast::span_unknown())), ctx), mlc::String("static_cast<uint8_t>(255)")));
results.push_back(test_runner::assert_eq_str(mlc::String("c4: usize literal codegen"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprUsize(mlc::String("100"), usize_t, ast::span_unknown())), ctx), mlc::String("static_cast<size_t>(100)")));
results.push_back(test_runner::assert_eq_str(mlc::String("c4: char literal codegen"), eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprChar(mlc::String("a"), char_t, ast::span_unknown())), ctx), mlc::String("static_cast<char32_t>(a)")));
...
mlc::String with_out = eval::gen_expr_via_string(std::make_shared<semantic_ir::SExpr>(semantic_ir::SExprWith(si(1), mlc::String("res"), with_body, unit_t(), ast::span_unknown())), ctx);
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: assoc type bind"), assoc_prog_src));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: operator desugar"), op_prog_src));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: else-if chain tail"), codegen_invariant_tail_after_else_if_chain));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: twin if zip join"), codegen_invariant_twin_if_zip_join_style));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: if else flattened"), codegen_invariant_if_else_flattened));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: large function body"), codegen_large_function_body));
...
results.push_back(codegen_test_helpers::assert_cpp_backends_equivalent_source(mlc::String("backends: extend method call"), codegen_extend_method));
return results;
}
