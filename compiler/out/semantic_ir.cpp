...
std::shared_ptr<registry::Type> sexpr_type(std::shared_ptr<semantic_ir::SExpr> expression) noexcept{return std::visit(overloaded{
  ...
  [&](const SExprCall& sexprcall) -> std::shared_ptr<registry::Type> { auto [_w0, _w1, _w2, t, _w3] = sexprcall; return t; },
  [&](const SExprMethod& sexprmethod) -> std::shared_ptr<registry::Type> { auto [_w0, _w1, _w2, _w3, t, _w4] = sexprmethod; return t; },
...
ast::Span sexpr_span(std::shared_ptr<semantic_ir::SExpr> expression) noexcept{return std::visit(overloaded{
  ...
  [&](const SExprCall& sexprcall) -> ast::Span { auto [_w0, _w1, _w2, _w3, s] = sexprcall; return s; },
  [&](const SExprMethod& sexprmethod) -> ast::Span { auto [_w0, _w1, _w2, _w3, _w4, s] = sexprmethod; return s; },
