...
bool derive_trait_name_allowed(mlc::String trait_name) noexcept{return trait_name == mlc::String("Display") ? true : trait_name == mlc::String("Eq") ? true : trait_name == mlc::String("Ord") ? true : trait_name == mlc::String("Hash") ? true : false;}
