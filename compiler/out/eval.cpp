...
mlc::String CodegenContext_gen_expr(context::CodegenContext self, std::shared_ptr<semantic_ir::SemanticExpression> expression) noexcept{return print::print_expr(expr_visitor_cpp::eval_expr_cpp(expression, self, eval_expr_gen_stmts_callback));}
