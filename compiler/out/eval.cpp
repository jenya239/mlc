...
{
std::shared_ptr<ast::Expr> value = expression_support::find_field_value(field_values, field_order[index]);
...
mlc::String gen_expr(std::shared_ptr<ast::Expr> expr, context::CodegenContext context) noexcept{return std::visit(overloaded{
  ...
  [&](const ExprStr& exprstr) -> mlc::String { auto [string_value, _w0] = exprstr; return literals::gen_string_literal(string_value); },
  [&](const ExprBool& exprbool) -> mlc::String { auto [boolean_value, _w0] = exprbool; return literals::gen_boolean_literal(boolean_value); },
  [&](const ExprUnit& exprunit) -> mlc::String { auto [_w0] = exprunit; return literals::gen_unit_literal(); },
  [&](const ExprExtern& exprextern) -> mlc::String { auto [_w0] = exprextern; return literals::gen_extern_placeholder(); },
  [&](const ExprIdent& exprident) -> mlc::String { auto [name, _w0] = exprident; return identifiers::gen_identifier(name, context); },
