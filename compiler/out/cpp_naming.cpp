...
mlc::String map_builtin(mlc::String name) noexcept{return name == mlc::String("print") ? mlc::String("mlc::io::print") : name == mlc::String("println") ? mlc::String("mlc::io::println") : name == mlc::String("exit") ? mlc::String("mlc::io::exit") : name == mlc::String("args") ? mlc::String("mlc::io::args") : name == mlc::String("read_line") ? mlc::String("mlc::io::read_line") : name == mlc::String("spawn_task") ? mlc::String("mlc::concurrency::spawn_task") : name == mlc::String("make_channel") ? mlc::String("mlc::concurrency::make_channel") : name == mlc::String("is_ready") ? mlc::String("mlc::is_ready") : name == mlc::String("block_on") ? mlc::String("mlc::block_on") : name;}
