...
if ((__match_subject == mlc::String("fn", 2))) {
  return true;
} else if ((__match_subject == mlc::String("type", 4))) {
  return true;
} else if ((__match_subject == mlc::String("let", 3))) {
  return true;
} else if ((__match_subject == mlc::String("mut", 3))) {
  return true;
  ...
  return true;
} else if ((__match_subject == mlc::String("then", 4))) {
  return true;
} else if ((__match_subject == mlc::String("else", 4))) {
  return true;
} else if ((__match_subject == mlc::String("unless", 6))) {
  return true;
} else if ((__match_subject == mlc::String("while", 5))) {
  return true;
} else if ((__match_subject == mlc::String("for", 3))) {
  return true;
} else if ((__match_subject == mlc::String("in", 2))) {
  return true;
} else if ((__match_subject == mlc::String("do", 2))) {
  return true;
} else if ((__match_subject == mlc::String("end", 3))) {
  return true;
} else if ((__match_subject == mlc::String("match", 5))) {
  return true;
} else if ((__match_subject == mlc::String("with", 4))) {
  return true;
} else if ((__match_subject == mlc::String("import", 6))) {
  return true;
} else if ((__match_subject == mlc::String("from", 4))) {
  return true;
} else if ((__match_subject == mlc::String("as", 2))) {
  return true;
} else if ((__match_subject == mlc::String("extern", 6))) {
  return true;
} else if ((__match_subject == mlc::String("extend", 6))) {
  return true;
} else if ((__match_subject == mlc::String("where", 5))) {
  return true;
} else if ((__match_subject == mlc::String("spawn", 5))) {
  return true;
...
mlc::String map_escape(mlc::String character) noexcept{
  return [&]() -> mlc::String {
auto __match_subject = character;
if ((__match_subject == mlc::String("n", 1))) {
  return mlc::String("\n", 1);
} else if ((__match_subject == mlc::String("t", 1))) {
  return mlc::String("\t", 1);
} else if ((__match_subject == mlc::String("r", 1))) {
  return mlc::String("\r", 1);
} else if ((__match_subject == mlc::String("\"", 1))) {
  return mlc::String("\"", 1);
} else if ((__match_subject == mlc::String("\\", 1))) {
  return mlc::String("\\", 1);
} else if ((__match_subject == mlc::String("0", 1))) {
  return mlc::String("\0", 1);
} else if ((__match_subject == mlc::String("{", 1))) {
  return mlc::String("{", 1);
} else if ((__match_subject == mlc::String("}", 1))) {
...
ScanResult scan_op_two_character(LexState state, mlc::String character, mlc::String next) noexcept{
  return [&]() -> ScanResult {
auto __match_subject = character;
if ((__match_subject == mlc::String("-", 1))) {
  return [&]() -> ScanResult {
auto __match_subject = next;
if ((__match_subject == mlc::String(">", 1))) {
