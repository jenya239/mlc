...
return ast_tokens::Token{kind, self.line, self.col};
}
...
auto token_line = state.line;
auto token_col = state.col;
auto current = LexState_advance(state);
...
return (((character == mlc::String("-", 1)) && (next == mlc::String(">", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Arrow{})} : (((character == mlc::String("=", 1)) && (next == mlc::String(">", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::FatArrow{})} : (((character == mlc::String("|", 1)) && (next == mlc::String(">", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Pipe{})} : (((character == mlc::String("=", 1)) && (next == mlc::String("=", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Op(mlc::String("==", 2)))} : (((character == mlc::String("!", 1)) && (next == mlc::String("=", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Op(mlc::String("!=", 2)))} : (((character == mlc::String("<", 1)) && (next == mlc::String("=", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Op(mlc::String("<=", 2)))} : (((character == mlc::String(">", 1)) && (next == mlc::String("=", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Op(mlc::String(">=", 2)))} : (((character == mlc::String("&", 1)) && (next == mlc::String("&", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Op(mlc::String("&&", 2)))} : (((character == mlc::String("|", 1)) && (next == mlc::String("|", 1))) ? ScanResult{LexState_advance_by(state, 2), LexState_token(state, ast_tokens::Op(mlc::String("||", 2)))} : ((character == mlc::String("=", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Equal{})} : ((character == mlc::String("|", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Bar{})} : ((character == mlc::String("?", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Question{})} : ((((character == mlc::String(".", 1)) && (next == mlc::String(".", 1))) && (LexState_peek(state, 2) == mlc::String(".", 1))) ? ScanResult{LexState_advance_by(state, 3), LexState_token(state, ast_tokens::Spread{})} : ((character == mlc::String(".", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Dot{})} : ((character == mlc::String("(", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::LParen{})} : ((character == mlc::String(")", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::RParen{})} : ((character == mlc::String("{", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::LBrace{})} : ((character == mlc::String("}", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::RBrace{})} : ((character == mlc::String("[", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::LBracket{})} : ((character == mlc::String("]", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::RBracket{})} : ((character == mlc::String(",", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Comma{})} : ((character == mlc::String(";", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Semicolon{})} : ((character == mlc::String(":", 1)) ? ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Colon{})} : ScanResult{LexState_advance(state), LexState_token(state, ast_tokens::Op(character))})))))))))))))))))))))));
}
