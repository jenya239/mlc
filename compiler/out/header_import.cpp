...
std::shared_ptr<ast::TypeExpr> cpp_type_string_to_type_expr(mlc::String type_string) noexcept{return type_string == mlc::String("int") ? std::make_shared<ast::TypeExpr>((ast::TyI32{})) : type_string == mlc::String("bool") ? std::make_shared<ast::TypeExpr>((ast::TyBool{})) : type_string == mlc::String("void") ? std::make_shared<ast::TypeExpr>((ast::TyUnit{})) : std::make_shared<ast::TypeExpr>(ast::TyNamed(type_string));}
