...
std::shared_ptr<ast::TypeExpr> cpp_type_string_to_type_expr(mlc::String type_string) noexcept{
  ...
  } else if ((type_string == mlc::String("bool", 4)))   {
    return std::make_shared<ast::TypeExpr>(ast::TyBool{});
  } else if ((type_string == mlc::String("void", 4)))   {
...
mlc::Array<std::shared_ptr<ast::Param>> cpp_parameter_strings_to_params(mlc::Array<mlc::String> parameter_strings) noexcept{
  ...
  while ((index < parameter_strings.length()))   {
    ...
    parameters.push_back(std::make_shared<ast::Param>(ast::Param{parameter_name, false, cpp_type_string_to_type_expr(parts.type_string), false, std::make_shared<ast::Expr>(ast::ExprUnit{ast::span_unknown()}), std::make_shared<ast::Pattern>(ast::PatternUnit{ast::span_unknown()})}));
...
mlc::Array<std::shared_ptr<ast::Param>> cpp_cpp_parameters_to_mlc_params(mlc::Array<std::shared_ptr<cpp_ast::CppParam>> parameters) noexcept{
  ...
  while ((index < parameters.length()))   {
    ...
    mlc_parameters.push_back(std::make_shared<ast::Param>(ast::Param{parameter_name, false, cpp_type_string_to_type_expr(print::print_cpp_type(parameter->parameter_type)), false, std::make_shared<ast::Expr>(ast::ExprUnit{ast::span_unknown()}), std::make_shared<ast::Pattern>(ast::PatternUnit{ast::span_unknown()})}));
    (index = mlc::arith::checked_add(index, 1));
  }
...
auto [__0, return_type, function_name, parameter_strings] = cppFnProto; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclFn{function_name, {}, {}, cpp_parameter_strings_to_params(parameter_strings), cpp_type_string_to_type_expr(return_type), std::make_shared<ast::Expr>(ast::ExprExtern{function_name, header_import_extern_marker(), {}, ast::span_unknown()}), {}})};
}
...
auto [__0, type_name, fields, __3] = cppStruct; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclType{type_name, {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{std::make_shared<ast::TypeVariant>(ast::VarRecord{type_name, cpp_fields_to_field_definitions(fields), false})}, {}, ast::span_unknown()})};
}
...
auto [definition] = cppClassDeclaration; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclType{definition.name, {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{std::make_shared<ast::TypeVariant>(ast::VarRecord{definition.name, cpp_class_members_to_field_definitions(definition.members), false})}, {}, ast::span_unknown()})};
}
...
auto [alias_name, type_node] = cppTypedefDeclaration; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclTypeAlias{alias_name, {}, cpp_type_string_to_type_expr(print::print_cpp_type(type_node)), ast::span_unknown()})};
}
...
auto [__0, type_name] = cppForwardDecl; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclType{type_name, {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{std::make_shared<ast::TypeVariant>(ast::VarRecord{type_name, {}, false})}, {}, ast::span_unknown()})};
}
...
auto [alias, type_string] = cppUsing; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclTypeAlias{alias, {}, cpp_type_string_to_type_expr(type_string), ast::span_unknown()})};
}
...
auto [__0, enum_name, arms] = cppVariant; return mlc::Array<std::shared_ptr<ast::Decl>>{std::make_shared<ast::Decl>(ast::DeclType{enum_name, {}, cpp_enum_arms_to_variants(arms), {}, ast::span_unknown()})};
}
