...
struct CodegenContext {
  ...
  mlc::HashMap<mlc::String, mlc::Array<mlc::String>> sum_type_parameter_names;
  mlc::HashMap<mlc::String, mlc::Array<mlc::String>> variant_used_type_parameter_names;
  ...
  mlc::HashMap<mlc::String, mlc::Array<mlc::String>> trait_associated_type_names;
