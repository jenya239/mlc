...
auto type_errors = (type_mismatch ? (mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((((mlc::String("field ", 6) + field_value->name) + mlc::String(": expected ", 11)) + semantic_type_structure::type_description(expected_type)) + mlc::String(", got ", 6)) + semantic_type_structure::type_description(actual_type)), ast::expr_span(field_value->val))}) : (mlc::Array<ast::Diagnostic>{}));
