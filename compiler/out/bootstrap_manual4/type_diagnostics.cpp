...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("unary - expects i32, got ", 25) + semantic_type_structure::type_description(inner_type)), source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("operator ! expects bool, got ", 29) + semantic_type_structure::type_description(inner_type)), source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("expected ", 9) + mlc::to_string(expected_length)) + mlc::String(" arguments, got ", 16)) + mlc::to_string(actual_length)), call_source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("expected ", 9) + mlc::to_string(expected)) + mlc::String(" arguments, got ", 16)) + mlc::to_string(argument_count)), method_span)};
} else {
return {};
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("expected ", 9) + mlc::to_string(expected_count)) + mlc::String(" arguments, got ", 16)) + mlc::to_string(actual_count)), call_source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((((mlc::String("expected between ", 17) + mlc::to_string(min_count)) + mlc::String(" and ", 5)) + mlc::to_string(max_count)) + mlc::String(" arguments, got ", 16)) + mlc::to_string(actual_count)), call_source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("indexing requires an array, got ", 32) + semantic_type_structure::type_description(receiver_type)), bracket_source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("array index must be i32, got ", 29) + semantic_type_structure::type_description(index_type)), bracket_source_span)};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("if branch types differ: then ", 29) + semantic_type_structure::type_description(then_type)) + mlc::String(", else ", 7)) + semantic_type_structure::type_description(else_type)), ast::expr_span(else_expression))};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("for loop range must be an array, got ", 37) + semantic_type_structure::type_description(iterator_type)), ast::expr_span(iterator))};
} else {
return {};
}
}
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("match arm result type ", 22) + semantic_type_structure::type_description(arm_result_type)) + mlc::String(" does not match first arm type ", 31)) + semantic_type_structure::type_description(first_arm_type)), ast::expr_span(arm_body))};
} else {
return {};
}
}
...
auto inner_object_type = std::visit(overloaded{[&](const registry::TShared& tShared) { auto [inner] = tShared; return inner; },
...
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((((mlc::String("undefined field: ", 17) + field_name) + mlc::String(" on ", 4)) + type_name), field_source_span)};
} else {
return {};
}
} else if ((!semantic_type_structure::type_is_unknown(object_type))) {
if (((type_name != mlc::String("", 0)) && (!registry::TypeRegistry_has_fields(registry, type_name)))) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error(((mlc::String("field access needs a record type; ", 34) + type_name) + mlc::String(" is not one", 11)), field_source_span)};
} else if (semantic_type_structure::type_is_array(object_type)) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("array value has no record fields for .", 38) + field_name), field_source_span)};
} else if ((!semantic_type_structure::type_is_function(object_type))) {
return mlc::Array<ast::Diagnostic>{ast::diagnostic_error((mlc::String("field access on value without record fields: ", 45) + semantic_type_structure::type_description(object_type)), field_source_span)};
} else {
return {};
}
