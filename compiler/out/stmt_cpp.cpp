...
[&](const semantic_ir::SemanticExpressionExtern& semanticExpressionExtern) -> GenStmtCppResult { auto [__0, __1] = semanticExpressionExtern; return gen_auto_let_stmt_cpp_result(name, value, context, try_counter); },
...
[&](const semantic_ir::SemanticExpressionExtern& semanticExpressionExtern) -> GenStmtCppResult { auto [__0, __1] = semanticExpressionExtern; return gen_return_stmt_cpp_default(expression, context, try_counter); },
...
[&](const semantic_ir::SemanticExpressionExtern& semanticExpressionExtern) -> GenStmtCppResult { auto [__0, __1] = semanticExpressionExtern; return gen_expr_stmt_cpp_default(expression, context, try_counter); },
