...
TypeRegistry empty_registry() noexcept{
  ...
  auto ok_variant_parameter_types = mlc::Array{std::make_shared<Type>(TUnknown{})};
  auto error_variant_parameter_types = mlc::Array{std::make_shared<Type>(TUnknown{})};
  ...
  builtin_function_types.set(mlc::String("spawn_task", 10), std::make_shared<Type>(TFn{mlc::Array{std::make_shared<Type>(TUnknown{})}, std::make_shared<Type>(TGeneric{mlc::String("Task", 4), mlc::Array{std::make_shared<Type>(TUnknown{})}})}));
  builtin_required_arity.set(mlc::String("spawn_task", 10), 1);
  builtin_function_types.set(mlc::String("make_channel", 12), std::make_shared<Type>(TFn{mlc::Array{std::make_shared<Type>(TUsize{})}, std::make_shared<Type>(TGeneric{mlc::String("Channel", 7), mlc::Array{std::make_shared<Type>(TUnknown{})}})}));
...
if ((__match_subject == mlc::String("i64", 3))) {
  return std::make_shared<Type>(TI64{});
} else if ((__match_subject == mlc::String("f64", 3))) {
...
void register_decl_trait_into_registry(TypeRegistry& registry, mlc::String trait_name, mlc::Array<std::shared_ptr<ast::Decl>> methods) noexcept{
  auto index = 0;
...
return empty;
  ...
  auto assoc_binding_key = ((type_name + mlc::String("::", 2)) + trait_name);
...
void register_decl_type_into_registry(TypeRegistry& registry, mlc::String type_name, mlc::Array<mlc::String> type_parameters, mlc::Array<std::shared_ptr<ast::TypeVariant>> variants) noexcept{
...
void register_decl_type_alias_into_registry(TypeRegistry& registry, mlc::String alias_name, mlc::Array<mlc::String> type_parameters, std::shared_ptr<ast::TypeExpr> type_expression) noexcept{
...
auto [trait_name, __1, methods, __3] = declTrait; return [&]() {
...
auto [type_name, type_parameters, variants, __3, __4] = declType; return [&]() {
...
auto [alias_name, type_parameters, type_expression, __3] = declTypeAlias; return [&]() {
