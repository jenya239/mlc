...
TypeRegistry empty_registry() noexcept{
  ...
  builtin_function_types.set(mlc::String("__region_handle_new", 19), std::make_shared<Type>(TFn{{}, std::make_shared<Type>(TGeneric{mlc::String("RegionHandle", 12), mlc::Array<std::shared_ptr<Type>>{std::make_shared<Type>(TUnknown{})}})}));
  builtin_required_arity.set(mlc::String("__region_handle_new", 19), 0);
