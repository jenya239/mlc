...
mlc::Array<ast::Diagnostic> missing_method_errors = semantic_type_structure::type_is_unknown(builtin_type) && semantic_type_structure::type_is_unknown(inferred_type) ? method_receiver_diagnostics::infer_undefined_record_method_diagnostics(object_result.inferred_type, method_name, method_span, registry) : mlc::Array<ast::Diagnostic>{};
