...
mlc::Array<ast::Diagnostic> unary_minus_diagnostic(mlc::String operation, std::shared_ptr<registry::Type> inner_type, ast::Span source_span) noexcept{
return operation == mlc::String("-") && !semantic_type_structure::type_is_unknown(inner_type) && !type_utils::type_is_i32(inner_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("unary - expects i32, got ") + type_utils::type_description(inner_type), source_span)} : mlc::Array<ast::Diagnostic>{};
}

mlc::Array<ast::Diagnostic> unary_bang_diagnostic(mlc::String operation, std::shared_ptr<registry::Type> inner_type, ast::Span source_span) noexcept{
return operation == mlc::String("!") && !semantic_type_structure::type_is_unknown(inner_type) && !type_utils::type_is_bool(inner_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("operator ! expects bool, got ") + type_utils::type_description(inner_type), source_span)} : mlc::Array<ast::Diagnostic>{};
}
...
mlc::Array<ast::Diagnostic> infer_method_receiver_has(mlc::String method_name, std::shared_ptr<registry::Type> receiver_type, ast::Span method_span) noexcept{
return method_name == mlc::String("has") ? !semantic_type_structure::type_is_unknown(receiver_type) && !type_utils::receiver_type_is_map(receiver_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("method has expects a Map receiver, got ") + type_utils::type_description(receiver_type), method_span)} : mlc::Array<ast::Diagnostic>{} : mlc::Array<ast::Diagnostic>{};
}

mlc::Array<ast::Diagnostic> infer_method_receiver_get_remove_keys_values(mlc::String method_name, std::shared_ptr<registry::Type> receiver_type, ast::Span method_span) noexcept{
return method_name == mlc::String("get") || method_name == mlc::String("remove") || method_name == mlc::String("keys") || method_name == mlc::String("values") ? !semantic_type_structure::type_is_unknown(receiver_type) && !type_utils::receiver_type_is_map(receiver_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("method ") + method_name + mlc::String(" expects a Map receiver, got ") + type_utils::type_description(receiver_type), method_span)} : mlc::Array<ast::Diagnostic>{} : mlc::Array<ast::Diagnostic>{};
}
...
mlc::Array<ast::Diagnostic> index_not_array_diagnostic(std::shared_ptr<registry::Type> receiver_type, ast::Span bracket_source_span) noexcept{
return !semantic_type_structure::type_is_unknown(receiver_type) && !semantic_type_structure::type_is_array(receiver_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("indexing requires an array, got ") + type_utils::type_description(receiver_type), bracket_source_span)} : mlc::Array<ast::Diagnostic>{};
}

mlc::Array<ast::Diagnostic> index_not_i32_diagnostic(std::shared_ptr<registry::Type> index_type, ast::Span bracket_source_span) noexcept{
return !semantic_type_structure::type_is_unknown(index_type) && !type_utils::type_is_i32(index_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("array index must be i32, got ") + type_utils::type_description(index_type), bracket_source_span)} : mlc::Array<ast::Diagnostic>{};
}
...
mlc::Array<ast::Diagnostic> for_loop_range_diagnostic(std::shared_ptr<registry::Type> iterator_type, std::shared_ptr<ast::Expr> iterator) noexcept{
return !semantic_type_structure::type_is_unknown(iterator_type) && !semantic_type_structure::type_is_array(iterator_type) ? mlc::Array<ast::Diagnostic>{ast::diagnostic_error(mlc::String("for loop range must be an array, got ") + type_utils::type_description(iterator_type), ast::expr_span(iterator))} : mlc::Array<ast::Diagnostic>{};
}
