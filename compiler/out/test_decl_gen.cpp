...
std::shared_ptr<ast::Param> display_self = std::make_shared<ast::Param>(ast::Param{mlc::String("self"), false, std::make_shared<ast::TypeExpr>(ast::TyNamed(mlc::String("Display"))), false, std::make_shared<ast::Expr>(ast::ExprUnit(ast::span_unknown()))});
...
std::shared_ptr<ast::Param> color_self = std::make_shared<ast::Param>(ast::Param{mlc::String("self"), false, std::make_shared<ast::TypeExpr>(ast::TyNamed(mlc::String("Color"))), false, std::make_shared<ast::Expr>(ast::ExprUnit(ast::span_unknown()))});
