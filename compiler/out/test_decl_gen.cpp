...
std::shared_ptr<ast::Param> iparam(mlc::String name) noexcept{return std::make_shared<ast::Param>(ast::Param{name, false, std::make_shared<ast::TypeExpr>((ast::TyI32{})), false, std::make_shared<ast::Expr>(ast::ExprUnit(ast::span_unknown())), std::make_shared<ast::Pat>(ast::PatUnit(ast::span_unknown()))});}
...
std::shared_ptr<semantic_ir::SDecl> point_display = std::make_shared<semantic_ir::SDecl>(semantic_ir::SDeclType(mlc::String("Point"), {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{ast_builders::record_variant(mlc::String("Point"), mlc::Array<std::shared_ptr<ast::FieldDef>>{ast_builders::field_definition(mlc::String("x"), std::make_shared<ast::TypeExpr>((ast::TyI32{}))), ast_builders::field_definition(mlc::String("y"), std::make_shared<ast::TypeExpr>((ast::TyI32{})))})}, mlc::Array<mlc::String>{mlc::String("Display")}));
...
std::shared_ptr<semantic_ir::SDecl> point_eq = std::make_shared<semantic_ir::SDecl>(semantic_ir::SDeclType(mlc::String("Point"), {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{ast_builders::record_variant(mlc::String("Point"), mlc::Array<std::shared_ptr<ast::FieldDef>>{ast_builders::field_definition(mlc::String("x"), std::make_shared<ast::TypeExpr>((ast::TyI32{}))), ast_builders::field_definition(mlc::String("y"), std::make_shared<ast::TypeExpr>((ast::TyI32{})))})}, mlc::Array<mlc::String>{mlc::String("Eq")}));
...
std::shared_ptr<semantic_ir::SDecl> empty_hash = std::make_shared<semantic_ir::SDecl>(semantic_ir::SDeclType(mlc::String("Empty"), {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{ast_builders::record_variant(mlc::String("Empty"), {})}, mlc::Array<mlc::String>{mlc::String("Hash")}));
...
std::shared_ptr<semantic_ir::SDecl> hue_hash = std::make_shared<semantic_ir::SDecl>(semantic_ir::SDeclType(mlc::String("Hue"), {}, mlc::Array<std::shared_ptr<ast::TypeVariant>>{ast_builders::unit_variant(mlc::String("North")), ast_builders::unit_variant(mlc::String("South"))}, mlc::Array<mlc::String>{mlc::String("Hash")}));
...
std::shared_ptr<ast::Param> display_self = std::make_shared<ast::Param>(ast::Param{mlc::String("self"), false, std::make_shared<ast::TypeExpr>(ast::TyNamed(mlc::String("Display"))), false, std::make_shared<ast::Expr>(ast::ExprUnit(ast::span_unknown())), std::make_shared<ast::Pat>(ast::PatUnit(ast::span_unknown()))});
...
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("gen_trait_decl: concept keyword"), decl_extend::gen_trait_decl(context, mlc::String("Display"), {}, mlc::Array<std::shared_ptr<semantic_ir::SDecl>>{display_method}), mlc::String("concept")));
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("gen_trait_decl: trait identifier"), decl_extend::gen_trait_decl(context, mlc::String("Display"), {}, mlc::Array<std::shared_ptr<semantic_ir::SDecl>>{display_method}), mlc::String("Display")));
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("gen_trait_struct: std::function field"), decl_extend::gen_trait_struct(context, mlc::String("Display"), {}, mlc::Array<std::shared_ptr<semantic_ir::SDecl>>{display_method}), mlc::String("std::function")));
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("gen_trait_struct: vtable struct name"), decl_extend::gen_trait_struct(context, mlc::String("Display"), {}, mlc::Array<std::shared_ptr<semantic_ir::SDecl>>{display_method}), mlc::String("struct Display_vtable")));
results.push_back(codegen_test_helpers::assert_code_contains(mlc::String("gen_trait_struct: method name"), decl_extend::gen_trait_struct(context, mlc::String("Display"), {}, mlc::Array<std::shared_ptr<semantic_ir::SDecl>>{display_method}), mlc::String("to_string")));
std::shared_ptr<ast::Param> color_self = std::make_shared<ast::Param>(ast::Param{mlc::String("self"), false, std::make_shared<ast::TypeExpr>(ast::TyNamed(mlc::String("Color"))), false, std::make_shared<ast::Expr>(ast::ExprUnit(ast::span_unknown())), std::make_shared<ast::Pat>(ast::PatUnit(ast::span_unknown()))});
