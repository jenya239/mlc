...
std::shared_ptr<CtorTypeInfo> lookup_ctor_type_info(mlc::Array<std::shared_ptr<CtorTypeInfo>> infos, mlc::String constructor_lookup_name) noexcept{
  return infos.fold(std::make_shared<CtorTypeInfo>(CtorTypeInfo{mlc::String("", 0), {}, {}}), [=](auto chosen, std::shared_ptr<CtorTypeInfo> candidate_info) mutable { return [&]() -> std::shared_ptr<CtorTypeInfo> {
  if ((candidate_info->name == constructor_lookup_name))   {
