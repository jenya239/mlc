...
struct MutActualArgumentMaterializationOutcomeCpp {mlc::Array<std::shared_ptr<cpp_ast::CppStatement>> prelude_statements;mlc::Array<std::shared_ptr<cpp_ast::CppExpression>> materialized_argument_expressions;};
