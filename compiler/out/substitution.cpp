...
[&]() -> void { if (std::holds_alternative<registry::TGeneric>((*type_value))) { auto _v_tgeneric = std::get<registry::TGeneric>((*type_value)); auto [type_name, type_arguments] = _v_tgeneric; return [&]() { 
  mlc::Array<mlc::String> parameter_names = registry::TypeRegistry_algebraic_decl_type_parameter_names_for(registry, type_name);
  int index = 0;
  return [&]() { 
