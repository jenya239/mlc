...
predicates::ExprResult parse_and_no_pipe(predicates::Parser parser) noexcept;

predicates::ExprResult parse_or_no_pipe(predicates::Parser parser) noexcept;

predicates::ExprResult parse_bitwise_or(predicates::Parser parser) noexcept;

predicates::ExprResult parse_bitwise_xor(predicates::Parser parser) noexcept;

predicates::ExprResult parse_bitwise_and(predicates::Parser parser) noexcept;
...
predicates::ExprResult parse_shift(predicates::Parser parser) noexcept;
...
predicates::ExprResult parse_postfix_conditional(predicates::Parser parser, std::shared_ptr<ast::Expr> expression) noexcept;
...
predicates::ExprResult parse_match_scrutinee(predicates::Parser parser) noexcept;
...
predicates::ExprResult parse_match_arm_body(predicates::Parser parser) noexcept;
...
{
predicates::Parser after_bar = predicates::Parser_advance(state);
...
{
predicates::PatternResult next = parse_pattern(after_bar);
...
predicates::ExprResult parse_and(predicates::Parser parser) noexcept{
predicates::ExprResult left = parse_bitwise_or(parser);
std::shared_ptr<ast::Expr> expression = left.value;
predicates::Parser state = left.parser;
while (predicates::TokenKind_is_op(predicates::Parser_kind(state)) && predicates::TokenKind_op_val(predicates::Parser_kind(state)) == mlc::String("&&")){
{
ast::Span operator_span = predicates::Parser_span_at_cursor(state);
predicates::ExprResult right = parse_bitwise_or(predicates::Parser_advance(state));
expression = std::make_shared<ast::Expr>(ast::ExprBin(mlc::String("&&"), expression, right.value, operator_span));
state = right.parser;
}
}
...
predicates::ExprResult parse_and_no_pipe(predicates::Parser parser) noexcept{
predicates::ExprResult left = parse_bitwise_xor(parser);
std::shared_ptr<ast::Expr> expression = left.value;
predicates::Parser state = left.parser;
while (predicates::TokenKind_is_op(predicates::Parser_kind(state)) && predicates::TokenKind_op_val(predicates::Parser_kind(state)) == mlc::String("&&")){
{
ast::Span operator_span = predicates::Parser_span_at_cursor(state);
predicates::ExprResult right = parse_bitwise_xor(predicates::Parser_advance(state));
expression = std::make_shared<ast::Expr>(ast::ExprBin(mlc::String("&&"), expression, right.value, operator_span));
state = right.parser;
}
}
...
predicates::ExprResult parse_or_no_pipe(predicates::Parser parser) noexcept{
predicates::ExprResult left = parse_and_no_pipe(parser);
std::shared_ptr<ast::Expr> expression = left.value;
predicates::Parser state = left.parser;
while (predicates::TokenKind_is_op(predicates::Parser_kind(state)) && predicates::TokenKind_op_val(predicates::Parser_kind(state)) == mlc::String("||")){
{
ast::Span operator_span = predicates::Parser_span_at_cursor(state);
predicates::ExprResult right = parse_and_no_pipe(predicates::Parser_advance(state));
expression = std::make_shared<ast::Expr>(ast::ExprBin(mlc::String("||"), expression, right.value, operator_span));
state = right.parser;
}
}
...
predicates::ExprResult parse_bitwise_xor(predicates::Parser parser) noexcept{
predicates::ExprResult left = parse_bitwise_and(parser);
std::shared_ptr<ast::Expr> expression = left.value;
predicates::Parser state = left.parser;
while (predicates::TokenKind_is_op(predicates::Parser_kind(state)) && predicates::TokenKind_op_val(predicates::Parser_kind(state)) == mlc::String("^")){
{
ast::Span operator_span = predicates::Parser_span_at_cursor(state);
predicates::ExprResult right = parse_bitwise_and(predicates::Parser_advance(state));
expression = std::make_shared<ast::Expr>(ast::ExprBin(mlc::String("^"), expression, right.value, operator_span));
state = right.parser;
}
}
...
predicates::ExprResult parse_comparison_relational(predicates::Parser parser) noexcept{
predicates::ExprResult left = parse_shift(parser);
std::shared_ptr<ast::Expr> expression = left.value;
predicates::Parser state = left.parser;
bool go = true;
while (go){
...
ast::Span operator_span = predicates::Parser_span_at_cursor(state);
mlc::String operator_value = predicates::TokenKind_op_val(kind);
predicates::ExprResult right = parse_shift(predicates::Parser_advance(state));
expression = std::make_shared<ast::Expr>(ast::ExprBin(operator_value, expression, right.value, operator_span));
state = right.parser;
}
} else {
...
predicates::ExprResult parse_unary(predicates::Parser parser) noexcept{
ast_tokens::TokenKind kind = predicates::Parser_kind(parser);
return predicates::TokenKind_is_op(kind) && (predicates::TokenKind_op_val(kind) == mlc::String("!") || predicates::TokenKind_op_val(kind) == mlc::String("-") || predicates::TokenKind_op_val(kind) == mlc::String("~") || predicates::TokenKind_op_val(kind) == mlc::String("+")) ? [&]() -> predicates::ExprResult { 
...
predicates::ExprResult parse_postfix_conditional(predicates::Parser parser, std::shared_ptr<ast::Expr> expression) noexcept{
int expression_line_number = ast::expr_span(expression).line;
ast_tokens::TokenKind kind = predicates::Parser_kind(parser);
...
ast::Span header_span = predicates::Parser_span_at_cursor(parser);
bool is_negated = predicates::TokenKind_is_unless(kind);
predicates::ExprResult condition_parsed = parse_or(predicates::Parser_advance(parser));
std::shared_ptr<ast::Expr> condition = is_negated ? std::make_shared<ast::Expr>(ast::ExprUn(mlc::String("!"), condition_parsed.value, ast::span_unknown())) : condition_parsed.value;
...
predicates::ExprResult parse_match_scrutinee(predicates::Parser parser) noexcept{return parse_comparison_relational(parser);}

predicates::ExprResult parse_match_expr(predicates::Parser parser, ast::Span header_span) noexcept{
predicates::ExprResult subject_parsed = parse_match_scrutinee(parser);
...
predicates::ExprResult parse_match_arm_body(predicates::Parser parser) noexcept{
predicates::ExprResult parsed = parse_or_no_pipe(parser);
...
{
predicates::ExprResult guard_parsed = parse_or_no_pipe(predicates::Parser_with_lambda_shorthand_suppressed(predicates::Parser_advance(after_pattern), true));
...
predicates::ExprResult body_parsed = parse_match_arm_body(after_fat_arrow);
