...
cpp_lexer::CppScanOpR cpp_scan_op_single(lexer::LexState state, mlc::String character, int line, int column) noexcept{return [&]() -> cpp_lexer::CppScanOpR { if (character == mlc::String("(")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CLParen{}), line, column)}; } if (character == mlc::String(")")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CRParen{}), line, column)}; } if (character == mlc::String("{")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CLBrace{}), line, column)}; } if (character == mlc::String("}")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CRBrace{}), line, column)}; } if (character == mlc::String("[")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CLBracket{}), line, column)}; } if (character == mlc::String("]")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CRBracket{}), line, column)}; } return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make(cpp_tokens::COp(character), line, column)}; }();}

cpp_lexer::CppScanOpR cpp_scan_op_two_character(lexer::LexState state, mlc::String character, mlc::String next_char, int line, int column) noexcept{return [&]() -> cpp_lexer::CppScanOpR { if (character == mlc::String("-")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String(">")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CArrow{}), line, column)}; } if (next_char == mlc::String("-")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CDec{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } if (character == mlc::String(":")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String(":")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CScope{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } if (character == mlc::String("=")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("=")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CEq{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } if (character == mlc::String("!")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("=")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CNe{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } if (character == mlc::String("<")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("=")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CLe{}), line, column)}; } if (next_char == mlc::String("<")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CLShift{}), line, column)}; } return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CLAngle{}), line, column)}; }(); } if (character == mlc::String(">")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("=")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CGe{}), line, column)}; } if (next_char == mlc::String(">")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CRShift{}), line, column)}; } return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance(state), cpp_tokens::cpp_token_make((cpp_tokens::CRAngle{}), line, column)}; }(); } if (character == mlc::String("&")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("&")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CAnd{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } if (character == mlc::String("|")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("|")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::COr{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } if (character == mlc::String("+")) { return [&]() -> cpp_lexer::CppScanOpR { if (next_char == mlc::String("+")) { return cpp_lexer::CppScanOpR{lexer::LexState_lex_advance_by(state, 2), cpp_tokens::cpp_token_make((cpp_tokens::CInc{}), line, column)}; } return cpp_scan_op_single(state, character, line, column); }(); } return cpp_scan_op_single(state, character, line, column); }();}
