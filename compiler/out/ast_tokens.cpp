...
ast_tokens::TokenKind Token_kind_value(ast_tokens::Token self) noexcept{return self.kind;}

int Token_line_number(ast_tokens::Token self) noexcept{return self.line;}

int Token_column(ast_tokens::Token self) noexcept{return self.column;}
