...
std::visit(overloaded{[&](const ast::VarRecord& varRecord) { auto [variant_name, __1, __2] = varRecord; return [&]() {
...
[&](const ast::VarUnit& varUnit) { auto [variant_name, __1] = varUnit; return [&]() {
names.push_back(variant_name);
/* unit */;
return /* unit */;
}(); }
