...
context::StructUsingEntry semantic_declaration_assoc_bind_entry(std::shared_ptr<semantic_ir::SemanticDeclaration> method, context::CodegenContext context) noexcept{return [&]() -> context::StructUsingEntry { if (std::holds_alternative<semantic_ir::SemanticDeclarationAssocBind>((*method))) { auto _v_semanticdeclarationassocbind = std::get<semantic_ir::SemanticDeclarationAssocBind>((*method)); auto [assoc_name, bound_type, _w0] = _v_semanticdeclarationassocbind; return context::StructUsingEntry{assoc_name, type_gen::sem_type_to_cpp(context, bound_type)}; } return context::StructUsingEntry{mlc::String(""), mlc::String("")}; }();}
...
{
context::StructUsingEntry entry = semantic_declaration_assoc_bind_entry(methods[method_index], context);
...
void add_assoc_binds_from_declaration(mlc::HashMap<mlc::String, mlc::Array<context::StructUsingEntry>>& entries, mlc::HashMap<mlc::String, mlc::Array<mlc::String>>& lines, std::shared_ptr<semantic_ir::SemanticDeclaration> declaration, context::CodegenContext context) noexcept{
return [&]() -> void { if (std::holds_alternative<semantic_ir::SemanticDeclarationExtend>((*declaration))) { auto _v_semanticdeclarationextend = std::get<semantic_ir::SemanticDeclarationExtend>((*declaration)); auto [type_name, _w0, methods, _w1] = _v_semanticdeclarationextend; return add_assoc_bind_struct_using(entries, lines, type_name, methods, context); } if (std::holds_alternative<semantic_ir::SemanticDeclarationExported>((*declaration))) { auto _v_semanticdeclarationexported = std::get<semantic_ir::SemanticDeclarationExported>((*declaration)); auto [inner] = _v_semanticdeclarationexported; return add_assoc_binds_from_declaration(entries, lines, inner, context); }  }();
}
...
mlc::Array<std::shared_ptr<ast::Decl>> module_decls = decl_index::ast_decls_for_path(load_item.path, all_items);
mlc::HashMap<mlc::String, mlc::String> qualified = decl_index::extend_qualified_map(decl_index::build_qualified(load_item.imports, all_items), all_items, load_item.path);
...
context::CodegenContext base_context = context::CodegenContext{precomputed_context.field_orders, precomputed_context.field_order_index, mlc::String(""), qualified, namespace_alias_prefixes, mlc::String(""), type_index::build_method_owners_from_decls(module_decls), {}, {}, mlc::HashMap<mlc::String, mlc::String>(), {}, precomputed_context.ctor_type_infos, precomputed_context.ctor_type_info_index, precomputed_context.variant_types, precomputed_context.sum_type_parameter_names, precomputed_context.variant_used_type_parameter_names, {}, {}, precomputed_context.generic_variants, mlc::HashMap<mlc::String, mlc::Array<context::StructUsingEntry>>(), mlc::HashMap<mlc::String, mlc::Array<mlc::String>>(), precomputed_context.type_alias_annotations, precomputed_context.trait_associated_type_names, context::new_temp_name_counter(), std::make_shared<registry::Type>((registry::TUnknown{}))};
