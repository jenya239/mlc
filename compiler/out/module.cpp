...
auto [assoc_name, bound_type, __2] = semanticDeclarationAssocBind; [&]() {
auto type_cpp = type_gen::sem_type_to_cpp(context, bound_type);
...
auto [inner] = semanticDeclarationExported; [&]() {
[&]() {
