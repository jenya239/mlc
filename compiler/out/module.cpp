...
mlc::Array<mlc::String> type_fwds = decl_parts.type_fwds;
mlc::Array<mlc::String> type_defs = decl_parts.type_defs;
mlc::Array<mlc::String> fn_protos = decl_parts.fn_protos;
mlc::Array<mlc::String> fn_defs = decl_parts.fn_defs;
...
mlc::String implementation_import_includes = cpp_naming::include_lines(s_item.imports);
mlc::String implementation_using_namespaces = cpp_naming::using_namespace_lines(s_item.imports);
mlc::String impl = mlc::Array<mlc::String>{expr::implementation_define_main_as_user_main_line(), expr::implementation_include_quotefile_line(base + mlc::String(".hpp")), mlc::String("\n"), implementation_import_includes, implementation_import_includes.length() > 0 ? mlc::String("\n") : mlc::String(""), expr::namespace_open_line(module_namespace), mlc::String("\n"), implementation_using_namespaces, implementation_using_namespaces.length() > 0 ? mlc::String("\n") : mlc::String(""), fn_defs.join(mlc::String("")), mlc::String("\n"), expr::namespace_close_comment_line(module_namespace), cli_wrapper}.join(mlc::String(""));
