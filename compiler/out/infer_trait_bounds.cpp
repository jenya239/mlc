...
ast::Span bound_diagnostic_span = call_argument_unify::type_parameter_source_argument_span(type_param, type_parameter_source_argument_index, argument_expressions, call_source_span);
int trait_index = 0;
[&]() { 
