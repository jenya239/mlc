...
[&](const semantic_ir::SemanticDeclarationExternType& semanticDeclarationExternType) { auto [type_name, __1, __2, __3, __4] = semanticDeclarationExternType; return ((mlc::String("extern type ", 12) + mlc::to_string(type_name)) + mlc::String("", 0)); },
