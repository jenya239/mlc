...
mlc::String semantic_declaration_label(std::shared_ptr<semantic_ir::SemanticDeclaration> declaration) noexcept{
  return std::visit(overloaded{[&](const semantic_ir::SemanticDeclarationFn& semanticDeclarationFn) { auto [name, __1, __2, __3, __4, __5, __6, __7, __8] = semanticDeclarationFn; return ((mlc::String("fn ", 3) + mlc::to_string(name)) + mlc::String("", 0)); },
...
[&](const semantic_ir::SemanticDeclarationExternType& semanticDeclarationExternType) { auto [type_name, __1, __2, __3, __4, __5] = semanticDeclarationExternType; return ((mlc::String("extern type ", 12) + mlc::to_string(type_name)) + mlc::String("", 0)); },
