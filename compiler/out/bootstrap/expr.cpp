...
return ((mlc::String("({ auto __q = ", 14) + mlc::to_string(inner_code)) + mlc::String("; if (std::get_if<1>(&__q)) return *std::get_if<1>(&__q); std::get<0>(__q).field0; })", 85));
}
...
return ((((mlc::String("[&]() {\nwhile (", 15) + mlc::to_string(condition_code)) + mlc::String(") {\n", 4)) + mlc::to_string(body_statements)) + mlc::String("}\n}()", 5));
}
...
return ((((((mlc::String("[&]() {\nfor (auto ", 18) + mlc::to_string(variable_cpp_safe)) + mlc::String(" : ", 3)) + mlc::to_string(iterator_code)) + mlc::String(") {\n", 4)) + mlc::to_string(body_statements)) + mlc::String("}\n}()", 5));
}
...
return ((((((mlc::String("", 0) + mlc::to_string(object_code)) + mlc::String("", 0)) + mlc::to_string(access_operator)) + mlc::String("", 0)) + mlc::to_string(field_cpp_safe)) + mlc::String("", 0));
}
...
return typed_array_empty(element_type_cpp);
}
}
...
return ((mlc::String("#include \"", 10) + mlc::to_string(header_filename)) + mlc::String("\"\n", 2));
}
...
return ((((mlc::String("{ ", 2) + mlc::to_string(method_name)) + mlc::String("(self) } -> std::convertible_to<", 32)) + mlc::to_string(destination_type_cpp)) + mlc::String(">", 1));
}
...
return ((((((mlc::String("static_assert(", 14) + mlc::to_string(concept_cpp_safe)) + mlc::String("<", 1)) + mlc::to_string(type_cpp)) + mlc::String(">, \"", 4)) + mlc::to_string(diagnostic_message_inside_cpp_string_literal)) + mlc::String("\");\n", 4));
}
