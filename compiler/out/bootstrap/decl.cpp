...
while (method_index < methods.size()){
{
[&]() -> void { if (std::holds_alternative<ast::DeclFn>((*methods[method_index]))) { auto _v_declfn = std::get<ast::DeclFn>((*methods[method_index])); auto [mangled, _w0, _w1, params, ret_type, body] = _v_declfn; return [&]() -> void { if (std::holds_alternative<ast::ExprExtern>((*body)._)) {  return [&]() { 
