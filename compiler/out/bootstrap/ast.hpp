...
struct MatchArm {std::shared_ptr<Pat> pat;bool has_guard;std::shared_ptr<Expr> when_condition;std::shared_ptr<Expr> body;};
struct FieldVal {mlc::String name;std::shared_ptr<Expr> val;};
struct RecordLitFields {mlc::Array<std::shared_ptr<FieldVal>> field0;};
struct RecordLitSpread {std::shared_ptr<Expr> field0;};
...
struct ExprRecord {mlc::String field0;mlc::Array<RecordLitPart> field1;Span field2;};
...
struct Param {mlc::String name;bool is_mut;std::shared_ptr<TypeExpr> typ;bool has_default;std::shared_ptr<Expr> default_;std::shared_ptr<Pat> param_pattern;};
struct FieldDef {mlc::String name;std::shared_ptr<TypeExpr> typ;bool has_default_expression;std::shared_ptr<Expr> default_expression;};
...
struct DeclFn {mlc::String field0;mlc::Array<mlc::String> field1;mlc::Array<mlc::Array<mlc::String>> field2;mlc::Array<std::shared_ptr<Param>> field3;std::shared_ptr<TypeExpr> field4;std::shared_ptr<Expr> field5;mlc::Array<WhereClauseBound> field6;};
