...
struct SDeclAssocBind;
using SDecl = std::variant<SDeclFn, SDeclType, SDeclTrait, SDeclExtend, SDeclImport, SDeclExported, SDeclAssocBind>;
struct SMatchArm {std::shared_ptr<ast::Pat> pat;bool has_guard;std::shared_ptr<SExpr> when_condition;std::shared_ptr<SExpr> body;};
...
struct SExprCall {std::shared_ptr<SExpr> field0;mlc::Array<std::shared_ptr<SExpr>> field1;mlc::Array<int> field2;std::shared_ptr<registry::Type> field3;ast::Span field4;};
struct SExprMethod {std::shared_ptr<SExpr> field0;mlc::String field1;mlc::Array<std::shared_ptr<SExpr>> field2;mlc::Array<int> field3;std::shared_ptr<registry::Type> field4;ast::Span field5;};
...
struct SExprWith {std::shared_ptr<SExpr> field0;mlc::String field1;mlc::Array<std::shared_ptr<SStmt>> field2;std::shared_ptr<registry::Type> field3;ast::Span field4;};
...
struct SStmtLetPat {std::shared_ptr<ast::Pat> field0;bool field1;std::shared_ptr<SExpr> field2;std::shared_ptr<registry::Type> field3;bool field4;std::shared_ptr<SExpr> field5;ast::Span field6;};
...
struct SDeclFn {mlc::String field0;mlc::Array<mlc::String> field1;mlc::Array<mlc::Array<mlc::String>> field2;mlc::Array<std::shared_ptr<ast::Param>> field3;std::shared_ptr<registry::Type> field4;std::shared_ptr<SExpr> field5;mlc::Array<ast::WhereClauseBound> field6;};
...
struct SDeclAssocBind {mlc::String field0;std::shared_ptr<registry::Type> field1;ast::Span field2;};
