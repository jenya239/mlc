...
parameter_index = parameter_index + 1;
  ...
  all_errors = ast::errs_append(all_errors, inference_result.errors);
...
return all_errors.size() > 0 ? ast::Result<check::CheckOut, mlc::Array<mlc::String>>(ast::Err<mlc::Array<mlc::String>>(all_errors)) : ast::Result<check::CheckOut, mlc::Array<mlc::String>>(ast::Ok<check::CheckOut>(check::CheckOut{{}, registry}));
}
