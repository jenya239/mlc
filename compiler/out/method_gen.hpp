...
mlc::String gen_method_shared_new(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 eval_expr_fn) noexcept;
template<typename __F3>
mlc::String gen_method_arc_new(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 eval_expr_fn) noexcept;
template<typename __F3>
mlc::String gen_method_mutex_new(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 eval_expr_fn) noexcept;
...
template<typename __F3>
std::shared_ptr<cpp_ast::CppExpression> gen_method_shared_new_cpp(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 evaluate_expression) noexcept;
template<typename __F3>
std::shared_ptr<cpp_ast::CppExpression> gen_method_arc_new_cpp(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 evaluate_expression) noexcept;
template<typename __F3>
std::shared_ptr<cpp_ast::CppExpression> gen_method_mutex_new_cpp(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 evaluate_expression) noexcept;
template<typename __F5>
std::shared_ptr<cpp_ast::CppExpression> gen_method_mutex_lock_cpp(std::shared_ptr<cpp_ast::CppExpression> receiver_expression, std::shared_ptr<semantic_ir::SemanticExpression> callback_argument, std::shared_ptr<registry::Type> mutex_type, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F5 evaluate_expression) noexcept;
...
mlc::String gen_method_arc_new(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 eval_expr_fn) noexcept{
  auto argument_code = eval_expr_fn(argument, context, gen_stmts);
  auto element_type = expression_support::semantic_type_to_cpp_type_name(semantic_ir::sexpr_type(argument), context);
  return ((((mlc::String("mlc::concurrency::Arc<", 22) + mlc::to_string(element_type)) + mlc::String(">(", 2)) + mlc::to_string(argument_code)) + mlc::String(")", 1));
}
template<typename __F3>
mlc::String gen_method_mutex_new(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 eval_expr_fn) noexcept{
  auto argument_code = eval_expr_fn(argument, context, gen_stmts);
  auto element_type = expression_support::semantic_type_to_cpp_type_name(semantic_ir::sexpr_type(argument), context);
  return ((((mlc::String("mlc::concurrency::Mutex<", 24) + mlc::to_string(element_type)) + mlc::String(">(", 2)) + mlc::to_string(argument_code)) + mlc::String(")", 1));
}
template<typename __F3>
std::shared_ptr<cpp_ast::CppExpression> gen_method_shared_new_cpp(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 evaluate_expression) noexcept{
  auto argument_expression = evaluate_expression(argument, context, gen_stmts);
  auto element_type = expression_support::infer_shared_new_type_name(argument, context);
  return make_callee_call_cpp(((mlc::String("std::make_shared<", 17) + mlc::to_string(element_type)) + mlc::String(">", 1)), mlc::Array<std::shared_ptr<cpp_ast::CppExpression>>{argument_expression});
}
template<typename __F3>
std::shared_ptr<cpp_ast::CppExpression> gen_method_arc_new_cpp(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 evaluate_expression) noexcept{
  auto argument_expression = evaluate_expression(argument, context, gen_stmts);
  auto element_type = expression_support::semantic_type_to_cpp_type_name(semantic_ir::sexpr_type(argument), context);
  return make_callee_call_cpp(((mlc::String("mlc::concurrency::Arc<", 22) + mlc::to_string(element_type)) + mlc::String(">", 1)), mlc::Array<std::shared_ptr<cpp_ast::CppExpression>>{argument_expression});
}
template<typename __F3>
std::shared_ptr<cpp_ast::CppExpression> gen_method_mutex_new_cpp(std::shared_ptr<semantic_ir::SemanticExpression> argument, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F3 evaluate_expression) noexcept{
  auto argument_expression = evaluate_expression(argument, context, gen_stmts);
  auto element_type = expression_support::semantic_type_to_cpp_type_name(semantic_ir::sexpr_type(argument), context);
  return make_callee_call_cpp(((mlc::String("mlc::concurrency::Mutex<", 24) + mlc::to_string(element_type)) + mlc::String(">", 1)), mlc::Array<std::shared_ptr<cpp_ast::CppExpression>>{argument_expression});
}
template<typename __F5>
std::shared_ptr<cpp_ast::CppExpression> gen_method_mutex_lock_cpp(std::shared_ptr<cpp_ast::CppExpression> receiver_expression, std::shared_ptr<semantic_ir::SemanticExpression> callback_argument, std::shared_ptr<registry::Type> mutex_type, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, __F5 evaluate_expression) noexcept{
  auto inner_type = semantic_type_structure::mutex_inner_type_from_mutex_type(mutex_type);
  auto inner_type_cpp = type_gen::sem_type_to_cpp(context, inner_type);
...
auto [parameter_names, body, __2, __3] = semanticExpressionLambda; return [&]() -> std::shared_ptr<cpp_ast::CppExpression> {
  if ((parameter_names.length() == 1))   {
    return [&]() {
auto parameter_name = cpp_naming::cpp_safe(parameter_names[0]);
auto body_expression = evaluate_expression(body, context, gen_stmts);
auto lock_callback = std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppMutableLambda{mlc::Array<std::shared_ptr<cpp_ast::CppCapture>>{std::make_shared<cpp_ast::CppCapture>(cpp_ast::CppCapture{mlc::String("", 0), true})}, mlc::Array<std::shared_ptr<cpp_ast::CppParam>>{std::make_shared<cpp_ast::CppParam>(cpp_ast::CppParam{parameter_name, std::make_shared<cpp_ast::CppType>(cpp_ast::CppTypeName{((mlc::String("", 0) + mlc::to_string(inner_type_cpp)) + mlc::String("&", 1))})})}, body_expression});
return std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppCall{std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppMember{receiver_expression, mlc::String("lock", 4), false}), mlc::Array<std::shared_ptr<cpp_ast::CppExpression>>{lock_callback}});
}();
  } else   {
    return std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppCall{std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppMember{receiver_expression, mlc::String("lock", 4), false}), mlc::Array<std::shared_ptr<cpp_ast::CppExpression>>{evaluate_expression(callback_argument, context, gen_stmts)}});
  }
}();
}
return std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppCall{std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppMember{receiver_expression, mlc::String("lock", 4), false}), mlc::Array<std::shared_ptr<cpp_ast::CppExpression>>{evaluate_expression(callback_argument, context, gen_stmts)}});
