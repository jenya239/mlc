...
auto [inner_declaration] = declExported; [&]() {
[&]() {
auto __match_subject = inner_declaration;
if (std::holds_alternative<ast::DeclFn>((*__match_subject))) {
const ast::DeclFn& declFn = std::get<ast::DeclFn>((*__match_subject));
auto [name, __1, __2, __3, __4, __5, __6] = declFn; [&]() {
...
auto [type_name, __1, __2, __3] = declTypeAlias; [&]() {
...
while ((variant_index < variants.length())) {
  std::visit(overloaded{[&](const ast::VarRecord& varRecord) -> void { auto [variant_name, __1, __2] = varRecord; [&]() {
names.push_back(variant_name);
std::make_tuple();
return std::make_tuple();
}(); },
[&](const ast::VarTuple& varTuple) -> void { auto [variant_name, __1, __2] = varTuple; [&]() {
names.push_back(variant_name);
std::make_tuple();
return std::make_tuple();
}(); },
[&](const ast::VarUnit& varUnit) -> void { auto [variant_name, __1] = varUnit; [&]() {
names.push_back(variant_name);
std::make_tuple();
return std::make_tuple();
}(); }
...
auto [name, __1, methods, __3] = declTrait; [&]() {
names.push_back(name);
auto method_index = 0;
...
if (std::holds_alternative<ast::DeclFn>((*__match_subject))) {
const ast::DeclFn& declFn = std::get<ast::DeclFn>((*__match_subject));
auto [function_name, __1, __2, __3, __4, __5, __6] = declFn; [&]() {
...
auto [__0, __1, methods, __3] = declExtend; [&]() {
auto method_index = 0;
while ((method_index < methods.length())) {
  [&]() {
auto __match_subject = methods[method_index];
