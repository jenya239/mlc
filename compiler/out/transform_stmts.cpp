...
return Transform_stmts_fold_state{accumulator.typed_statements.concat(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>{std::make_shared<semantic_ir::SemanticStatement>(semantic_ir::SemanticStatementLet{binding_name, is_mut, coerced_value, value_type, source_span})}), type_environment};
}(); },
...
type_environment.set(binding_name, value_type);
auto coerced_value = transform::coerce_expr_to_type(typed_value, value_type);
return Transform_stmts_fold_state{accumulator.typed_statements.concat(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>{std::make_shared<semantic_ir::SemanticStatement>(semantic_ir::SemanticStatementLetConst{binding_name, coerced_value, value_type, source_span})}), type_environment};
}(); },
...
return Transform_stmts_fold_state{accumulator.typed_statements.concat(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>{std::make_shared<semantic_ir::SemanticStatement>(semantic_ir::SemanticStatementExpr{typed_expr, source_span})}), accumulator.type_environment};
}(); },
...
return Transform_stmts_fold_state{accumulator.typed_statements.concat(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>{std::make_shared<semantic_ir::SemanticStatement>(semantic_ir::SemanticStatementReturn{typed_return, source_span})}), accumulator.type_environment};
}(); },
[&](const ast::StmtBreak& stmtBreak) -> Transform_stmts_fold_state { auto [source_span] = stmtBreak; return Transform_stmts_fold_state{accumulator.typed_statements.concat(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>{std::make_shared<semantic_ir::SemanticStatement>(semantic_ir::SemanticStatementBreak{source_span})}), accumulator.type_environment}; },
[&](const ast::StmtContinue& stmtContinue) -> Transform_stmts_fold_state { auto [source_span] = stmtContinue; return Transform_stmts_fold_state{accumulator.typed_statements.concat(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>{std::make_shared<semantic_ir::SemanticStatement>(semantic_ir::SemanticStatementContinue{source_span})}), accumulator.type_environment}; }
}, (*statement));
}
