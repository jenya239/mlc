...
bool is_output_directory_flag(mlc::String argument) noexcept{return argument == mlc::String("-o");}

bool is_profile_flag(mlc::String argument) noexcept{return argument == mlc::String("--profile");}

bool is_check_only_flag(mlc::String argument) noexcept{return argument == mlc::String("--check-only");}

bool is_emit_compile_commands_flag(mlc::String argument) noexcept{return argument == mlc::String("--emit-compile-commands");}

bool is_verify_each_pass_flag(mlc::String argument) noexcept{return argument == mlc::String("--verify-each");}

bool is_dump_ast_flag(mlc::String argument) noexcept{return argument == mlc::String("--dump-ast");}

bool is_dump_sem_flag(mlc::String argument) noexcept{return argument == mlc::String("--dump-sem");}

bool is_dump_mir_flag(mlc::String argument) noexcept{return argument == mlc::String("--dump-mir");}

bool is_mir_bootstrap_report_flag(mlc::String argument) noexcept{return argument == mlc::String("--mir-bootstrap-report");}

bool is_time_passes_flag(mlc::String argument) noexcept{return argument == mlc::String("--time-passes");}

bool is_run_interpreter_flag(mlc::String argument) noexcept{return argument == mlc::String("--run") ? true : argument == mlc::String("--interpret") ? true : false;}

bool is_trace_vm_flag(mlc::String argument) noexcept{return argument == mlc::String("--trace-vm");}
