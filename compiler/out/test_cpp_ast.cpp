...
cpp_ast::CppClassMember class_member = cpp_ast::CppClassMemberAccess((cpp_ast::CppPublic{}));
results.push_back(test_runner::assert_true(mlc::String("CppClassMemberAccess"), [&]() { if (std::holds_alternative<cpp_ast::CppClassMemberAccess>(class_member)) { auto _v_cppclassmemberaccess = std::get<cpp_ast::CppClassMemberAccess>(class_member); auto [access] = _v_cppclassmemberaccess; return [&]() { if (std::holds_alternative<cpp_ast::CppPublic>(access)) {  return true; } return false; }(); } return false; }()));
results.push_back(test_runner::assert_true(mlc::String("CppClassDeclaration"), [&]() { if (std::holds_alternative<cpp_ast::CppClassDeclaration>((*std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppClassDeclaration(cpp_ast::CppClassDefinition{true, mlc::String(""), mlc::String("Point"), {}, mlc::Array<cpp_ast::CppClassMember>{cpp_ast::CppClassMemberAccess((cpp_ast::CppPublic{})), cpp_ast::CppClassMemberField(std::make_shared<cpp_ast::CppType>(cpp_ast::CppTypeName(mlc::String("float"))), mlc::String("x"), mlc::String(""))}}))))) { auto _v_cppclassdeclaration = std::get<cpp_ast::CppClassDeclaration>((*std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppClassDeclaration(cpp_ast::CppClassDefinition{true, mlc::String(""), mlc::String("Point"), {}, mlc::Array<cpp_ast::CppClassMember>{cpp_ast::CppClassMemberAccess((cpp_ast::CppPublic{})), cpp_ast::CppClassMemberField(std::make_shared<cpp_ast::CppType>(cpp_ast::CppTypeName(mlc::String("float"))), mlc::String("x"), mlc::String(""))}})))); auto [definition] = _v_cppclassdeclaration; return definition.name == mlc::String("Point") && definition.is_struct; } return false; }()));
std::shared_ptr<cpp_ast::CppDeclaration> typedef_declaration = std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppTypedefDeclaration(mlc::String("size_t"), std::make_shared<cpp_ast::CppType>(cpp_ast::CppTypeName(mlc::String("unsigned long")))));
results.push_back(test_runner::assert_true(mlc::String("CppTypedefDeclaration"), [&]() { if (std::holds_alternative<cpp_ast::CppTypedefDeclaration>((*typedef_declaration))) { auto _v_cpptypedefdeclaration = std::get<cpp_ast::CppTypedefDeclaration>((*typedef_declaration)); auto [name, type_node] = _v_cpptypedefdeclaration; return [&]() -> bool { 
  bool name_ok = name == mlc::String("size_t");
  bool type_ok = [&]() { if (std::holds_alternative<cpp_ast::CppTypeName>((*type_node))) { auto _v_cpptypename = std::get<cpp_ast::CppTypeName>((*type_node)); auto [type_name] = _v_cpptypename; return type_name == mlc::String("unsigned long"); } return false; }();
  return name_ok && type_ok;
 }(); } return false; }()));
std::shared_ptr<cpp_ast::CppDeclaration> template_declaration = std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppTemplateDeclaration(mlc::String("typename T"), std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppFunctionPrototypeDecl(cpp_ast::CppFunctionPrototype{mlc::String(""), std::make_shared<cpp_ast::CppType>(cpp_ast::CppTypeName(mlc::String("T"))), mlc::String("identity"), mlc::Array<std::shared_ptr<cpp_ast::CppParam>>{std::make_shared<cpp_ast::CppParam>(cpp_ast::CppParam{mlc::String("value"), std::make_shared<cpp_ast::CppType>(cpp_ast::CppTypeName(mlc::String("T")))})}, cpp_ast::cpp_fn_modifiers_none()}))));
results.push_back(test_runner::assert_true(mlc::String("CppTemplateDeclaration"), [&]() { if (std::holds_alternative<cpp_ast::CppTemplateDeclaration>((*template_declaration))) { auto _v_cpptemplatedeclaration = std::get<cpp_ast::CppTemplateDeclaration>((*template_declaration)); auto [parameters, inner] = _v_cpptemplatedeclaration; return [&]() -> bool { 
  bool parameters_ok = parameters == mlc::String("typename T");
  bool inner_ok = [&]() { if (std::holds_alternative<cpp_ast::CppFunctionPrototypeDecl>((*inner))) { auto _v_cppfunctionprototypedecl = std::get<cpp_ast::CppFunctionPrototypeDecl>((*inner)); auto [prototype] = _v_cppfunctionprototypedecl; return prototype.name == mlc::String("identity"); } return false; }();
  return parameters_ok && inner_ok;
 }(); } return false; }()));
return results;
}
