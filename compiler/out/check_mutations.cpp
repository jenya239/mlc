...
auto [type_value, __1] = semanticExpressionExtern; return MutationsPass_visit_extern(mutations_pass, type_value);
}
if (std::holds_alternative<semantic_ir::SemanticExpressionIdent>((*__match_subject))) {
const semantic_ir::SemanticExpressionIdent& semanticExpressionIdent = std::get<semantic_ir::SemanticExpressionIdent>((*__match_subject));
...
static_assert(ExprVisitor<MutationCheckResult, MutationsPass>, "MutationsPass does not implement ExprVisitor");
