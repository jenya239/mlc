...
[&](const ast::ExprIndex& exprIndex) { auto [obj, idx] = exprIndex; return ast::errs_append(check_names_expr(obj, locals, globals), check_names_expr(idx, locals, globals)); },
