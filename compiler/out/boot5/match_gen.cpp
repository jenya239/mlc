...
[&](const ast::PatIdent& patIdent) { auto [name, __1] = patIdent; return expr::match_arm_binding_identifier(cpp_naming::cpp_safe(name), eval_expr_fn(arm->body, context::context_add_value(context, name), gen_stmts)); },
