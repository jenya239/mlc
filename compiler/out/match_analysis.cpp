...
bool subject_is_bool_type(std::shared_ptr<semantic_ir::SemanticExpression> subject) noexcept{return [&]() { if (std::holds_alternative<registry::TBool>((*semantic_ir::sexpr_type(subject)))) {  return true; } return false; }();}
