...
std::shared_ptr<cpp_ast::CppExpression> CodegenPass_visit_call(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
auto callee_code = (context::qualify_function_callee(cpp_naming::map_builtin(name), context) + result_wrapper_ctor_type_argument(name, context));
...
std::shared_ptr<cpp_ast::CppExpression> gen_call_via_cpp_visitor(std::shared_ptr<semantic_ir::SemanticExpression> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> call_parameter_mutability_flags, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts) noexcept{
  ...
  auto invoke_expression = [&]() -> std::shared_ptr<cpp_ast::CppExpression> {
  if (expression_support::is_constructor_call(function_expression))   {
    return gen_constructor_call_cpp_expression(function_expression, materialization_outcome.materialized_argument_expressions, context, gen_stmts);
  } else   {
    return std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppCall{gen_call_function_cpp_expression(function_expression, context, gen_stmts), materialization_outcome.materialized_argument_expressions});
  }
}();
...
std::shared_ptr<cpp_ast::CppExpression> gen_question_via_cpp_visitor(std::shared_ptr<semantic_ir::SemanticExpression> inner_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts) noexcept{
  return std::make_shared<cpp_ast::CppExpression>(cpp_ast::CppQuestionTry{eval_expr_cpp(inner_expression, context, gen_stmts)});
}
...
std::shared_ptr<cpp_ast::CppExpression> gen_binary_via_cpp_visitor(mlc::String operation, std::shared_ptr<semantic_ir::SemanticExpression> left_expression, std::shared_ptr<semantic_ir::SemanticExpression> right_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)> gen_stmts, std::function<std::shared_ptr<cpp_ast::CppExpression>(std::shared_ptr<semantic_ir::SemanticExpression>, context::CodegenContext, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>>, context::CodegenContext)>)> evaluate_expression) noexcept{
  ...
  auto type_name = named_type_name_from_semantic_type(semantic_ir::sexpr_type(left_expression));
...
std::shared_ptr<cpp_ast::CppExpression> visit_call(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
std::shared_ptr<cpp_ast::CppExpression> CodegenPass_visit_call(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept{
return gen_call_via_cpp_visitor(function_expression, arguments, mutability_flags, self.context, self.gen_stmts);
}
std::shared_ptr<cpp_ast::CppExpression> CodegenPass_visit_method(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, mlc::String method_name, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept{
...
inline std::shared_ptr<cpp_ast::CppExpression> visit_int(CodegenPass self, int value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_int(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_int(CodegenPass self, int value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_int(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_str(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_str(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_str(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_str(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_bool(CodegenPass self, bool value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_bool(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_bool(CodegenPass self, bool value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_bool(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_unit(CodegenPass self, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_unit(self, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_unit(CodegenPass self, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_unit(self, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_float(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_float(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_float(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_float(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_i64(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_i64(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_i64(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_i64(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_u8(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_u8(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_u8(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_u8(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_usize(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_usize(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_usize(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_usize(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_char(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_char(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_char(CodegenPass self, mlc::String value, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_char(self, value, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_extern(CodegenPass self, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_extern(self, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_extern(CodegenPass self, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_extern(self, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_ident(CodegenPass self, mlc::String name, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_ident(self, name, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_ident(CodegenPass self, mlc::String name, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_ident(self, name, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_bin(CodegenPass self, mlc::String operation, std::shared_ptr<semantic_ir::SemanticExpression> left_expression, std::shared_ptr<semantic_ir::SemanticExpression> right_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_bin(self, operation, left_expression, right_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_bin(CodegenPass self, mlc::String operation, std::shared_ptr<semantic_ir::SemanticExpression> left_expression, std::shared_ptr<semantic_ir::SemanticExpression> right_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_bin(self, operation, left_expression, right_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_un(CodegenPass self, mlc::String operation, std::shared_ptr<semantic_ir::SemanticExpression> inner_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_un(self, operation, inner_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_un(CodegenPass self, mlc::String operation, std::shared_ptr<semantic_ir::SemanticExpression> inner_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_un(self, operation, inner_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_call(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_call(self, function_expression, arguments, mutability_flags, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_call(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_call(self, function_expression, arguments, mutability_flags, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_method(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, mlc::String method_name, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_method(self, object, method_name, arguments, mutability_flags, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_method(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, mlc::String method_name, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> arguments, mlc::Array<int> mutability_flags, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_method(self, object, method_name, arguments, mutability_flags, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_field(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, mlc::String field_name, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_field(self, object, field_name, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_field(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, mlc::String field_name, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_field(self, object, field_name, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_index(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, std::shared_ptr<semantic_ir::SemanticExpression> index_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_index(self, object, index_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_index(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> object, std::shared_ptr<semantic_ir::SemanticExpression> index_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_index(self, object, index_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_if(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> condition, std::shared_ptr<semantic_ir::SemanticExpression> then_expression, std::shared_ptr<semantic_ir::SemanticExpression> else_expression, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_if(self, condition, then_expression, else_expression, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_if(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> condition, std::shared_ptr<semantic_ir::SemanticExpression> then_expression, std::shared_ptr<semantic_ir::SemanticExpression> else_expression, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_if(self, condition, then_expression, else_expression, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_block(CodegenPass self, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<semantic_ir::SemanticExpression> result_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_block(self, statements, result_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_block(CodegenPass self, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<semantic_ir::SemanticExpression> result_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_block(self, statements, result_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_while(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> condition, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_while(self, condition, statements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_while(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> condition, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_while(self, condition, statements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_for(CodegenPass self, mlc::String variable, std::shared_ptr<semantic_ir::SemanticExpression> iterator, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_for(self, variable, iterator, statements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_for(CodegenPass self, mlc::String variable, std::shared_ptr<semantic_ir::SemanticExpression> iterator, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_for(self, variable, iterator, statements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_match(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> subject, mlc::Array<std::shared_ptr<semantic_ir::SemanticMatchArm>> arms, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_match(self, subject, arms, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_match(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> subject, mlc::Array<std::shared_ptr<semantic_ir::SemanticMatchArm>> arms, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_match(self, subject, arms, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_record(CodegenPass self, mlc::String type_name, mlc::Array<std::shared_ptr<semantic_ir::SemanticFieldVal>> field_values, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_record(self, type_name, field_values, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_record(CodegenPass self, mlc::String type_name, mlc::Array<std::shared_ptr<semantic_ir::SemanticFieldVal>> field_values, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_record(self, type_name, field_values, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_record_update(CodegenPass self, mlc::String type_name, std::shared_ptr<semantic_ir::SemanticExpression> base_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticFieldVal>> overrides, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_record_update(self, type_name, base_expression, overrides, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_record_update(CodegenPass self, mlc::String type_name, std::shared_ptr<semantic_ir::SemanticExpression> base_expression, mlc::Array<std::shared_ptr<semantic_ir::SemanticFieldVal>> overrides, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_record_update(self, type_name, base_expression, overrides, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_array(CodegenPass self, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> elements, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_array(self, elements, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_array(CodegenPass self, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> elements, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_array(self, elements, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_tuple(CodegenPass self, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> elements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_tuple(self, elements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_tuple(CodegenPass self, mlc::Array<std::shared_ptr<semantic_ir::SemanticExpression>> elements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_tuple(self, elements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_question(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> inner_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_question(self, inner_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_question(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> inner_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_question(self, inner_expression, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_lambda(CodegenPass self, mlc::Array<mlc::String> parameter_names, std::shared_ptr<semantic_ir::SemanticExpression> body_expression, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_lambda(self, parameter_names, body_expression, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_lambda(CodegenPass self, mlc::Array<mlc::String> parameter_names, std::shared_ptr<semantic_ir::SemanticExpression> body_expression, std::shared_ptr<registry::Type> semantic_type) noexcept { return CodegenPass_visit_lambda(self, parameter_names, body_expression, semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_with(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> resource, mlc::String binder, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_with(self, resource, binder, statements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_with(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> resource, mlc::String binder, mlc::Array<std::shared_ptr<semantic_ir::SemanticStatement>> statements, std::shared_ptr<registry::Type> _semantic_type) noexcept { return CodegenPass_visit_with(self, resource, binder, statements, _semantic_type); }
inline std::shared_ptr<cpp_ast::CppExpression> visit_unsupported(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> _expression) noexcept { return CodegenPass_visit_unsupported(self, _expression); }
inline std::shared_ptr<cpp_ast::CppExpression> ExprVisitor_visit_unsupported(CodegenPass self, std::shared_ptr<semantic_ir::SemanticExpression> _expression) noexcept { return CodegenPass_visit_unsupported(self, _expression); }
static_assert(ExprVisitor<std::shared_ptr<cpp_ast::CppExpression>, CodegenPass>, "CodegenPass does not implement ExprVisitor");
