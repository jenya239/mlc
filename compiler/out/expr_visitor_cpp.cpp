...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_field(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _object, mlc::String _field_name, std::shared_ptr<registry::Type> _semantic_type) noexcept;

std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_index(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _object, std::shared_ptr<semantic_ir::SExpr> _index_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_while(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _condition, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> _statements, std::shared_ptr<registry::Type> _semantic_type) noexcept;

std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_for(expr_visitor_cpp::CppExprVisitor self, mlc::String _variable, std::shared_ptr<semantic_ir::SExpr> _iterator, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> _statements, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_record_update(expr_visitor_cpp::CppExprVisitor self, mlc::String _type_name, std::shared_ptr<semantic_ir::SExpr> _base_expression, mlc::Array<std::shared_ptr<semantic_ir::SFieldVal>> _overrides, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_tuple(expr_visitor_cpp::CppExprVisitor self, mlc::Array<std::shared_ptr<semantic_ir::SExpr>> _elements, std::shared_ptr<registry::Type> _semantic_type) noexcept;

std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_question(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _inner_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_with(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _resource, mlc::String _binder, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> _statements, std::shared_ptr<registry::Type> _semantic_type) noexcept;
...
std::shared_ptr<cpp_ast::CppExpr> gen_call_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> function_expression, mlc::Array<std::shared_ptr<semantic_ir::SExpr>> arguments, mlc::Array<int> call_parameter_mutability_flags, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_call_via_visitor(function_expression, arguments, call_parameter_mutability_flags, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_method_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> object, mlc::String method_name, mlc::Array<std::shared_ptr<semantic_ir::SExpr>> arguments, mlc::Array<int> receiver_and_parameter_mutability_flags, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_method_via_visitor(object, method_name, arguments, receiver_and_parameter_mutability_flags, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_if_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> condition, std::shared_ptr<semantic_ir::SExpr> then_expression, std::shared_ptr<semantic_ir::SExpr> else_expression, std::shared_ptr<registry::Type> if_semantic_type, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_if_via_visitor(condition, then_expression, else_expression, if_semantic_type, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_block_via_cpp_visitor(mlc::Array<std::shared_ptr<semantic_ir::SStmt>> statements, std::shared_ptr<semantic_ir::SExpr> result_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_block_via_visitor(statements, result_expression, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_match_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> subject, mlc::Array<std::shared_ptr<semantic_ir::SMatchArm>> arms, std::shared_ptr<registry::Type> match_semantic_type, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_match_via_visitor(subject, arms, match_semantic_type, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_record_via_cpp_visitor(mlc::String type_name, mlc::Array<std::shared_ptr<semantic_ir::SFieldVal>> field_values, std::shared_ptr<registry::Type> expression_type, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_record_via_visitor(type_name, field_values, expression_type, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_array_via_cpp_visitor(mlc::Array<std::shared_ptr<semantic_ir::SExpr>> elements, std::shared_ptr<registry::Type> element_container_semantic_type, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_array_via_visitor(elements, element_container_semantic_type, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_lambda_via_cpp_visitor(mlc::Array<mlc::String> parameter_binding_names, std::shared_ptr<semantic_ir::SExpr> body_expression_under_lambda, std::shared_ptr<registry::Type> semantic_function_type_for_lambda_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_lambda_via_visitor(parameter_binding_names, body_expression_under_lambda, semantic_function_type_for_lambda_expression, context, gen_stmts, eval_expr_cpp_as_string));}
...
std::shared_ptr<cpp_ast::CppExpr> left_cpp = evaluate_expression(left_expression, context, gen_stmts);
std::shared_ptr<cpp_ast::CppExpr> right_cpp = evaluate_expression(right_expression, context, gen_stmts);
return method != mlc::String("") && type_name != mlc::String("") ? std::make_shared<cpp_ast::CppExpr>(cpp_ast::CppCall(emit_helpers::make_identifier_cpp_expression(type_name + mlc::String("_") + method), mlc::Array<std::shared_ptr<cpp_ast::CppExpr>>{left_cpp, right_cpp})) : std::make_shared<cpp_ast::CppExpr>(cpp_ast::CppBinary(operation, left_cpp, right_cpp));
}

std::shared_ptr<cpp_ast::CppExpr> gen_unary_via_cpp_visitor(mlc::String operation, std::shared_ptr<semantic_ir::SExpr> inner_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts, std::function<std::shared_ptr<cpp_ast::CppExpr>(std::shared_ptr<semantic_ir::SExpr>, context::CodegenContext, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)>)> evaluate_expression) noexcept{return std::make_shared<cpp_ast::CppExpr>(cpp_ast::CppUnary(operation, evaluate_expression(inner_expression, context, gen_stmts)));}
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_field(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _object, mlc::String _field_name, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}

std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_index(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _object, std::shared_ptr<semantic_ir::SExpr> _index_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_while(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _condition, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> _statements, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}

std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_for(expr_visitor_cpp::CppExprVisitor self, mlc::String _variable, std::shared_ptr<semantic_ir::SExpr> _iterator, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> _statements, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_record_update(expr_visitor_cpp::CppExprVisitor self, mlc::String _type_name, std::shared_ptr<semantic_ir::SExpr> _base_expression, mlc::Array<std::shared_ptr<semantic_ir::SFieldVal>> _overrides, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_tuple(expr_visitor_cpp::CppExprVisitor self, mlc::Array<std::shared_ptr<semantic_ir::SExpr>> _elements, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}

std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_question(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _inner_expression, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}
...
std::shared_ptr<cpp_ast::CppExpr> CppExprVisitor_visit_with(expr_visitor_cpp::CppExprVisitor self, std::shared_ptr<semantic_ir::SExpr> _resource, mlc::String _binder, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> _statements, std::shared_ptr<registry::Type> _semantic_type) noexcept{return unsupported_cpp_expression();}
...
std::shared_ptr<cpp_ast::CppExpr> eval_expr_with_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts, std::function<std::shared_ptr<cpp_ast::CppExpr>(std::shared_ptr<semantic_ir::SExpr>, context::CodegenContext, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)>)> evaluate_expression) noexcept{return std::visit(overloaded{
  ...
  [&](const SExprField& sexprfield) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_object, _field_name, _w0, _w1] = sexprfield; return unsupported_cpp_expression(); },
  [&](const SExprIndex& sexprindex) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_object, _index_expression, _w0, _w1] = sexprindex; return unsupported_cpp_expression(); },
  ...
  [&](const SExprWhile& sexprwhile) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_condition, _statements, _w0, _w1] = sexprwhile; return unsupported_cpp_expression(); },
  [&](const SExprFor& sexprfor) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_variable, _iterator, _statements, _w0, _w1] = sexprfor; return unsupported_cpp_expression(); },
  ...
  [&](const SExprRecordUpdate& sexprrecordupdate) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_type_name, _base_expression, _overrides, _w0, _w1] = sexprrecordupdate; return unsupported_cpp_expression(); },
  ...
  [&](const SExprTuple& sexprtuple) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_elements, _w0, _w1] = sexprtuple; return unsupported_cpp_expression(); },
  [&](const SExprQuestion& sexprquestion) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_inner_expression, _w0, _w1] = sexprquestion; return unsupported_cpp_expression(); },
  ...
  [&](const SExprWith& sexprwith) -> std::shared_ptr<cpp_ast::CppExpr> { auto [_resource, _binder, _statements, _w0, _w1] = sexprwith; return unsupported_cpp_expression(); }
}, (*expression)._);}
