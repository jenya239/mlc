...
std::shared_ptr<cpp_ast::CppExpr> gen_field_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> object, mlc::String field_name, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_field_via_visitor(object, field_name, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_index_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> object, std::shared_ptr<semantic_ir::SExpr> index_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_index_via_visitor(object, index_expression, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_while_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> condition, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> statements, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_while_via_visitor(condition, statements, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_for_via_cpp_visitor(mlc::String variable, std::shared_ptr<semantic_ir::SExpr> iterator, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> statements, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_for_via_visitor(variable, iterator, statements, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_record_update_via_cpp_visitor(mlc::String type_name, std::shared_ptr<semantic_ir::SExpr> base_expression, mlc::Array<std::shared_ptr<semantic_ir::SFieldVal>> overrides, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_record_update_via_visitor(type_name, base_expression, overrides, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_tuple_via_cpp_visitor(mlc::Array<std::shared_ptr<semantic_ir::SExpr>> elements, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_tuple_via_visitor(elements, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_question_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> inner_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_question_via_visitor(inner_expression, context, gen_stmts, eval_expr_cpp_as_string));}

std::shared_ptr<cpp_ast::CppExpr> gen_with_via_cpp_visitor(std::shared_ptr<semantic_ir::SExpr> resource, mlc::String binder, mlc::Array<std::shared_ptr<semantic_ir::SStmt>> statements, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_with_via_visitor(resource, binder, statements, context, gen_stmts, eval_expr_cpp_as_string));}
...
return method != mlc::String("") && type_name != mlc::String("") ? std::make_shared<cpp_ast::CppExpr>(cpp_ast::CppCall(emit_helpers::make_identifier_cpp_expression(type_name + mlc::String("_") + method), mlc::Array<std::shared_ptr<cpp_ast::CppExpr>>{evaluate_expression(left_expression, context, gen_stmts), evaluate_expression(right_expression, context, gen_stmts)})) : cpp_expr_from_rendered_fragment(expr_visitor_string::gen_binary_via_visitor(operation, left_expression, right_expression, context, gen_stmts, eval_expr_cpp_as_string));
}

std::shared_ptr<cpp_ast::CppExpr> gen_unary_via_cpp_visitor(mlc::String operation, std::shared_ptr<semantic_ir::SExpr> inner_expression, context::CodegenContext context, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)> gen_stmts, std::function<std::shared_ptr<cpp_ast::CppExpr>(std::shared_ptr<semantic_ir::SExpr>, context::CodegenContext, std::function<mlc::String(mlc::Array<std::shared_ptr<semantic_ir::SStmt>>, context::CodegenContext)>)> evaluate_expression) noexcept{return cpp_expr_from_rendered_fragment(expr_visitor_string::gen_unary_via_visitor(operation, inner_expression, context, gen_stmts, eval_expr_cpp_as_string));}
