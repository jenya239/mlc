...
results.push_back(test_runner::assert_true(mlc::String("infer: user function call too few arguments"), first_checker_error_line(mlc::String("fn f(x: i32) -> i32 = x\nfn g() -> i32 = f()")).contains(mlc::String("expected 1 arguments, got 0"))));
results.push_back(test_runner::assert_true(mlc::String("infer: user function call too many arguments"), first_checker_error_line(mlc::String("fn f(x: i32) -> i32 = x\nfn g() -> i32 = f(1, 2)")).contains(mlc::String("expected 1 arguments, got 2"))));
