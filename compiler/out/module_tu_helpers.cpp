...
mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> push_parsed_include_line(mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> declarations, mlc::String line) noexcept{
if (line.length() >= 10 && line.substring(0, 10) == mlc::String("#include \"") && line.char_at(line.length() - 1) == mlc::String("\"")){
{
...
mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> append_cpp_declarations_from_include_text(mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> declarations, mlc::String include_text) noexcept{
mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> result = declarations;
int start = 0;
int index = 0;
...
std::shared_ptr<cpp_ast::CppDeclaration> make_include_guard_ifndef_cpp_declaration(mlc::String guard_macro) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppIfndef(guard_macro));}

std::shared_ptr<cpp_ast::CppDeclaration> make_include_guard_define_cpp_declaration(mlc::String guard_macro) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppDefineMacro(guard_macro, mlc::String("")));}

std::shared_ptr<cpp_ast::CppDeclaration> make_include_guard_endif_cpp_declaration(mlc::String guard_macro) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppEndif(guard_macro));}

std::shared_ptr<cpp_ast::CppDeclaration> make_namespace_open_cpp_declaration(mlc::String namespace_identifier) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppNamespaceBegin(namespace_identifier));}

std::shared_ptr<cpp_ast::CppDeclaration> make_namespace_close_cpp_declaration(mlc::String namespace_identifier) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppNamespaceEnd(namespace_identifier));}

std::shared_ptr<cpp_ast::CppDeclaration> make_define_main_as_user_main_cpp_declaration() noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppDefineMacro(mlc::String("main"), mlc::String("mlc_user_main")));}

std::shared_ptr<cpp_ast::CppDeclaration> make_quoted_include_cpp_declaration(mlc::String header_filename) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppInclude(false, header_filename));}

std::shared_ptr<cpp_ast::CppDeclaration> make_blank_line_cpp_declaration() noexcept{return std::make_shared<cpp_ast::CppDeclaration>((cpp_ast::CppBlankLine{}));}

std::shared_ptr<cpp_ast::CppDeclaration> make_using_namespace_cpp_declaration(mlc::String namespace_identifier) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppUsingNamespace(namespace_identifier));}

mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> append_using_namespace_declarations(mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> declarations, mlc::Array<mlc::String> import_paths) noexcept{
mlc::Array<std::shared_ptr<cpp_ast::CppDeclaration>> result = declarations;
mlc::Array<mlc::String> namespace_names = cpp_naming::using_namespace_names(import_paths);
int index = 0;
while (index < namespace_names.size()){
{
...
std::shared_ptr<cpp_ast::CppDeclaration> make_entry_host_main_cpp_declaration(mlc::String qualified_namespace) noexcept{return std::make_shared<cpp_ast::CppDeclaration>(cpp_ast::CppHostEntryMain(qualified_namespace));}
