...
constexpr bool LexOut_has_errors(ast_tokens::LexOut self) noexcept{return self.errors.size() > 0;}

ast_tokens::TKind Token_kind_value(ast_tokens::Token self) noexcept;

constexpr int Token_line_number(ast_tokens::Token self) noexcept{return self.line;}

constexpr int Token_column(ast_tokens::Token self) noexcept{return self.col;}
