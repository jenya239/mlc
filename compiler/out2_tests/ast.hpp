...
struct ExprExtern;
struct ExprLambda;
using Expr = std::variant<ExprInt, ExprStr, ExprBool, ExprUnit, ExprIdent, ExprBin, ExprUn, ExprCall, ExprMethod, ExprField, ExprIndex, ExprIf, ExprBlock, ExprWhile, ExprFor, ExprMatch, ExprRecord, ExprRecordUpdate, ExprArray, ExprTuple, ExprQuestion, ExprExtern, ExprLambda>;
struct StmtLet;
struct StmtLetPat;
struct StmtLetConst;
struct StmtExpr;
...
struct StmtLetPat {std::shared_ptr<Pat> field0;bool field1;std::shared_ptr<TypeExpr> field2;std::shared_ptr<Expr> field3;Span field4;};
