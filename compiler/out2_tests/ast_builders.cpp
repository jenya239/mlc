...
return std::make_shared<ast::TypeVariant>(ast::VarRecord{variant_name, field_definitions});
}
...
return std::make_shared<ast::TypeVariant>(ast::VarTuple{variant_name, field_types});
}
std::shared_ptr<ast::TypeVariant> unit_variant(mlc::String variant_name) noexcept{
return std::make_shared<ast::TypeVariant>(ast::VarUnit{variant_name});
}
