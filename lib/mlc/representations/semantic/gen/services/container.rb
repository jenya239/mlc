...
require_relative 'var_type_registry'
require_relative 'type_checker'
require_relative 'scope_context_service'
require_relative 'type_unification_service'
require_relative 'type_inference_service'
require_relative 'sum_type_constructor_service'
require_relative 'module_context_service'
...
require_relative 'semantic_ir_type_checker'
        ...
        module Services
          ...
          class Container
            ...
            def initialize(function_registry:, type_registry:)
              ...
              @var_type_registry = MLC::Representations::Semantic::Gen::Services::VarTypeRegistry.new
              ...
              @module_context_service = MLC::Representations::Semantic::Gen::Services::ModuleContextService.new(
                function_registry: @function_registry
              )
              @sum_type_constructor_service = MLC::Representations::Semantic::Gen::Services::SumTypeConstructorService.new(
              ...
              @type_inference_service = MLC::Representations::Semantic::Gen::Services::TypeInferenceService.new(
                var_type_registry: @var_type_registry,
                type_registry: @type_registry,
                function_registry: @function_registry,
                type_decl_table: @type_decl_table,
              ...
              @stdlib_registry = MLC::Common::Stdlib::SignatureRegistry.new
              @metadata_loader = MLC::Common::Stdlib::MetadataLoader.new(
                function_registry: @function_registry,
                type_registry: @type_registry
              )
