  ...
  module Representations
    module Semantic
      ...
      def ensure_required_rules(engine)
        ...
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::TupleLiteralRule)
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::SymbolLiteralRule)
        ...
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::SliceAccessRule)
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::TupleAccessRule)
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::StaticMethodCallRule)
        ...
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::SafeMemberRule)
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::SafeCallRule)
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::TryExprRule)
        register_rule(engine, :expression, MLC::Representations::Semantic::Gen::Rules::AwaitExprRule)
        ...
        register_rule(engine, :statement, MLC::Representations::Semantic::Gen::Rules::Statements::DestructuringDeclRule)
