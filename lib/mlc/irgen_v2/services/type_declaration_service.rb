    ...
    module Services
      ...
      class TypeDeclarationService
        ...
        def build(decl)
          ...
          MLC::HighIR::TypeDecl.new(name: decl.name, type: core_type, type_params: type_params, exported: decl.exported)
        end
        ...
        def specialize_named_type(core_type, name)
          ...
          when MLC::HighIR::RecordType
            MLC::HighIR::Builder.record_type(name, core_type.fields)
          when MLC::HighIR::SumType
            MLC::HighIR::Builder.sum_type(name, core_type.variants)
          else
            core_type
          end
        end
