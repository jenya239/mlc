...
module MLC
  module SemanticGen
    module Services
      # MemberAccessService - resolves SemanticIR types for member access expressions
      class MemberAccessService
        ...
        # Resolve the SemanticIR type for a member access
        def resolve(object_type, member, node: nil)
          ...
          if object_type.is_a?(MLC::SemanticIR::GenericType)
        ...
        def resolve_string_member(member, node:)
          ...
          if STRING_ARRAY_MEMBERS.include?(member)
            ...
            return MLC::SemanticIR::ArrayType.new(element_type: element)
          end
        ...
        def substitute_type(type, type_map)
          ...
          when MLC::SemanticIR::FunctionType
            ...
            MLC::SemanticIR::Builder.function_type(params, ret)
          else
            type
          end
        end
        ...
        def function_placeholder(return_type:)
          params = []
          MLC::SemanticIR::Builder.function_type(params, return_type)
        end
